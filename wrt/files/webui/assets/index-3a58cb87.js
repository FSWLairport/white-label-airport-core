...
var BS = (e, t, n) =>
  t in e
    ? jS(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (e[t] = n);
var Bh = (e, t, n) => (BS(e, typeof t != "symbol" ? t + "" : t, n), n);
function sg(e, t) {
...
function us(e, t, n, r, o) {
  ...
  if (((a = 0), (r = r === "" ? "." : r + ":"), Vh(e)))
    ...
    for (e = l.call(e), s = 0; !(i = e.next()).done; )
      (i = i.value), (l = r + pu(i, s++)), (a += us(i, t, n, l, o));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
fe.StrictMode = KS;
fe.Suspense = JS;
fe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = i_;
fe.cloneElement = function (e, t, n) {
  ...
  return { $$typeof: sa, type: e.type, key: o, ref: i, props: r, _owner: a };
};
...
const V = Kf(L),
  Tt = sg({ __proto__: null, default: V }, [L]);
/**
 * @license React
 ...
 */ var a_ = L,
  ...
  c_ = a_.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function vg(e, t, n) {
  ...
  for (r in t) u_.call(t, r) && !f_.hasOwnProperty(r) && (o[r] = t[r]);
  if (e && e.defaultProps)
...
const Cr = Li.Fragment,
  R = Li.jsx,
  le = Li.jsxs;
const d_ = "modulepreload",
  h_ = function (e, t) {
        ...
        },
        {
          ...
          value: function (n) {
            return new e(
              this.logger,
              Gh(
                Gh({}, { prefix: "".concat(this.prefix, ":").concat(n, ":") }),
                this.options
              )
            );
          },
...
function Ta(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? Zh(Object(n), !0).forEach(function (r) {
          cn(e, r, n[r]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : Zh(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r));
        });
  }
  return e;
      ...
      It(n, [
        ...
        },
        {
          ...
          value: function (o, i, a) {
            ...
            var f = ks(this.data, c);
            return f || !u || typeof a != "string"
              ? f
              : _g(this.data && this.data[o] && this.data[o][i], a, l);
          },
        },
        {
          key: "addResource",
          ...
          },
          {
            ...
            value: function (o, i, a) {
              ...
              if (v && v.toLowerCase() === "cimode") {
                if (y) {
                  var _ = i.nsSeparator || this.options.nsSeparator;
                  return l
                    ? ((m.res = "".concat(p).concat(_).concat(f)), m)
                    : "".concat(p).concat(_).concat(f);
                }
              ...
              if (
                ...
                if (!i.returnObjects && !this.options.returnObjects) {
                  ...
                  var $ = this.options.returnedObjectHandler
                    ? this.options.returnedObjectHandler(
                        g,
                        h,
                        Je(Je({}, i), {}, { ns: d })
                ...
                if (u) {
                  ...
                  for (var w in h)
                    if (Object.prototype.hasOwnProperty.call(h, w)) {
                      var P = "".concat(re).concat(u).concat(w);
                      (ce[w] = this.translate(
                        P,
                        Je(Je({}, i), { joinArrays: !1, ns: d })
                      )),
                        ce[w] === P && (ce[w] = h[w]);
                    }
                  h = ce;
                }
              } else if (I && typeof N == "string" && k === "[object Array]")
                (h = h.join(N)), h && (h = this.extendTranslation(h, o, i, a));
              else {
                var M = !1,
                  C = !1,
                  O = i.count !== void 0 && typeof i.count != "string",
                  A = n.hasDefaultValue(i),
                  D = O ? this.pluralResolver.getSuffix(v, i.count, i) : "",
                  z = i["defaultValue".concat(D)] || i.defaultValue;
                !this.isValidLookup(h) && A && ((M = !0), (h = z)),
                  this.isValidLookup(h) || ((C = !0), (h = f));
                var b =
                    i.missingKeyNoValueFallbackToKey ||
                    this.options.missingKeyNoValueFallbackToKey,
                  U = b && C ? void 0 : h,
                  B = A && z !== h && this.options.updateMissing;
                if (C || M || B) {
                  if (
                    (this.logger.log(
                  ...
                  if (this.options.saveMissingTo === "fallback" && Z && Z[0])
                    for (var ae = 0; ae < Z.length; ae++) W.push(Z[ae]);
                  else
                    this.options.saveMissingTo === "all"
                      ? (W = this.languageUtils.toResolveHierarchy(
                          i.lng || this.language
                        ))
                      : W.push(i.lng || this.language);
                  var Y = function (ye, pe, we) {
                    var rt = A && we !== h ? we : U;
                    s.options.missingKeyHandler
                      ? s.options.missingKeyHandler(ye, p, pe, rt, B, i)
                      : s.backendConnector &&
                        s.backendConnector.saveMissing &&
                        s.backendConnector.saveMissing(ye, p, pe, rt, B, i),
                      s.emit("missingKey", ye, p, pe, h);
                  };
                          ...
                          s.pluralResolver
                            ...
                            .forEach(function (ye) {
                              Y(
                                [me],
                                f + ye,
                                i["defaultValue".concat(ye)] || z
                              );
                            });
                        })
                      : Y(W, f, z));
                }
                (h = this.extendTranslation(h, o, i, m, a)),
                  C &&
                    h === f &&
            ...
            value: function (o, i, a, s, l) {
              ...
              if (this.i18nFormat && this.i18nFormat.parse)
                o = this.i18nFormat.parse(
                  o,
                  Je(Je({}, this.options.interpolation.defaultVariables), a),
                  s.usedLng,
                  s.usedNS,
                  s.usedKey,
                  { resolved: s }
                ...
                a.nest !== !1 &&
                  (o = this.interpolator.nest(
                    ...
                    function () {
                      for (
                        var h = arguments.length, g = new Array(h), S = 0;
                        S < h;
                        S++
                      )
                        g[S] = arguments[S];
                      return l && l[0] === g[0] && !a.context
                        ? (u.logger.warn(
              ...
              var _ = a.postProcess || this.options.postProcess,
                m = typeof _ == "string" ? [_] : _;
              return (
                o != null &&
                  m &&
                  m.length &&
              ...
              return (
                ...
                o.forEach(function (d) {
                  if (!i.isValidLookup(s)) {
                    var p = i.extractFromKey(d, a),
                      v = p.key;
                    l = v;
                    var y = p.namespaces;
                    i.options.fallbackNS &&
                      (y = y.concat(i.options.fallbackNS));
                    var _ = a.count !== void 0 && typeof a.count != "string",
                      m =
                        _ &&
                        !a.ordinal &&
                        a.count === 0 &&
                    ...
                    y.forEach(function (S) {
                      i.isValidLookup(s) ||
                        ((f = S),
                        !tp["".concat(g[0], "-").concat(S)] &&
                          i.utils &&
                          i.utils.hasLoadedNamespace &&
                          !i.utils.hasLoadedNamespace(f) &&
                          ((tp["".concat(g[0], "-").concat(S)] = !0),
                          i.logger.warn(
                            'key "'
                        ...
                        g.forEach(function (k) {
                          if (!i.isValidLookup(s)) {
                            ...
                            if (i.i18nFormat && i.i18nFormat.addLookupKeys)
                              i.i18nFormat.addLookupKeys(T, v, k, S, a);
                            else {
                              var N;
                              _ &&
                              ...
                              if (
                                ...
                                var G = ""
                                  ...
                                  .concat(a.context);
                                T.push(G),
                                  _ && (T.push(G + N), m && T.push(G + I));
                              }
                            }
                            for (var $; ($ = T.pop()); )
                              i.isValidLookup(s) ||
                                ((u = $), (s = i.getResource(k, S, $, a)));
                          }
                        }));
                    });
                  }
...
var rp = (function () {
  ...
  N_ = ["v1", "v2", "v3"],
  op = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 };
function A_() {
  var e = {};
  return (
    T_.forEach(function (t) {
      t.lngs.forEach(function (n) {
        e[n] = { numbers: t.nr, plurals: L_[t.fc] };
      });
    }),
    e
  );
  ...
  return (
    It(e, [
      ...
      },
      {
        ...
        value: function () {
          return !N_.includes(this.options.compatibilityJSON);
        },
      },
    ]),
    e
    ...
    It(e, [
      {
        ...
        value: function () {
          ...
          (this.escape = r.escape !== void 0 ? r.escape : b_),
            ...
            if (m.indexOf(a.formatSeparator) < 0) {
              ...
              return a.alwaysFormat
                ? a.format(
                    ...
                    void 0,
                    o,
                    Dt(Dt(Dt({}, i), r), {}, { interpolationkey: m })
                  )
                : h;
            }
            var g = m.split(a.formatSeparator),
              S = g.shift().trim(),
              k = g.join(a.formatSeparator).trim();
            return a.format(
              Jh(r, c, S),
              k,
              o,
              Dt(Dt(Dt({}, i), r), {}, { interpolationkey: S })
            );
          };
          this.resetRegExp();
          var p =
            ...
            y.forEach(function (_) {
              for (u = 0; (s = _.regex.exec(n)); ) {
                ...
                if (((l = d(m)), l === void 0))
                  ...
                  typeof l != "string" && !a.useRawValueToEscape && (l = Xh(l));
                var g = _.safeValue(l);
                if (
                  ((n = n.replace(s[0], g)),
                  v
                    ? ((_.regex.lastIndex += l.length),
      ...
      },
      {
        ...
        value: function (n, r) {
          ...
          function u(p, v) {
            ...
            var _ = p.split(new RegExp("".concat(y, "[ ]*{"))),
              m = "{".concat(_[1]);
            (p = _[0]), (m = this.interpolate(m, l));
            var h = m.match(/'/g),
              g = m.match(/"/g);
            ((h && h.length % 2 === 0 && !g) || g.length % 2 !== 0) &&
              (m = m.replace(/'/g, '"'));
            try {
              (l = JSON.parse(m)), v && (l = Dt(Dt({}, v), l));
            } catch (S) {
              return (
                this.logger.warn(
...
var $_ = (function () {
  function e() {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    At(this, e),
      (this.logger = rn.create("formatter")),
      (this.options = t),
      (this.formats = {
        ...
        datetime: Wr(function (n, r) {
          var o = new Intl.DateTimeFormat(n, On({}, r));
          return function (i) {
            return o.format(i);
          };
        }),
        relativetime: Wr(function (n, r) {
          var o = new Intl.RelativeTimeFormat(n, On({}, r));
          return function (i) {
            return o.format(i, r.range || "day");
          };
        }),
        list: Wr(function (n, r) {
          var o = new Intl.ListFormat(n, On({}, r));
          return function (i) {
            return o.format(i);
          };
        }),
              ...
              if (a.formats[d]) {
                ...
                try {
                  var y =
                      ...
                      {},
                    _ = y.locale || y.lng || i.locale || i.lng || o;
                  v = a.formats[d](u, _, On(On(On({}, p), i), y));
                } catch (m) {
                  a.logger.warn(m);
                }
                return v;
...
function lp(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? sp(Object(n), !0).forEach(function (r) {
          cn(e, r, n[r]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : sp(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r));
        });
  }
  return e;
...
var B_ = (function (e) {
  ...
  function n(r, o, i) {
    ...
    return (
      ...
      (a.options = s),
      (a.logger = rn.create("backendConnector")),
      (a.waitingReads = []),
          ...
          return (
            o.forEach(function (p) {
              ...
              i.forEach(function (y) {
                var _ = "".concat(p, "|").concat(y);
                !a.reload && l.store.hasResourceBundle(p, y)
                  ? (l.state[_] = 2)
                  : l.state[_] < 0 ||
                    (l.state[_] === 1
                      ? c[_] === void 0 && (c[_] = !0)
        ...
        value: function (o, i, a, s, l) {
          ...
          if (!(a == null || a === "")) {
            if (this.backend && this.backend.create) {
              var f = lp(lp({}, u), {}, { isUpdate: l }),
                d = this.backend.create.bind(this.backend);
              if (d.length < 6)
                try {
                  var p;
                  d.length === 5 ? (p = d(o, i, a, s, f)) : (p = d(o, i, a, s)),
                    p && typeof p.then == "function"
                      ? p
                          .then(function (v) {
                            return c(null, v);
...
function Zt(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? fp(Object(n), !0).forEach(function (r) {
          cn(e, r, n[r]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : fp(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r));
        });
  }
  return e;
...
var Ps = (function (e) {
  ...
  function n() {
    ...
    if (
      ...
      if (!r.options.initImmediate) return r.init(o, i), la(r, zn(r));
      setTimeout(function () {
        r.init(o, i);
      }, 0);
    }
    ...
    It(n, [
      {
        ...
        value: function () {
          ...
          var s = up();
          (this.options = Zt(Zt(Zt({}, s), this.options), cp(i))),
            this.options.compatibilityAPI !== "v1" &&
          ...
          if (!this.options.isClone) {
            this.modules.logger
              ? rn.init(l(this.modules.logger), this.options)
              : rn.init(null, this.options);
            var u;
            this.modules.formatter
              ? (u = this.modules.formatter)
              : typeof Intl < "u" && (u = $_);
            var c = new rp(this.options);
            this.store = new x_(this.options.resources, this.options);
            var f = this.services;
            (f.logger = rn),
              (f.resourceStore = this.store),
              (f.languageUtils = c),
              (f.pluralResolver = new I_(c, {
              ...
              (f.interpolator = new M_(this.options)),
              (f.utils = {
                hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
              }),
              (f.backendConnector = new B_(
              ...
              (this.translator = new np(this.services, this.options)),
          ...
          p.forEach(function (m) {
            o[m] = function () {
              var h;
              return (h = o.store)[m].apply(h, arguments);
            };
          });
          var v = [
            "addResource",
          ...
          v.forEach(function (m) {
            o[m] = function () {
              var h;
              return (h = o.store)[m].apply(h, arguments), o;
            };
          });
          var y = Wo(),
            _ = function () {
      ...
      },
      {
        ...
        value: function (o) {
          ...
          return (
            ...
            o.type === "postProcessor" && bg.addPostProcessor(o),
        ...
        value: function (o, i, a) {
          var s = this,
            l = function u(c, f) {
              ...
              var _ = s.options.keySeparator || ".",
                m;
              return (
                d.keyPrefix && Array.isArray(c)
                  ? (m = c.map(function (h) {
                      return "".concat(d.keyPrefix).concat(_).concat(h);
                    }))
                  : (m = d.keyPrefix
                      ? "".concat(d.keyPrefix).concat(_).concat(c)
                      : c),
                s.t(m, d)
              );
            };
      ...
      },
      {
        ...
        value: function (o) {
          ...
          var i = [
            ...
            a = (this.services && this.services.languageUtils) || new rp(up());
          return i.indexOf(a.getLanguagePartFromCode(o)) > -1 ||
      ...
      },
      {
        ...
        value: function () {
          var o = this,
            ...
            a =
              arguments.length > 1 && arguments[1] !== void 0
                ? arguments[1]
                : La,
            s = Zt(Zt(Zt({}, this.options), i), { isClone: !0 }),
            l = new n(s);
          ...
          return (
            ...
            (l.services = Zt({}, this.services)),
            (l.services.utils = {
              hasLoadedNamespace: l.hasLoadedNamespace.bind(l),
            }),
            (l.translator = new np(l.services, l.options)),
...
cn(Ps, "createInstance", function () {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
    t = arguments.length > 1 ? arguments[1] : void 0;
  return new Ps(e, t);
});
var Ye = Ps.createInstance();
Ye.createInstance = Ps.createInstance;
Ye.createInstance;
Ye.dir;
Ye.init;
Ye.loadResources;
...
function K_(e) {
  return (
    H_.call(q_.call(arguments, 1), function (t) {
...
var dp = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  Q_ = function (t, n, r) {
    ...
    if (o.domain) {
      if (!dp.test(o.domain)) throw new TypeError("option domain is invalid");
      a += "; Domain=".concat(o.domain);
    }
    if (o.path) {
      if (!dp.test(o.path)) throw new TypeError("option path is invalid");
  ...
  hp = {
    create: function (t, n, r, o) {
      ...
      r &&
        ...
        o && (i.domain = o),
        (document.cookie = Q_(t, encodeURIComponent(n), i));
    },
    read: function (t) {
      for (
  ...
  pp = function () {
    ...
    try {
      Ho = window !== "undefined" && window.localStorage !== null;
          ...
          var r =
            ...
            o =
              arguments.length > 2 && arguments[2] !== void 0
                ...
                : {};
          (this.services = n),
            (this.options = K_(r, this.options || {}, rb())),
...
function cc(e) {
  return (
    ob.call(ib.call(arguments, 1), function (t) {
      if (t) for (var n in t) e[n] === void 0 && (e[n] = t[n]);
    }),
    e
  );
...
function Og() {
  return (
    ...
    (typeof XMLHttpRequest > "u" ? "undefined" : uc(XMLHttpRequest)) ===
      "object"
  );
}
function ab(e) {
...
function sb(e) {
  return ab(e) ? e : Promise.resolve(e);
}
function lb(e) {
  throw new Error(
          ...
          (function (a) {
            ...
            if (s.arrayBuffer)
              var u = [
                ...
                c =
                  ...
                  function (w) {
                    return (
                      w && u.indexOf(Object.prototype.toString.call(w)) > -1
                    );
                  };
            function f(w) {
              if (
            ...
            function v(w) {
              (this.map = {}),
                w instanceof v
                  ...
                  : w &&
                    Object.getOwnPropertyNames(w).forEach(function (P) {
                      this.append(P, w[P]);
                    }, this);
            }
            (v.prototype.append = function (w, P) {
              (w = f(w)), (P = d(P));
              var M = this.map[w];
              this.map[w] = M ? M + ", " + P : P;
            }),
              ...
              (v.prototype.get = function (w) {
                return (w = f(w)), this.has(w) ? this.map[w] : null;
              }),
              (v.prototype.has = function (w) {
                return this.map.hasOwnProperty(f(w));
              }),
              (v.prototype.set = function (w, P) {
                this.map[f(w)] = d(P);
              }),
              (v.prototype.forEach = function (w, P) {
                for (var M in this.map)
                  this.map.hasOwnProperty(M) && w.call(P, this.map[M], M, this);
              }),
            ...
            function m(w) {
              var P = new FileReader(),
                M = _(P);
              return P.readAsArrayBuffer(w), M;
            }
            function h(w) {
              var P = new FileReader(),
                M = _(P);
              return P.readAsText(w), M;
            }
            function g(w) {
              for (
                var P = new Uint8Array(w), M = new Array(P.length), C = 0;
                C < P.length;
                C++
              )
                M[C] = String.fromCharCode(P[C]);
              return M.join("");
            }
            function S(w) {
                ...
                (this._initBody = function (w) {
                  (this._bodyInit = w),
                    w
                      ? typeof w == "string"
                        ? (this._bodyText = w)
                        : s.blob && Blob.prototype.isPrototypeOf(w)
                        ? (this._bodyBlob = w)
                        : s.formData && FormData.prototype.isPrototypeOf(w)
                        ? (this._bodyFormData = w)
                        : s.searchParams &&
                          URLSearchParams.prototype.isPrototypeOf(w)
                        ? (this._bodyText = w.toString())
                        : s.arrayBuffer && s.blob && l(w)
                        ? ((this._bodyArrayBuffer = S(w.buffer)),
                          (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                        : s.arrayBuffer &&
                          (ArrayBuffer.prototype.isPrototypeOf(w) || c(w))
                        ? (this._bodyArrayBuffer = S(w))
                        : (this._bodyText = w =
            ...
            function I(w, P) {
              ...
              if (w instanceof I) {
                ...
                (this.url = w.url),
                  ...
                  P.headers || (this.headers = new v(w.headers)),
                  (this.method = w.method),
                  (this.mode = w.mode),
                  (this.signal = w.signal),
                  !M &&
                    w._bodyInit != null &&
                    ((M = w._bodyInit), (w.bodyUsed = !0));
              } else this.url = String(w);
              if (
                ((this.credentials =
                  P.credentials || this.credentials || "same-origin"),
                (P.headers || !this.headers) &&
                  (this.headers = new v(P.headers)),
                (this.method = N(P.method || this.method || "GET")),
                  ...
                  .forEach(function (M) {
                    if (M) {
                      var C = M.split("="),
                        O = C.shift().replace(/\+/g, " "),
                        A = C.join("=").replace(/\+/g, " ");
                      P.append(decodeURIComponent(O), decodeURIComponent(A));
                    }
                  }),
                P
              );
            ...
            function X(w, P) {
              P || (P = {}),
                ...
                (this.statusText = "statusText" in P ? P.statusText : "OK"),
                (this.headers = new v(P.headers)),
                (this.url = P.url || ""),
                this._initBody(w);
            }
            ...
            (X.redirect = function (w, P) {
              if (ce.indexOf(P) === -1)
                throw new RangeError("Invalid status code");
              return new X(null, { status: P, headers: { location: w } });
            }),
            ...
            function re(w, P) {
              return new Promise(function (M, C) {
                ...
                if (O.signal && O.signal.aborted)
                  return C(new a.DOMException("Aborted", "AbortError"));
                ...
                (A.onload = function () {
                  ...
                  (A.onabort = function () {
                    C(new a.DOMException("Aborted", "AbortError"));
                  }),
                  A.open(O.method, O.url, !0),
                  O.credentials === "include"
                    ? (A.withCredentials = !0)
                    : O.credentials === "omit" && (A.withCredentials = !1),
                  "responseType" in A && s.blob && (A.responseType = "blob"),
                  O.headers.forEach(function (z, b) {
                    A.setRequestHeader(b, z);
                  }),
                  O.signal &&
...
(function (e, t) {
  ...
  if (
    (typeof fetch == "function" &&
      (typeof ls < "u" && ls.fetch
        ? (n = ls.fetch)
        : typeof window < "u" && window.fetch
        ? (n = window.fetch)
        : (n = fetch)),
    typeof lb < "u" && (typeof window > "u" || typeof window.document > "u"))
  ) {
    var r = n || fb();
...
const xg = Ni,
  gp = sg({ __proto__: null, default: xg }, [Ni]);
function Ts(e) {
  return (
    (Ts =
      typeof Symbol == "function" && typeof Symbol.iterator == "symbol"
...
Og() &&
  (typeof global < "u" && global.XMLHttpRequest
    ? (Ai = global.XMLHttpRequest)
    : typeof window < "u" &&
      window.XMLHttpRequest &&
      (Ai = window.XMLHttpRequest));
var Ls;
typeof ActiveXObject == "function" &&
  (typeof global < "u" && global.ActiveXObject
    ? (Ls = global.ActiveXObject)
    : typeof window < "u" &&
      window.ActiveXObject &&
      (Ls = window.ActiveXObject));
!yn && gp && !Ai && !Ls && (yn = xg || gp);
typeof yn != "function" && (yn = void 0);
var fc = function (t, n) {
    if (n && Ts(n) === "object") {
      var r = "";
      for (var o in n)
  ...
  wp = !1,
  db = function (t, n, r, o) {
    t.queryStringParams && (n = fc(n, t.queryStringParams));
    var i = cc(
      {},
  ...
  hb = function (t, n, r, o) {
    r && Ts(r) === "object" && (r = fc("", r).slice(1)),
      t.queryStringParams && (n = fc(n, t.queryStringParams));
    try {
      var i;
      Ai ? (i = new Ai()) : (i = new Ls("MSXML2.XMLHTTP.3.0")),
  ...
  pb = function (t, n, r, o) {
    if (
      ...
      return db(t, n, r, o);
    if (Og() || typeof ActiveXObject == "function") return hb(t, n, r, o);
            ...
            var r = this,
              ...
              i =
                arguments.length > 2 && arguments[2] !== void 0
                  ...
                  : {};
            (this.services = n),
              (this.options = cc(o, this.options || {}, wb())),
              (this.allOptions = i),
              this.services &&
            ...
            if (this.options.addPath) {
              ...
              n.forEach(function (d) {
                ...
                typeof s.options.addPath == "function" &&
                  (p = s.options.addPath(d, r));
                var v = s.services.interpolator.interpolate(p, {
                  lng: d,
                  ns: r,
                });
                s.options.request(s.options, v, l, function (y, _) {
                  (u += 1),
                    c.push(y),
                    f.push(_),
                    u === n.length && typeof a == "function" && a(c, f);
                });
              });
            }
          },
              ...
              u(s),
                ...
                l.forEach(function (c) {
                  n.allOptions.ns.forEach(function (f) {
                    o.read(c, f, "read", null, null, function (d, p) {
                      d &&
                        a.warn(
                          "loading namespace "
                        ...
                        o.loaded("".concat(c, "|").concat(f), d, p);
                    });
                  });
                });
            }
...
function dc() {
  for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
    t[n] = arguments[n];
  (typeof t[0] == "string" && _p[t[0]]) ||
    (typeof t[0] == "string" && (_p[t[0]] = new Date()), Sb.apply(void 0, t));
}
function bp(e, t, n) {
...
function bb(e, t) {
  ...
  if (!t.languages || !t.languages.length)
    return dc("i18n.languages were undefined or empty", t.languages), !0;
...
function No(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
    ...
    i = r.defaultNS,
    a = n || o || Tb();
  if ((a && !a.reportNamespaces && (a.reportNamespaces = new Ab()), !a)) {
    dc(
      "You will need to pass in an i18next instance by using initReactI18next"
    );
    var s = function (G) {
        return Array.isArray(G) ? G[G.length - 1] : G;
      },
      l = [s, {}, !1];
  ...
  var u = mu(mu(mu({}, kb()), a.options.react), t),
    c = u.useSuspense,
    f = u.keyPrefix,
  ...
  L.useEffect(
    function () {
      k.current && !T.current && h(v), (T.current = !1);
    },
    [a, f]
  );
  var N = [m, a, p];
  if (((N.t = m), (N.i18n = a), (N.ready = p), p || (!p && !c))) return N;
...
const Ko = {
  zh_cn: Ot(() => import("./zh-cn-ace621d4.js"), [], import.meta.url),
  zh_tw: Ot(() => import("./zh-tw-47d3ce5e.js"), [], import.meta.url),
  en: Ot(() => import("./en-1067a8eb.js"), [], import.meta.url),
  vi: Ot(() => import("./vi-75c7db25.js"), [], import.meta.url),
};
Ye.use(Pg)
  .use(Lb)
  .use(Cg)
 ...
 */ (function (e) {
  ...
  function r(O) {
    ...
    if (D !== A) {
      O[0] = D;
      e: for (var z = 0, b = O.length, U = b >>> 1; z < U; ) {
        var B = 2 * (z + 1) - 1,
          J = O[B],
          W = B + 1,
          Z = O[W];
        if (0 > o(J, D))
          W < b && 0 > o(Z, J)
            ? ((O[z] = Z), (O[W] = D), (z = W))
            : ((O[z] = J), (O[B] = D), (z = B));
        else if (W < b && 0 > o(Z, D)) (O[z] = Z), (O[W] = D), (z = W);
        else break e;
      }
    }
    return A;
  ...
  function S(O) {
    if (((y = !1), g(O), !v))
      if (n(l) !== null) (v = !0), M(k);
        ...
        var A = n(u);
        A !== null && C(S, A.startTime - O);
      }
  }
  function k(O, A) {
    (v = !1), y && ((y = !1), m(I), (I = -1)), (p = !0);
    var D = d;
    try {
      for (
        g(A), f = n(l);
        f !== null && (!(f.expirationTime > A) || (O && !X()));

      ) {
        var z = f.callback;
        if (typeof z == "function") {
          (f.callback = null), (d = f.priorityLevel);
          var b = z(f.expirationTime <= A);
          (A = e.unstable_now()),
      ...
      return (
        ...
        D > z
          ? ((O.sortIndex = D),
            ...
            n(l) === null &&
              O === n(u) &&
              (y ? (m(I), (I = -1)) : (y = !0), C(S, D - z)))
          : ((O.sortIndex = b), t(l, O), v || p || ((v = !0), M(k))),
        O
      );
    }),
...
function go(e, t) {
  for (Mi[e] = t, e = 0; e < t.length; e++) Ag.add(t[e]);
}
var Sn = !(
    typeof window > "u" ||
...
var Cn = Ng.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Aa(e) {
  e._valueTracker || (e._valueTracker = Hb(e));
}
function Ug(e) {
  if (!e) return !1;
...
function Rc(e, t) {
  if (t) {
    if (Kb[e] && (t.children != null || t.dangerouslySetInnerHTML != null))
      throw Error(j(137, e));
...
function Ap(e) {
  if ((e = fa(e))) {
    if (typeof kc != "function") throw Error(j(280));
    var t = e.stateNode;
    t && ((t = Tl(t)), kc(e.stateNode, e.type, t));
  }
}
function Hg(e) {
...
function qg() {
  if (uo) {
    var e = uo,
      t = co;
    if (((co = uo = null), Ap(e), t)) for (e = 0; e < t.length; e++) Ap(t[e]);
  }
}
function Kg(e, t) {
  return e(t);
...
function Xb(e, t, n, r, o, i, a, s, l) {
  (vi = !1), (As = null), Qb.apply(Gb, arguments);
}
function Yb(e, t, n, r, o, i, a, s, l) {
  if ((Xb.apply(this, arguments), vi)) {
    if (vi) {
      var u = As;
      (vi = !1), (As = null);
...
function Ip(e) {
  if (Dr(e) !== e) throw Error(j(188));
}
function Jb(e) {
  var t = e.alternate;
  if (!t) {
    if (((t = Dr(e)), t === null)) throw Error(j(188));
    return t !== e ? null : e;
  }
  for (var n = e, r = t; ; ) {
    var o = n.return;
...
function Yg(e) {
  return (e = Jb(e)), e !== null ? Jg(e) : null;
}
function Jg(e) {
...
var Zg = mt.unstable_scheduleCallback,
  Mp = mt.unstable_cancelCallback,
  Zb = mt.unstable_shouldYield,
  eE = mt.unstable_requestPaint,
  Ae = mt.unstable_now,
  tE = mt.unstable_getCurrentPriorityLevel,
  ad = mt.unstable_ImmediatePriority,
  ey = mt.unstable_UserBlockingPriority,
  Ms = mt.unstable_NormalPriority,
  nE = mt.unstable_LowPriority,
  ty = mt.unstable_IdlePriority,
  Ol = null,
  an = null;
function rE(e) {
  if (an && typeof an.onCommitFiberRoot == "function")
    try {
      an.onCommitFiberRoot(Ol, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
var qt = Math.clz32 ? Math.clz32 : aE,
  oE = Math.log,
  iE = Math.LN2;
function aE(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((oE(e) / iE) | 0)) | 0;
}
var Ma = 64,
  Da = 4194304;
function ui(e) {
...
function fE(e, t, n, r, o) {
  switch (t) {
    ...
    case "dragenter":
      return (Wn = Xo(Wn, e, t, n, r, o)), !0;
    case "mouseover":
      return (Hn = Xo(Hn, e, t, n, r, o)), !0;
    case "pointerover":
      var i = o.pointerId;
      return Ui.set(i, Xo(Ui.get(i) || null, e, t, n, r, o)), !0;
    case "gotpointercapture":
      return (
        (i = o.pointerId), Fi.set(i, Xo(Fi.get(i) || null, e, t, n, r, o)), !0
      );
  }
  return !1;
}
...
function fs(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = fa(n)), t !== null && ld(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function Yo(e, t) {
  e.blockedOn === t &&
    ...
    Nc ||
      ((Nc = !0),
      mt.unstable_scheduleCallback(mt.unstable_NormalPriority, dE)));
}
function ji(e) {
  function t(o) {
    return Yo(o, e);
  ...
  for (; 0 < In.length && ((n = In[0]), n.blockedOn === null); )
    ly(n), n.blockedOn === null && In.shift();
}
...
function ud(e, t, n, r) {
  if ($s) {
    var o = Ac(e, t, n, r);
    if (o === null) Lu(e, t, r, Us, n), Dp(e, r);
    else if (fE(o, e, t, n, r)) r.stopPropagation();
    else if ((Dp(e, r), t & 4 && -1 < cE.indexOf(e))) {
      for (; o !== null; ) {
        var i = fa(o);
        if (
          (i !== null && oy(i),
          (i = Ac(e, t, n, r)),
          i === null && Lu(e, t, r, Us, n),
          i === o)
        )
          break;
        o = i;
...
var Us = null;
function Ac(e, t, n, r) {
  if (((Us = null), (e = id(r)), (e = mr(e)), e !== null))
...
var Ao = {
  ...
  xl = Te({}, ca, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Jo &&
            (Jo && e.type === "mousemove"
              ? ((bu = e.screenX - Jo.screenX), (Eu = e.screenY - Jo.screenY))
              : (Eu = bu = 0),
            (Jo = e)),
          bu);
    },
  ...
  Fp = St(xl),
  mE = Te({}, xl, { dataTransfer: 0 }),
  gE = St(mE),
  yE = Te({}, ca, { relatedTarget: 0 }),
  Cu = St(yE),
  wE = Te({}, Ao, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  SE = St(wE),
  _E = Te({}, Ao, {
...
var kE = Te({}, ca, {
  ...
  NE = St(LE),
  AE = Te({}, Ao, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  IE = St(AE),
  ME = Te({}, xl, {
    deltaX: function (e) {
  ...
  DE = St(ME),
  $E = [9, 13, 27, 32],
  hd = Sn && "CompositionEvent" in window,
  mi = null;
Sn && "documentMode" in document && (mi = document.documentMode);
var UE = Sn && "TextEvent" in window && !mi,
  fy = Sn && (!hd || (mi && 8 < mi && 11 >= mi)),
...
function FE(e, t) {
  switch (e) {
    case "compositionend":
      return hy(t);
    case "keypress":
      return t.which !== 32 ? null : ((Vp = !0), zp);
    case "textInput":
      return (e = t.data), e === zp && Vp ? null : e;
    default:
      return null;
  }
}
function jE(e, t) {
  if (Gr)
    return e === "compositionend" || (!hd && dy(e, t))
      ? ((e = cy()), (ds = cd = $n = null), (Gr = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (Sn) {
    ...
    if (!Ou) {
      ...
      Hp.setAttribute("oninput", "return;"),
        (Ou = typeof Hp.oninput == "function");
    }
    Ru = Ou;
  } else Ru = !1;
  vy = Ru && (!document.documentMode || 9 < document.documentMode);
}
function qp() {
  gi && (gi.detachEvent("onpropertychange", my), (Bi = gi = null));
}
function my(e) {
  if (e.propertyName === "value" && kl(Bi)) {
    var t = [];
    py(t, Bi, e, id(e)), Gg(zE, t);
  }
}
function WE(e, t, n) {
  e === "focusin"
    ? (qp(), (gi = t), (Bi = n), gi.attachEvent("onpropertychange", my))
    : e === "focusout" && qp();
}
function HE(e) {
...
var Gt = typeof Object.is == "function" ? Object.is : QE;
function zi(e, t) {
  if (Gt(e, t)) return !0;
...
function GE(e) {
  ...
  if (
    ...
    n &&
    n.ownerDocument &&
    gy(n.ownerDocument.documentElement, n)
  ) {
    if (r !== null && pd(n)) {
      if (
        ((t = r.start),
...
var XE = Sn && "documentMode" in document && 11 >= document.documentMode,
  Xr = null,
  Ic = null,
  yi = null,
  Mc = !1;
...
function Pl(e) {
  ...
  var t = Yr[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in wy) return (xu[e] = t[n]);
  return e;
}
var Sy = Pl("animationend"),
  _y = Pl("animationiteration"),
  by = Pl("animationstart"),
  Ey = Pl("transitionend"),
  Cy = new Map(),
  Xp =
...
for (var ku = 0; ku < Xp.length; ku++) {
  var Pu = Xp[ku],
    YE = Pu.toLowerCase(),
    JE = Pu[0].toUpperCase() + Pu.slice(1);
  nr(YE, "on" + JE);
}
nr(Sy, "onAnimationEnd");
nr(_y, "onAnimationIteration");
nr(by, "onAnimationStart");
nr("dblclick", "onDoubleClick");
nr("focusin", "onFocus");
nr("focusout", "onBlur");
nr(Ey, "onTransitionEnd");
...
var ci =
  ...
  ZE = new Set("cancel close invalid load scroll toggle".split(" ").concat(ci));
function Yp(e, t, n) {
...
function Ry(e, t) {
  ...
  if (Is) throw ((e = Tc), (Is = !1), (Tc = null), e);
}
function _e(e, t) {
  var n = t[jc];
  ...
  if (!e[ja]) {
    (e[ja] = !0),
      Ag.forEach(function (n) {
        n !== "selectionchange" && (ZE.has(n) || Tu(n, !1, e), Tu(n, !0, e));
      });
    var t = e.nodeType === 9 ? e : e.ownerDocument;
    t === null || t[ja] || ((t[ja] = !0), Tu("selectionchange", !1, t));
  }
}
function Oy(e, t, n, r) {
  switch (uy(t)) {
  ...
  Gg(function () {
        ...
        for (var h = u, g; h !== null; ) {
          ...
          if (
            (g.tag === 5 &&
              S !== null &&
              ((g = S),
              m !== null && ((S = $i(h, m)), S != null && y.push(Wi(h, S, g)))),
            _)
          )
            break;
          h = h.return;
    ...
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (y = p, m = v, h = 0, g = y; g; g = Hr(g)) h++;
      ...
      if (hd)
        ...
        Gr
          ? dy(e, n) && (I = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (I = "onCompositionStart");
      I &&
        (fy &&
          n.locale !== "ko" &&
          (Gr || I !== "onCompositionStart"
            ? I === "onCompositionEnd" && Gr && (N = cy())
            : (($n = c),
              (cd = "value" in $n ? $n.value : $n.textContent),
              (Gr = !0))),
        (T = Fs(u, I)),
        0 < T.length &&
          ((I = new jp(I, e, null, n, c)),
          f.push({ event: I, listeners: T }),
          N ? (I.data = N) : ((N = hy(n)), N !== null && (I.data = N)))),
        (N = UE ? FE(e, n) : jE(e, n)) &&
...
function Jp(e, t, n, r, o) {
  for (var i = t._reactName, a = []; n !== null && n !== r; ) {
    ...
    s.tag === 5 &&
      ...
      ((s = u),
      o
        ? ((l = $i(n, i)), l != null && a.unshift(Wi(n, l, s)))
        : o || ((l = $i(n, i)), l != null && a.push(Wi(n, l, s)))),
      (n = n.return);
  }
...
function Ba(e, t, n) {
  if (((t = Zp(t)), Zp(e) !== t && n)) throw Error(j(425));
}
function js() {}
var Dc = null,
  $c = null;
...
var Fc = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  r2 =
    typeof queueMicrotask == "function"
      ...
      : typeof ev < "u"
      ? function (e) {
          return ev.resolve(null).then(e).catch(o2);
        }
      : Fc;
function o2(e) {
  setTimeout(function () {
...
var Io = Math.random().toString(36).slice(2),
  ...
  jc = "__reactEvents$" + Io,
  i2 = "__reactListeners$" + Io,
  a2 = "__reactHandles$" + Io;
function mr(e) {
  var t = e[nn];
  if (t) return t;
...
function be(e) {
  0 > Zr || ((e.current = Bc[Zr]), (Bc[Zr] = null), Zr--);
}
function Se(e, t) {
  Zr++, (Bc[Zr] = e.current), (e.current = t);
}
var tr = {},
  Xe = rr(tr),
  st = rr(!1),
...
function nv(e, t, n) {
  if (Xe.current !== tr) throw Error(j(168));
  Se(Xe, t), Se(st, n);
}
function xy(e, t, n) {
  var r = e.stateNode;
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var o in r) if (!(o in t)) throw Error(j(108, Wb(e) || "Unknown", o));
  return Te({}, n, r);
}
function zs(e) {
  return (
...
function or() {
  if (!Au && pn !== null) {
    ...
    try {
      ...
      throw (pn !== null && (pn = pn.slice(e + 1)), Zg(ad, or), o);
    } finally {
      (ve = t), (Au = !1);
    }
  }
...
var eo = [],
  ...
  mn = "";
function fr(e, t) {
  (eo[to++] = Ws), (eo[to++] = Vs), (Vs = e), (Ws = t);
}
function Py(e, t, n) {
  (Ct[Rt++] = vn), (Ct[Rt++] = mn), (Ct[Rt++] = Or), (Or = e);
  var r = vn;
  e = mn;
  var o = 32 - qt(r) - 1;
  (r &= ~(1 << o)), (n += 1);
  ...
  if (30 < i) {
    ...
    (i = (r & ((1 << a) - 1)).toString(32)),
      ...
      (mn = i + e);
  } else (vn = (1 << i) | (n << o) | r), (mn = e);
}
function vd(e) {
  e.return !== null && (fr(e, 1), Py(e, 1, 0));
}
function md(e) {
  for (; e === Vs; )
    (Vs = eo[--to]), (eo[to] = null), (Ws = eo[--to]), (eo[to] = null);
  for (; e === Or; )
    (Or = Ct[--Rt]),
      (Ct[Rt] = null),
      (mn = Ct[--Rt]),
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (vt = e), (pt = qn(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Or !== null ? { id: vn, overflow: mn } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function za(e) {
  ...
  if (
    ...
    if (zc(e)) throw (Ly(), Error(j(418)));
    for (; t; ) Ty(e, t), (t = qn(t.nextSibling));
  }
  if ((iv(e), e.tag === 13)) {
  ...
  } else pt = vt ? qn(e.stateNode.nextSibling) : null;
  return !0;
}
function Ly() {
  for (var e = pt; e; ) e = qn(e.nextSibling);
}
function wo() {
  (pt = vt = null), (Ce = !1);
}
...
var l2 = Cn.ReactCurrentBatchConfig;
function Ft(e, t) {
  if (e && e.defaultProps) {
...
function Lt(e) {
  ...
  if (yd !== e)
    if (((e = { context: e, memoizedValue: t, next: null }), no === null)) {
      if (qs === null) throw Error(j(308));
      (no = e), (qs.dependencies = { lanes: 0, firstContext: e });
    } else no = no.next = e;
  return t;
}
var gr = null;
...
var Nl = {
  ...
  enqueueForceUpdate: function (e, t) {
    ...
    (o.tag = 2),
      t != null && (o.callback = t),
      (t = Kn(e, o, r)),
      t !== null && (Kt(t, e, r, n), ps(t, e, r));
  },
};
function lv(e, t, n, r, o, i, a) {
  return (
    (e = e.stateNode),
...
function My(e, t, n) {
  ...
  return (
    typeof i == "object" && i !== null
      ? (i = Lt(i))
      : ((o = lt(t) ? Rr : Xe.current),
        (r = t.contextTypes),
        (i = (r = r != null) ? yo(e, o) : tr)),
    (t = new t(n, i)),
...
function qc(e, t, n, r) {
  var o = e.stateNode;
  (o.props = n), (o.state = e.memoizedState), (o.refs = Iy), bd(e);
  var i = t.contextType;
  typeof i == "object" && i !== null
    ? (o.context = Lt(i))
    : ((i = lt(t) ? Rr : Xe.current), (o.context = yo(e, i))),
...
function Dy(e) {
      ...
      : h !== null &&
        (h.elementType === k ||
          (typeof k == "object" &&
            ...
            k.$$typeof === Tn &&
            cv(k) === h.type))
      ? ((S = o(h, g.props)), (S.ref = Zo(m, h, g)), (S.return = m), S)
      : ((S = Ss(g.type, g.key, g.props, null, m.mode, S)),
        (S.ref = Zo(m, h, g)),
        (S.return = m),
        S);
  }
  function u(m, h, g, S) {
    return h === null ||
      ...
      ? ((h = Bu(g, m.mode, S)), (h.return = m), h)
      : ((h = o(h, g.children || [])), (h.return = m), h);
  }
  function c(m, h, g, S, k) {
    return h === null || h.tag !== 7
      ? ((h = _r(g, m.mode, S, k)), (h.return = m), h)
      : ((h = o(h, g)), (h.return = m), h);
  }
  function f(m, h, g) {
    if ((typeof h == "string" && h !== "") || typeof h == "number")
      return (h = ju("" + h, m.mode, g)), (h.return = m), h;
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case Na:
          return (
            (g = Ss(h.type, h.key, h.props, null, m.mode, g)),
            (g.ref = Zo(m, null, h)),
            (g.return = m),
            g
          );
      ...
      if (li(h) || Qo(h))
        return (h = _r(h, m.mode, g, null)), (h.return = m), h;
      Va(m, h);
    }
    return null;
  }
  function d(m, h, g, S) {
    ...
    if ((typeof g == "string" && g !== "") || typeof g == "number")
      return k !== null ? null : s(m, h, "" + g, S);
    if (typeof g == "object" && g !== null) {
      switch (g.$$typeof) {
        case Na:
          return g.key === k ? l(m, h, g, S) : null;
        case Kr:
          return g.key === k ? u(m, h, g, S) : null;
        case Tn:
          return (k = g._init), d(m, h, k(g._payload), S);
      }
      if (li(g) || Qo(g)) return k !== null ? null : c(m, h, g, S, null);
      Va(m, g);
    }
    return null;
  }
  function p(m, h, g, S, k) {
    if ((typeof S == "string" && S !== "") || typeof S == "number")
      return (m = m.get(g) || null), s(h, m, "" + S, k);
    if (typeof S == "object" && S !== null) {
      switch (S.$$typeof) {
        case Na:
          return (m = m.get(S.key === null ? g : S.key) || null), l(h, m, S, k);
        case Kr:
          return (m = m.get(S.key === null ? g : S.key) || null), u(h, m, S, k);
        case Tn:
          var T = S._init;
          return p(m, h, g, T(S._payload), k);
      }
      if (li(S) || Qo(S)) return (m = m.get(g) || null), c(h, m, S, k, null);
      Va(h, S);
    }
    return null;
  }
  function v(m, h, g, S) {
    for (
      var k = null, T = null, N = h, I = (h = 0), G = null;
      N !== null && I < g.length;
      I++
    ) {
      N.index > I ? ((G = N), (N = null)) : (G = N.sibling);
      var $ = d(m, N, g[I], S);
      if ($ === null) {
        N === null && (N = G);
        break;
    ...
    if (I === g.length) return n(m, N), Ce && fr(m, I), k;
    if (N === null) {
      for (; I < g.length; I++)
        (N = f(m, g[I], S)),
          N !== null &&
            ((h = i(N, h, I)), T === null ? (k = N) : (T.sibling = N), (T = N));
      return Ce && fr(m, I), k;
    }
    for (N = r(m, N); I < g.length; I++)
      (G = p(N, m, I, g[I], S)),
        G !== null &&
          (e && G.alternate !== null && N.delete(G.key === null ? I : G.key),
          (h = i(G, h, I)),
  ...
  function y(m, h, g, S) {
    ...
    for (
      var T = (k = null), N = h, I = (h = 0), G = null, $ = g.next();
      N !== null && !$.done;
      I++, $ = g.next()
    ) {
      N.index > I ? ((G = N), (N = null)) : (G = N.sibling);
    ...
    if ($.done) return n(m, N), Ce && fr(m, I), k;
    if (N === null) {
      for (; !$.done; I++, $ = g.next())
        ($ = f(m, $.value, S)),
          $ !== null &&
            ((h = i($, h, I)), T === null ? (k = $) : (T.sibling = $), (T = $));
      return Ce && fr(m, I), k;
    }
    for (N = r(m, N); !$.done; I++, $ = g.next())
      ($ = p(N, m, I, $.value, S)),
        $ !== null &&
      ...
      switch (g.$$typeof) {
        case Na:
          e: {
            ...
            g.type === Qr
              ? ((h = _r(g.props.children, m.mode, S, g.key)),
                (h.return = m),
                (m = h))
              : ((S = Ss(g.type, g.key, g.props, null, m.mode, S)),
                (S.ref = Zo(m, h, g)),
        ...
        case Kr:
          e: {
            ...
            (h = Bu(g, m.mode, S)), (h.return = m), (m = h);
          }
          return a(m);
        case Tn:
          return (T = g._init), _(m, h, T(g._payload), S);
      }
      if (li(g)) return v(m, h, g, S);
      if (Qo(g)) return y(m, h, g, S);
      Va(m, g);
    }
    return (typeof g == "string" && g !== "") || typeof g == "number"
      ? ((g = "" + g),
        h !== null && h.tag === 6
          ...
          : (n(m, h), (h = ju(g, m.mode, S)), (h.return = m), (m = h)),
        a(m))
      : n(m, h);
  }
  return _;
...
var So = Dy(!0),
  ...
  Ki = rr(da);
function yr(e) {
  if (e === da) throw Error(j(174));
  return e;
}
function Ed(e, t) {
  switch ((Se(Ki, t), Se(qi, e), Se(sn, da), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var vs = Cn.ReactCurrentDispatcher,
  Mu = Cn.ReactCurrentBatchConfig,
  xr = 0,
  Pe = null,
  De = null,
  je = null,
...
function xd(e, t, n, r, o, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (vs.current = e === null || e.memoizedState === null ? h2 : p2),
    (e = n(r, o)),
    wi)
  ) {
    i = 0;
    do {
      if (((wi = !1), (Qi = 0), 25 <= i)) throw Error(j(301));
      (i += 1),
        (je = De = null),
        (t.updateQueue = null),
        (vs.current = v2),
...
function Du(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    o = e;
    do (i = o.lane), (Pe.lanes |= i), (kr |= i), (o = o.next);
    while (o !== e);
...
function jy(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Pd(Vy.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || i || (je !== null && je.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      Xi(9, zy.bind(null, n, r, o, t), void 0, null),
      Be === null)
    )
      throw Error(j(349));
    xr & 30 || By(n, t, o);
...
function zy(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), Wy(t) && Hy(e);
}
function Vy(e, t, n) {
  return n(function () {
    Wy(t) && Hy(e);
...
function Al(e, t, n, r) {
  ...
  if (De !== null) {
    ...
    if (((i = a.destroy), r !== null && Od(r, a.deps))) {
      o.memoizedState = Xi(t, n, i, r);
      return;
    }
  }
  (Pe.flags |= e), (o.memoizedState = Xi(1 | t, n, i, r));
}
function dv(e, t) {
...
function Xy(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Al(4, 4, Gy.bind(null, t, e), n)
  );
}
function Td() {}
function Yy(e, t) {
...
function Zy(e, t, n) {
  return xr & 21
    ? (Gt(n, t) || ((n = ny()), (Pe.lanes |= n), (kr |= n), (e.baseState = !0)),
      t)
...
function d2(e, t, n) {
  ...
  if (t0(e)) n0(t, o);
    ...
    (n = Ny(e, t, o, r)),
      n !== null && ((o = et()), Kt(n, e, r, o), r0(n, t, r));
  }
}
function t0(e) {
  var t = e.alternate;
...
var Xs = {
  ...
  h2 = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        ms(4194308, 4, Gy.bind(null, t, e), n)
      );
    },
    ...
    useReducer: function (e, t, n) {
      ...
      return (
        ...
        (r.queue = e),
        (e = e.dispatch = f2.bind(null, Pe, e)),
        [r.memoizedState, e]
      );
    },
    useRef: function (e) {
    ...
    useTransition: function () {
      var e = fv(!1),
        t = e[0];
      return (e = c2.bind(null, e[1])), (tn().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (o.queue = i),
        dv(Vy.bind(null, r, i, e), [e]),
        (r.flags |= 2048),
        Xi(9, zy.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  p2 = {
    ...
    useDeferredValue: function (e) {
      var t = Nt();
      return Zy(t, De.memoizedState, e);
    },
    useTransition: function () {
      var e = Du(Gi)[0],
        t = Nt().memoizedState;
  ...
  v2 = {
    ...
    useDeferredValue: function (e) {
      var t = Nt();
      return De === null ? (t.memoizedState = e) : Zy(t, De.memoizedState, e);
    },
    useTransition: function () {
      var e = $u(Gi)[0],
        t = Nt().memoizedState;
...
function hv(e, t, n) {
  ...
  o.has(n) || (o.add(n), (e = T2.bind(null, e, t, n)), t.then(e, e));
}
function pv(e) {
  do {
    var t;
    ...
    : (e === t
        ...
        : ((e.flags |= 128),
          ...
          n.tag === 1 &&
            (n.alternate === null
              ? (n.tag = 17)
              : ((t = wn(-1, 1)), (t.tag = 2), Kn(n, t, 1))),
          (n.lanes |= 1)),
      e);
}
var g2 = Cn.ReactCurrentOwner,
  at = !1;
function Ze(e, t, n, r) {
  t.child = e === null ? $y(t, null, n, r) : So(t, e.child, n, r);
}
  ...
  return (
    ...
    e !== null && !at
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        En(e, t, o))
      : (Ce && n && vd(t), (t.flags |= 1), Ze(e, t, r, o), t.child)
  );
}
function gv(e, t, n, r, o) {
  ...
  if (((i = e.child), !(e.lanes & o))) {
    ...
    if (
      ((n = n.compare), (n = n !== null ? n : zi), n(a, r) && e.ref === t.ref)
    )
      return En(e, t, o);
  }
  return (
  ...
  return (
    ...
    e !== null && !at
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        En(e, t, o))
      : (Ce && r && vd(t), (t.flags |= 1), Ze(e, t, n, o), t.child)
  );
}
function yv(e, t, n, r, o) {
  ...
  if ((ho(t, o), t.stateNode === null))
    gs(e, t), My(t, n, r), qc(t, n, r, o), (r = !0);
  else if (e === null) {
    var a = t.stateNode,
      s = t.memoizedProps;
    a.props = s;
    ...
    s !== f || d !== v || st.current || Ln
      ? (typeof p == "function" && (Hc(t, n, p, r), (v = t.memoizedState)),
        (u = Ln || lv(t, n, u, r, d, v, l) || !1)
          ? (c ||
...
function Gc(e, t, n, r, o, i) {
  l0(e, t);
  var a = (t.flags & 128) !== 0;
  if (!r && !a) return o && rv(t, n, !1), En(e, t, i);
...
function wv(e, t, n, r, o) {
  return wo(), gd(o), (t.flags |= 256), Ze(e, t, n, r), t.child;
}
...
function c0(e, t, n) {
  ...
  if (i) {
    ...
    return (
      ...
      s !== null ? (i = Xn(s, i)) : ((i = _r(i, a, n, null)), (i.flags |= 2)),
      (i.return = t),
      (r.return = t),
      (r.sibling = i),
      (t.child = r),
...
function y2(e, t, n, r, o, i, a) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Uu(Error(j(422)))), Wa(e, t, a, r))
      : t.memoizedState !== null
  ...
  if (o.data === "$!") {
    ...
    return (r = s), (i = Error(j(419))), (r = Uu(i, r, void 0)), Wa(e, t, a, r);
  }
  if (((s = (a & e.childLanes) !== 0), at || s)) {
    if (((r = Be), r !== null)) {
      ...
      (o = o & (r.suspendedLanes | a) ? 0 : o),
        o !== 0 &&
          o !== i.retryLane &&
          ((i.retryLane = o), bn(e, o), Kt(r, e, o, -1));
    }
    return $d(), (r = Uu(Error(j(421)))), Wa(e, t, a, r);
  }
  return o.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function f0(e, t, n) {
  ...
  if ((Se(ke, r), !(t.mode & 1))) t.memoizedState = null;
  else
    switch (o) {
      case "forwards":
    ...
    case 13:
      if (((r = t.memoizedState), r !== null))
        return r.dehydrated !== null
          ? (Se(ke, ke.current & 1), (t.flags |= 128), null)
  ...
  switch ((md(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (za(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Vt !== null && (sf(Vt), (Vt = null)))),
        Jc(e, t),
        qe(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = yr(sn.current)), za(t))) {
          (r = t.stateNode), (n = t.type);
          var i = t.memoizedProps;
          switch (((r[nn] = t), (r[Hi] = i), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
            ...
            case "video":
            case "audio":
              for (o = 0; o < ci.length; o++) _e(ci[o], r);
              break;
            case "source":
              _e("error", r);
              break;
          ...
          e: {
            switch (((a = Oc(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (o = 0; o < ci.length; o++) _e(ci[o], e);
                o = r;
                break;
              case "source":
                _e("error", e), (o = r);
    ...
    case 6:
      if (e && t.stateNode != null) p0(e, t, e.memoizedProps, r);
        ...
        if (((n = yr(Ki.current)), yr(sn.current), za(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[nn] = t),
    ...
    case 13:
      if (
        ...
        if (Ce && pt !== null && t.mode & 1 && !(t.flags & 128))
          ...
          qe(t), (i = !1);
        } else Vt !== null && (sf(Vt), (Vt = null)), (i = !0);
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || ke.current & 1 ? $e === 0 && ($e = 3) : $d())),
          t.updateQueue !== null && (t.flags |= 4),
          qe(t),
          null);
    case 4:
      return (
        _o(), Jc(e, t), e === null && Vi(t.stateNode.containerInfo), qe(t), null
      );
    case 10:
    ...
    case 17:
      return lt(t.type) && Bs(), qe(t), null;
    case 19:
      if ((be(ke), (i = t.memoizedState), i === null)) return qe(t), null;
              ...
              if (((a = Qs(e)), a !== null)) {
                for (
                  ...
                  (i = n),
                    ...
                    (n = n.sibling);
                return Se(ke, (ke.current & 1) | 2), t.child;
              }
              e = e.sibling;
            }
          i.tail !== null &&
...
function E2(e, t) {
  ...
  for ($c = { focusedElem: e, selectionRange: n }, $s = !1, K = t; K !== null; )
...
function v0(e) {
  ...
  t !== null && ((e.alternate = null), v0(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[nn], delete t[Hi], delete t[jc], delete t[i2], delete t[a2])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function nf(e, t, n) {
  ...
  if (r === 5 || r === 6)
    ...
    for (nf(e, t, n), e = e.sibling; e !== null; ) nf(e, t, n), (e = e.sibling);
}
var ze = null,
  zt = !1;
function xn(e, t, n) {
        ...
        e: for (; s !== null; ) {
          switch (s.tag) {
            case 5:
              ...
              break e;
            case 3:
              (ze = s.stateNode.containerInfo), (zt = !0);
              break e;
            case 4:
              (ze = s.stateNode.containerInfo), (zt = !0);
              break e;
...
function y0(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      $t(t, e), en(e), r & 512 && n !== null && ro(n, n.return);
      break;
    case 5:
      if (
        ($t(t, e),
      ...
      if (r & 4 && ((o = e.stateNode), o != null)) {
        ...
        if (((e.updateQueue = null), l !== null))
          try {
            s === "input" && i.type === "radio" && i.name != null && Fg(o, i),
              Oc(s, a);
            var u = Oc(s, i);
    ...
    case 3:
      if (
        ($t(t, e), en(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          ji(t.containerInfo);
        } catch (y) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((Ge = (u = Ge) || c), $t(t, e), (Ge = u)) : $t(t, e),
        en(e),
        r & 8192)
      ) {
        if (
          ...
          for (K = o; K !== null; )
            (a = K),
              ...
              a.tag === 22 && a.memoizedState !== null
                ...
                ? ((l.return = a), (K = l))
                : Ov(o);
        for (; i !== null; ) (K = i), w0(i), (i = i.sibling);
        (K = o), (Ha = s), (Ge = u);
      }
      Cv(e);
    } else
      o.subtreeFlags & 8772 && i !== null ? ((i.return = o), (K = i)) : Cv(e);
  }
}
function Cv(e) {
  for (; K !== null; ) {
...
var R2 = Math.ceil,
  Ys = Cn.ReactCurrentDispatcher,
  Nd = Cn.ReactCurrentOwner,
...
function Kt(e, t, n, r) {
  if (50 < bi) throw ((bi = 0), (of = null), Error(j(185)));
  ua(e, n, r),
    (!(he & 2) || e !== Be) &&
      (e === Be && (!(he & 2) && (Ml |= n), $e === 4 && Mn(e, Ve)),
      ut(e, r),
      n === 1 && he === 0 && !(t.mode & 1) && ((Eo = Ae() + 500), Ll && or()));
}
function ut(e, t) {
  var n = e.callbackNode;
  lE(e, t);
  var r = Ds(e, e === Be ? Ve : 0);
  if (r === 0)
    n !== null && Mp(n), (e.callbackNode = null), (e.callbackPriority = 0);
  else if (((t = r & -r), e.callbackPriority !== t)) {
    if ((n != null && Mp(n), t === 1))
      e.tag === 0 ? s2(xv.bind(null, e)) : ky(xv.bind(null, e)),
        r2(function () {
          !(he & 6) && or();
        }),
        (n = null);
      ...
      n = x0(n, S0.bind(null, e));
    }
    (e.callbackPriority = t), (e.callbackNode = n);
  }
}
function S0(e, t) {
  if (((ys = -1), (ws = 0), he & 6)) throw Error(j(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = el(e, r);
    ...
    he |= 2;
    var i = b0();
    (Be !== e || Ve !== t) && ((hn = null), (Eo = Ae() + 500), Sr(e, t));
    do
      try {
        k2();
        break;
    ...
    wd(),
      (Ys.current = i),
      (he = o),
      Ie !== null ? (t = 0) : ((Be = null), (Ve = 0), (t = $e));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((o = Lc(e)), o !== 0 && ((r = o), (t = af(e, o)))), t === 1)
    )
      throw ((n = Yi), Sr(e, 0), Mn(e, r), ut(e, Ae()), n);
    if (t === 6) Mn(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (Mn(e, r), (r & 130023424) === r && ((t = Id + 500 - Ae()), 10 < t))
          ) {
            if (Ds(e, 0) !== 0) break;
            ...
            e.timeoutHandle = Fc(dr.bind(null, e, it, hn), t);
            break;
          }
          dr(e, it, hn);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Fc(dr.bind(null, e, it, hn), r);
            break;
          }
          dr(e, it, hn);
          break;
  ...
  return ut(e, Ae()), e.callbackNode === n ? S0.bind(null, e) : null;
}
function af(e, t) {
  var n = _i;
  return (
...
function xv(e) {
  ...
  if (n === 1) throw ((n = Yi), Sr(e, 0), Mn(e, t), ut(e, Ae()), n);
...
function Md(e, t) {
  ...
  try {
    ...
    (he = n), he === 0 && ((Eo = Ae() + 500), Ll && or());
  }
}
function Pr(e) {
  Un !== null && Un.tag === 0 && !(he & 6) && po();
  var t = he;
  he |= 1;
  var n = Pt.transition,
    r = ve;
  try {
    if (((Pt.transition = null), (ve = 1), e)) return e();
  } finally {
    (ve = r), (Pt.transition = n), (he = t), !(he & 6) && or();
  }
}
function Dd() {
  (ht = oo.current), be(oo);
...
function Sr(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), n2(n)), Ie !== null))
...
function $d() {
  ($e === 0 || $e === 3 || $e === 2) && ($e = 4),
    Be === null || (!(kr & 268435455) && !(Ml & 268435455)) || Mn(Be, Ve);
}
function el(e, t) {
  var n = he;
  he |= 2;
  var r = b0();
  (Be !== e || Ve !== t) && ((hn = null), Sr(e, t));
  do
    try {
      x2();
      break;
  ...
  while (1);
  if ((wd(), (he = n), (Ys.current = r), Ie !== null)) throw Error(j(261));
  return (Be = null), (Ve = 0), $e;
}
function x2() {
  for (; Ie !== null; ) E0(Ie);
}
function k2() {
  for (; Ie !== null && !Zb(); ) E0(Ie);
}
function E0(e) {
...
function dr(e, t, n) {
  var r = ve,
    o = Pt.transition;
  try {
    (Pt.transition = null), (ve = 1), P2(e, t, n, r);
  } finally {
    (Pt.transition = o), (ve = r);
  }
  return null;
}
function P2(e, t, n, r) {
  ...
  if (Js) throw ((Js = !1), (e = rf), (rf = null), e);
  return (
    Zs & 1 && e.tag !== 0 && po(),
    (i = e.pendingLanes),
    i & 1 ? (e === of ? bi++ : ((bi = 0), (of = e))) : (bi = 0),
    or(),
    null
  );
}
function po() {
  if (Un !== null) {
    var e = ry(Zs),
      ...
      n = ve;
    try {
      if (((Pt.transition = null), (ve = 16 > e ? 16 : e), Un === null))
        var r = !1;
      else {
        if (((e = Un), (Un = null), (Zs = 0), he & 6)) throw Error(j(331));
        var o = he;
        ...
        if (
          ((he = o), or(), an && typeof an.onPostCommitFiberRoot == "function")
        )
          try {
            an.onPostCommitFiberRoot(Ol, e);
          } catch {}
        r = !0;
      }
      return r;
    } finally {
      (ve = n), (Pt.transition = t);
    }
  }
  return !1;
}
...
function T2(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    Be === e &&
      (Ve & n) === n &&
      ($e === 4 || ($e === 3 && (Ve & 130023424) === Ve && 500 > Ae() - Id)
        ? Sr(e, 0)
        : (Ad |= n)),
    ut(e, t);
}
function R0(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = et();
  (e = bn(e, t)), e !== null && (ua(e, t, n), ut(e, n));
}
function L2(e) {
  var t = e.memoizedState,
    n = 0;
...
O0 = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || st.current) at = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (at = !1), w2(e, t, n);
      at = !!(e.flags & 131072);
    }
  else (at = !1), Ce && t.flags & 1048576 && Py(t, Ws, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      gs(e, t), (e = t.pendingProps);
      var o = yo(t, Xe.current);
      ho(t, n), (o = xd(null, t, r, e, o, n));
      var i = kd();
      return (
        (t.flags |= 1),
        typeof o == "object" &&
        ...
        o.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            qc(t, r, e, n),
            (t = Gc(null, t, r, !0, i, n)))
          : ((t.tag = 0), Ce && i && vd(t), Ze(null, t, o, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((u0(t), e === null)) throw Error(j(387));
        (r = t.pendingProps),
          (i = t.memoizedState),
          (o = i.element),
          Ay(e, t),
        ...
        if (((r = a.element), i.isDehydrated))
          if (
            ...
            (o = bo(Error(j(423)), t)), (t = wv(e, t, r, n, o));
            break e;
          } else if (r !== o) {
            (o = bo(Error(j(424)), t)), (t = wv(e, t, r, n, o));
            break e;
          } else
            for (
              pt = qn(t.stateNode.containerInfo.firstChild),
                vt = t,
                Ce = !0,
                Vt = null,
                n = $y(t, null, r, n),
    ...
    case 4:
      return (
        Ed(t, t.stateNode.containerInfo),
        (r = t.pendingProps),
        e === null ? (t.child = So(t, null, r, n)) : Ze(e, t, r, n),
        t.child
      );
    case 11:
      return (
...
function Ss(e, t, n, r, o, i) {
  ...
  if (((r = e), typeof e == "function")) Ud(e) && (a = 1);
    ...
    e: switch (e) {
      case Qr:
        return _r(n.children, o, i, t);
      case nd:
        (a = 8), (o |= 8);
        break;
      case mc:
        return (
          (e = xt(12, n, t, o | 2)), (e.elementType = mc), (e.lanes = i), e
        );
      case gc:
        return (e = xt(13, n, t, o)), (e.elementType = gc), (e.lanes = i), e;
      case yc:
        return (e = xt(19, n, t, o)), (e.elementType = yc), (e.lanes = i), e;
      case Dg:
        return Dl(n, o, i, t);
      default:
...
Ul.prototype.render = Bd.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(j(409));
  $l(e, t, null, null);
};
Ul.prototype.unmount = Bd.prototype.unmount = function () {
...
function U2(e, t, n, r, o) {
  ...
  var l = Fd(e, 0, !1, null, null, !1, !1, "", Tv);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (sd(t, n | 1), ut(t, Ae()), !(he & 6) && ((Eo = Ae() + 500), or()));
      }
      break;
    case 13:
      Pr(function () {
...
Kg = Md;
Qg = Pr;
var F2 = { usingClientEntryPoint: !1, Events: [fa, Jr, Tl, Hg, qg, Md] },
  ti = {
  ...
  j2 = {
    ...
    findFiberByHostInstance: ti.findFiberByHostInstance || $2,
...
wt.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = P0(t, null, e, 1, n ?? null, o, !1, i, a)),
    (e[_n] = t.current),
    Vi(e),
    r)
  )
...
var N0,
  Lv = mo;
(N0 = Lv.createRoot), Lv.hydrateRoot;
var nl = {},
  B2 = {
    get exports() {
      return nl;
...
(function (e, t) {
  ...
  function a(f) {
    ...
    try {
      var p = window.getComputedStyle(f),
        v = p.getPropertyValue("display");
      return d ? v !== r && i(f, p) : v === n;
    } catch {
  ...
  function s(f) {
    for (
      var d = f, p = f.getRootNode && f.getRootNode();
      d && d !== document.body;

    ) {
      if ((p && d === p && (d = p.host.parentNode), a(d))) return !1;
      d = d.parentNode;
    }
    return !0;
  }
  function l(f, d) {
    var p = f.nodeName.toLowerCase(),
      v = (o.test(p) && !f.disabled) || (p === "a" && f.href) || d;
    return v && s(f);
  }
  function u(f) {
  ...
  function c(f) {
    var d = [].slice.call(f.querySelectorAll("*"), 0).reduce(function (p, v) {
      return p.concat(v.shadowRoot ? c(v.shadowRoot) : [v]);
    }, []);
    return d.filter(u);
  }
  e.exports = t.default;
...
Xt.handleBlur = Zi;
Xt.handleFocus = ea;
Xt.markForFocusLater = eC;
Xt.returnFocus = tC;
Xt.popWithoutFocus = nC;
Xt.setupScopedFocus = rC;
Xt.teardownScopedFocus = oC;
var G2 = Ji,
  X2 = Y2(G2);
function Y2(e) {
...
function ea() {
  if (lf) {
    if (((lf = !1), !io)) return;
    setTimeout(function () {
      if (!io.contains(document.activeElement)) {
        var e = (0, X2.default)(io)[0] || io;
        e.focus();
      }
    }, 0);
  }
...
function eC() {
  Co.push(document.activeElement);
}
function tC() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
    t = null;
  try {
    Co.length !== 0 && ((t = Co.pop()), t.focus({ preventScroll: e }));
    return;
  } catch {
    console.warn(
      [
...
function rC(e) {
  (io = e),
    window.addEventListener
      ...
      : (window.attachEvent("onBlur", Zi), document.attachEvent("onFocus", ea));
}
function oC() {
  (io = null),
    window.addEventListener
      ? (window.removeEventListener("blur", Zi),
        document.removeEventListener("focus", ea))
      : (window.detachEvent("onBlur", Zi), document.detachEvent("onFocus", ea));
}
var ol = {},
  iC = {
    get exports() {
...
var Bl = cC.default,
  dC = Bl.canUseDOM ? window.HTMLElement : {};
Qt.SafeHTMLCollection = Bl.canUseDOM ? window.HTMLCollection : {};
Qt.SafeNodeList = Bl.canUseDOM ? window.NodeList : {};
Qt.canUseDOM = Bl.canUseDOM;
Qt.default = dC;
Object.defineProperty(Yt, "__esModule", { value: !0 });
Yt.resetState = gC;
Yt.log = yC;
Yt.assertNodeList = M0;
Yt.setElement = wC;
Yt.validateElement = Vd;
Yt.hide = SC;
Yt.show = _C;
Yt.documentNotReadyOrSSRTesting = bC;
var hC = sC,
  pC = mC(hC),
  vC = Qt;
function mC(e) {
...
function wC(e) {
  var t = e;
  if (typeof t == "string" && vC.canUseDOM) {
...
function EC() {
  ...
  for (var t in Ei) Nv(e, Ei[t]);
  var n = document.body;
  for (var r in Ci) Nv(n, Ci[r]);
  (Ei = {}), (Ci = {});
}
function CC() {}
var RC = function (t, n) {
  ...
  kC = function (t, n, r) {
    r.forEach(function (o) {
      OC(n, o), n[o] === 0 && t.remove(o);
    });
  };
Mo.add = function (t, n) {
  return xC(
    t.classList,
    t.nodeName.toLowerCase() == "html" ? Ei : Ci,
    n.split(" ")
  );
};
...
function TC() {
  console.log("portalOpenInstances ----------"),
    console.log(il.openInstances.length),
    il.openInstances.forEach(function (e) {
...
var Ke = void 0,
  ...
  br = [];
function MC() {
  for (var e = [Ke, jt], t = 0; t < e.length; t++) {
    var n = e[t];
...
function DC() {
  console.log("bodyTrap ----------"), console.log(br.length);
  for (var e = [Ke, jt], t = 0; t < e.length; t++) {
    var n = e[t],
      r = n || {};
...
function $C(e, t) {
  !Ke &&
    ...
    Ke.addEventListener("focus", Av),
    (jt = Ke.cloneNode()),
    jt.addEventListener("focus", Av)),
    (br = t),
    br.length > 0
      ? (document.body.firstChild !== Ke &&
          document.body.insertBefore(Ke, document.body.firstChild),
        document.body.lastChild !== jt && document.body.appendChild(jt))
      : (Ke.parentElement && Ke.parentElement.removeChild(Ke),
        jt.parentElement && jt.parentElement.removeChild(jt));
}
AC.default.subscribe($C);
(function (e, t) {
  ...
  var n =
      ...
      function (w) {
        for (var P = 1; P < arguments.length; P++) {
          var M = arguments[P];
          for (var C in M)
            Object.prototype.hasOwnProperty.call(M, C) && (w[C] = M[C]);
        }
        return w;
      },
    r =
    ...
    o = (function () {
      ...
      return function (P, M, C) {
        return M && w(P.prototype, M), C && w(P, C), P;
      };
    })(),
    i = L,
    a = xe,
  ...
  function S(w) {
    ...
    if (w != null)
      for (var M in w)
        Object.prototype.hasOwnProperty.call(w, M) && (P[M] = w[M]);
  ...
  var G = { overlay: "ReactModal__Overlay", content: "ReactModal__Content" },
    ...
    re = (function (w) {
      ...
      function P(M) {
        ...
        var C = N(
          this,
          (P.__proto__ || Object.getPrototypeOf(P)).call(this, M)
        );
        return (
          (C.setOverlayRef = function (O) {
            (C.overlay = O), C.props.overlayRef && C.props.overlayRef(O);
          }),
          (C.setContentRef = function (O) {
            (C.content = O), C.props.contentRef && C.props.contentRef(O);
          }),
          (C.afterClose = function () {
            var O = C.props,
              A = O.appElement,
              D = O.ariaHideApp,
              z = O.htmlOpenClassName,
              b = O.bodyOpenClassName,
              U = O.parentSelector,
              B = (U && U().ownerDocument) || document;
            b && y.remove(B.body, b),
              z && y.remove(B.getElementsByTagName("html")[0], z),
              D && ce > 0 && ((ce -= 1), ce === 0 && p.show(A)),
              C.props.shouldFocusAfterRender &&
                (C.props.shouldReturnFocusAfterClose
                  ? (u.returnFocus(C.props.preventScroll),
                    u.teardownScopedFocus())
                  : u.popWithoutFocus()),
              C.props.onAfterClose && C.props.onAfterClose(),
              g.default.deregister(C);
          }),
          (C.open = function () {
            C.beforeOpen(),
              C.state.afterOpen && C.state.beforeClose
                ? (clearTimeout(C.closeTimer), C.setState({ beforeClose: !1 }))
                : (C.props.shouldFocusAfterRender &&
                    (u.setupScopedFocus(C.node), u.markForFocusLater()),
          ...
          (C.closeWithTimeout = function () {
            var O = Date.now() + C.props.closeTimeoutMS;
            C.setState({ beforeClose: !0, closesAt: O }, function () {
          ...
          (C.handleKeyDown = function (O) {
            $(O) && (0, f.default)(C.content, O),
              C.props.shouldCloseOnEsc &&
                X(O) &&
                (O.stopPropagation(), C.requestClose(O));
          }),
          (C.handleOverlayOnClick = function (O) {
            C.shouldClose === null && (C.shouldClose = !0),
              C.shouldClose &&
                C.props.shouldCloseOnOverlayClick &&
                (C.ownerHandlesClose() ? C.requestClose(O) : C.focusContent()),
              (C.shouldClose = null);
          }),
          (C.handleContentOnMouseUp = function () {
            C.shouldClose = !1;
          }),
          (C.handleOverlayOnMouseDown = function (O) {
            !C.props.shouldCloseOnOverlayClick &&
              O.target == C.overlay &&
              O.preventDefault();
          }),
          ...
          (C.requestClose = function (O) {
            return C.ownerHandlesClose() && C.props.onRequestClose(O);
          }),
          ...
          (C.buildClassName = function (O, A) {
            var D =
                (typeof A > "u" ? "undefined" : r(A)) === "object"
                  ? A
                  : {
                      base: G[O],
                      afterOpen: G[O] + "--after-open",
                      beforeClose: G[O] + "--before-close",
                    },
              z = D.base;
            return (
              C.state.afterOpen && (z = z + " " + D.afterOpen),
              C.state.beforeClose && (z = z + " " + D.beforeClose),
              typeof A == "string" && A ? z + " " + A : z
            );
          }),
          (C.attributesFromObject = function (O, A) {
            return Object.keys(A).reduce(function (D, z) {
              return (D[O + "-" + z] = A[z]), D;
            }, {});
          }),
      ...
      return (
        o(P, [
          ...
          },
          {
            ...
            value: function (C, O) {
              this.props.isOpen && !C.isOpen
                ? this.open()
                : !this.props.isOpen && C.isOpen && this.close(),
          ...
          },
          {
            ...
            value: function () {
              var C = this.props,
                O = C.appElement,
                A = C.ariaHideApp,
                D = C.htmlOpenClassName,
                z = C.bodyOpenClassName,
                b = C.parentSelector,
                U = (b && b().ownerDocument) || document;
              z && y.add(U.body, z),
                D && y.add(U.getElementsByTagName("html")[0], D),
                A && ((ce += 1), p.hide(O)),
          ...
          },
          {
            ...
            value: function () {
              ...
              var J = {
                ...
                W = n(
                  {
                    ...
                    style: n({}, U, this.props.style.content),
                ...
                Z = this.props.contentElement(W, b);
              return this.props.overlayElement(J, Z);
            },
          },
        ]),
        P
  ...
  (re.defaultProps = {
    ...
    (re.propTypes = {
      ...
      appElement: s.default.oneOfType([
        ...
        s.default.instanceOf(_.SafeHTMLCollection),
        s.default.instanceOf(_.SafeNodeList),
...
$0.__suppressDeprecationWarning = !0;
U0.__suppressDeprecationWarning = !0;
F0.__suppressDeprecationWarning = !0;
function UC(e) {
  var t = e.prototype;
...
https://fb.me/react-async-component-lifecycle-hooks`
  ...
  if (
    (typeof e.getDerivedStateFromProps == "function" &&
      ((t.componentWillMount = $0), (t.componentWillReceiveProps = U0)),
    typeof t.getSnapshotBeforeUpdate == "function")
  ) {
...
Tr.bodyOpenClassName = Tr.portalClassName = void 0;
var Iv =
    Object.assign ||
    function (e) {
      for (var t = 1; t < arguments.length; t++) {
...
var YC = (Tr.portalClassName = "ReactModalPortal"),
  JC = (Tr.bodyOpenClassName = "ReactModal__Body--open"),
  hr = Fn.canUseDOM && sl.default.createPortal !== void 0,
  Uv = function (t) {
    return document.createElement(t);
  },
  Fv = function () {
    return hr
      ? sl.default.createPortal
      : sl.default.unstable_renderSubtreeIntoContainer;
  };
function Qa(e) {
  return e();
}
    ...
    return (
      (i =
        ...
        (o.removePortal = function () {
          !hr && sl.default.unmountComponentAtNode(o.node);
        ...
        (o.renderPortal = function (u) {
          var c = Fv(),
            f = c(
              o,
              al.default.createElement(
                Mv.default,
                Iv({ defaultStyles: t.defaultStyles }, u)
              ),
              o.node
            );
          o.portalRef(f);
      ...
      [
        {
          ...
          value: function () {
            if (Fn.canUseDOM) {
              ...
              r.appendChild(this.node), !hr && this.renderPortal(this.props);
            }
          },
        },
        {
          ...
          value: function (r, o, i) {
            if (Fn.canUseDOM) {
              ...
              c !== u && (u.removeChild(this.node), c.appendChild(this.node)),
                !(!r.isOpen && !s) && !hr && this.renderPortal(this.props);
            }
          },
        },
        {
          key: "componentWillUnmount",
          value: function () {
            if (!(!Fn.canUseDOM || !this.node || !this.portal)) {
        ...
        },
        {
          key: "render",
          value: function () {
            if (!Fn.canUseDOM || !hr) return null;
            !this.node && hr && (this.node = Uv("div"));
            var r = Fv();
            return r(
              al.default.createElement(
                Mv.default,
...
pa.propTypes = {
  ...
  appElement: oe.default.oneOfType([
    oe.default.instanceOf(Dv.default),
    oe.default.instanceOf(Fn.SafeHTMLCollection),
    oe.default.instanceOf(Fn.SafeNodeList),
    oe.default.arrayOf(oe.default.instanceOf(Dv.default)),
  ]),
...
pa.defaultProps = {
  ...
  overlayElement: function (t, n) {
    return al.default.createElement("div", t, n);
  },
...
function l$(e, t, n) {
  return ga(e)
    ? typeof t == "function"
      ? de({}, n, { mutationKey: e, mutationFn: t })
      : de({}, t, { mutationKey: e })
    : typeof e == "function"
    ? de({}, t, { mutationFn: e })
    : de({}, e);
...
function Nn(e, t, n) {
  return ga(e) ? [de({}, t, { queryKey: e }), n] : [e || {}, t];
}
function eR(e, t) {
...
function jv(e, t) {
  ...
  if (ga(s)) {
    if (r) {
      if (t.queryHash !== Hd(s, t.options)) return !1;
    } else if (!cl(t.queryKey, s)) return !1;
  }
  var u = eR(n, i);
  if (u === "none") return !1;
  if (u !== "all") {
...
function Bv(e, t) {
  ...
  if (ga(i)) {
    ...
    if (n) {
      if (wr(t.options.mutationKey) !== wr(i)) return !1;
    } else if (!cl(t.options.mutationKey, i)) return !1;
  }
  return !(
...
function Hd(e, t) {
  var n = (t == null ? void 0 : t.queryKeyHashFn) || wr;
  return n(e);
}
function wr(e) {
  var t = ul(e);
...
function ff(e) {
  ...
  var n = t.prototype;
  return !(!zv(n) || !n.hasOwnProperty("isPrototypeOf"));
}
function zv(e) {
...
var oR = (function (e) {
    ...
    function t() {
      ...
      return (
        ...
        (r.setup = function (o) {
          var i;
          if (!ll && (i = window) != null && i.addEventListener) {
            var a = function () {
              return o();
            };
            return (
    ...
    var l = function (p) {
      ...
      c = function () {
        return new Promise(function (p) {
          (i = p), (n.isPaused = !0), t.onPause == null || t.onPause();
        }).then(function () {
          (i = void 0),
            (n.isPaused = !1),
      ...
      f = function d() {
        if (!n.isResolved) {
          ...
          (o = function (y) {
            if (
              !n.isResolved &&
              (u(new H0(y)), n.abort == null || n.abort(), dl(p))
            )
              try {
                p.cancel();
              } catch {}
          }),
            (n.isTransportCancelable = dl(p)),
            Promise.resolve(p)
              .then(l)
              .catch(function (v) {
                var y, _;
                if (!n.isResolved) {
                  var m = (y = t.retry) != null ? y : 3,
                    h = (_ = t.retryDelay) != null ? _ : aR,
                    g = typeof h == "function" ? h(n.failureCount, v) : h,
                    S =
                      m === !0 ||
                  ...
                  n.failureCount++,
                    ...
                    rR(g)
                      .then(function () {
                        if (!Ri.isFocused() || !bs.isOnline()) return c();
                      })
                      .then(function () {
                        r ? u(v) : d();
                      });
...
var uR = (function () {
    ...
    return (
      (t.setOptions = function (r) {
        var o;
        (this.options = de({}, this.defaultOptions, r)),
      ...
      (t.setData = function (r, o) {
        ...
        return (
          (i = (a = this.options).isDataEqual) != null && i.call(a, s, l)
            ? (l = s)
            : this.options.structuralSharing !== !1 && (l = fl(s, l)),
          this.dispatch({
            data: l,
            type: "success",
      ...
      (t.setState = function (r, o) {
        this.dispatch({ type: "setState", state: r, setStateOptions: o });
      }),
      (t.cancel = function (r) {
        var o,
          i = this.promise;
        return (
          ...
          i ? i.then(Qe).catch(Qe) : Promise.resolve()
        );
      }),
      (t.destroy = function () {
      ...
      (t.fetch = function (r, o) {
        ...
        if ((a = this.options.behavior) != null && a.onFetch) {
          var _;
          (_ = this.options.behavior) == null || _.onFetch(y);
        }
        if (
            ...
            onSuccess: function (g) {
              i.setData(g),
                i.cache.config.onSuccess == null ||
                  i.cache.config.onSuccess(g, i),
                i.cacheTime === 0 && i.optionalRemove();
            },
            onError: function (g) {
              (Es(g) && g.silent) || i.dispatch({ type: "error", error: g }),
                Es(g) ||
                  (i.cache.config.onError == null ||
                    i.cache.config.onError(g, i),
                  hl().error(g)),
                i.cacheTime === 0 && i.optionalRemove();
            },
            onFail: function () {
        ...
        (this.state = this.reducer(this.state, r)),
          Ne.batch(function () {
            o.observers.forEach(function (i) {
              ...
              o.cache.notify({ query: o, type: "queryUpdated", action: r });
          });
      }),
      ...
      (t.reducer = function (r, o) {
        ...
        switch (o.type) {
          case "failed":
            return de({}, r, { fetchFailureCount: r.fetchFailureCount + 1 });
          case "pause":
            return de({}, r, { isPaused: !0 });
          case "continue":
            return de({}, r, { isPaused: !1 });
          case "fetch":
            return de(
              {},
              r,
          ...
          case "error":
            var s = o.error;
            return Es(s) && s.revert && this.revertState
              ? de({}, this.revertState)
              : de({}, r, {
                  error: s,
  ...
  Q0 = (function (e) {
    ...
    var n = t.prototype;
    return (
      (n.build = function (o, i, a) {
        var s,
          l = i.queryKey,
          u = (s = i.queryHash) != null ? s : Hd(l, i),
          c = this.get(u);
        return (
          c ||
            ((c = new uR({
  ...
  cR = (function () {
    function e(n) {
      (this.options = de({}, n.defaultOptions, n.options)),
        (this.mutationId = n.mutationId),
        (this.mutationCache = n.mutationCache),
        (this.observers = []),
        (this.state = n.state || fR()),
        (this.meta = n.meta);
    }
    var t = e.prototype;
    return (
      ...
      (t.cancel = function () {
        return this.retryer
          ? (this.retryer.cancel(), this.retryer.promise.then(Qe).catch(Qe))
          : Promise.resolve();
      }),
      (t.continue = function () {
        return this.retryer
          ...
          a
            ...
            .then(function () {
              return r.options.onSuccess == null
                ? void 0
                : r.options.onSuccess(o, r.state.variables, r.state.context);
            })
            .then(function () {
...
function dR(e, t) {
  switch (t.type) {
    case "failed":
      return de({}, e, { failureCount: e.failureCount + 1 });
    case "pause":
      return de({}, e, { isPaused: !0 });
    case "continue":
      return de({}, e, { isPaused: !1 });
    case "loading":
      return de({}, e, {
        context: t.context,
        data: void 0,
    ...
    onFetch: function (t) {
      t.fetchFn = function () {
        var n,
          ...
          v = ((s = t.state.data) == null ? void 0 : s.pageParams) || [],
          y = W0(),
          ...
          S = function (w, P, M, C) {
            return (
              (m = C ? [P].concat(m) : [].concat(m, [P])),
              C ? [M].concat(w) : [].concat(w, [M])
            );
          },
          k = function (w, P, M, C) {
            if (h) return Promise.reject("Cancelled");
            if (typeof M > "u" && !P && w.length) return Promise.resolve(w);
            var O = {
                queryKey: t.queryKey,
                signal: _,
                pageParam: M,
              ...
              A = g(O),
              D = Promise.resolve(A).then(function (b) {
                return S(w, M, b, C);
              });
            if (dl(A)) {
              var z = D;
        ...
        if (!p.length) T = k([]);
          ...
          (function () {
            ...
            var re = typeof t.options.getNextPageParam > "u",
              w = l && p[0] ? l(p[0], 0, p) : !0;
            T = w ? k([], re, v[0]) : Promise.resolve(S([], v[0], p[0]));
            for (
              var P = function (O) {
                  T = T.then(function (A) {
                    var D = l && p[O] ? l(p[O], O, p) : !0;
                    if (D) {
                      var z = re ? v[O] : Wv(t.options, A);
                      return k(A, re, z);
                    }
                    return Promise.resolve(S(A, v[O], p[O]));
                  });
                },
                M = 1;
              M < p.length;
        ...
        var X = T.then(function (re) {
            return { pages: re, pageParams: m };
          }),
          ce = X;
        return (
          (ce.cancel = function () {
            (h = !0), y == null || y.abort(), dl(T) && T.cancel();
          }),
          X
        );
      };
...
var mR = (function () {
    function e(n) {
      n === void 0 && (n = {}),
        (this.queryCache = n.queryCache || new Q0()),
    ...
    return (
      (t.mount = function () {
        var r = this;
        (this.unsubscribeFocus = Ri.subscribe(function () {
          Ri.isFocused() &&
            bs.isOnline() &&
      ...
      (t.isMutating = function (r) {
        return this.mutationCache.findAll(de({}, r, { fetching: !0 })).length;
      }),
      ...
      (t.cancelQueries = function (r, o, i) {
        ...
        var f = Ne.batch(function () {
          return a.queryCache.findAll(l).map(function (d) {
            return d.cancel(c);
          });
        });
        return Promise.all(f).then(Qe).catch(Qe);
      }),
      (t.invalidateQueries = function (r, o, i) {
        var a,
          ...
          p = de({}, f, {
            active:
              (a = (s = f.refetchActive) != null ? s : f.active) != null
                ? a
                : !0,
        ...
        return Ne.batch(function () {
          return (
            u.queryCache.findAll(f).forEach(function (v) {
              v.invalidate();
            }),
      ...
      (t.refetchQueries = function (r, o, i) {
        var a = this,
          ...
          f = Promise.all(c).then(Qe);
        return (u != null && u.throwOnError) || (f = f.catch(Qe)), f;
      }),
      ...
      (t.prefetchQuery = function (r, o, i) {
        return this.fetchQuery(r, o, i).then(Qe).catch(Qe);
      }),
      (t.fetchInfiniteQuery = function (r, o, i) {
        var a = _s(r, o, i);
        return (a.behavior = pR()), this.fetchQuery(a);
      }),
      (t.prefetchInfiniteQuery = function (r, o, i) {
        return this.fetchInfiniteQuery(r, o, i).then(Qe).catch(Qe);
      }),
      (t.cancelMutations = function () {
        ...
        return Promise.all(o).then(Qe).catch(Qe);
      }),
      ...
      (t.setQueryDefaults = function (r, o) {
        var i = this.queryDefaults.find(function (a) {
          return wr(r) === wr(a.queryKey);
        });
        i
          ? (i.defaultOptions = o)
          : this.queryDefaults.push({ queryKey: r, defaultOptions: o });
      }),
      (t.getQueryDefaults = function (r) {
        var o;
        return r
          ? (o = this.queryDefaults.find(function (i) {
              return cl(r, i.queryKey);
            })) == null
            ? void 0
            : o.defaultOptions
          : void 0;
      ...
      (t.setMutationDefaults = function (r, o) {
        var i = this.mutationDefaults.find(function (a) {
          return wr(r) === wr(a.mutationKey);
        });
        i
          ? (i.defaultOptions = o)
          : this.mutationDefaults.push({ mutationKey: r, defaultOptions: o });
      }),
      (t.getMutationDefaults = function (r) {
        var o;
        return r
          ? (o = this.mutationDefaults.find(function (i) {
              return cl(r, i.mutationKey);
            })) == null
            ? void 0
            : o.defaultOptions
          : void 0;
      ...
      (t.defaultQueryOptions = function (r) {
        ...
        return (
          !o.queryHash && o.queryKey && (o.queryHash = Hd(o.queryKey, o)), o
        );
      }),
    ...
    return (
      ...
      (n.onSubscribe = function () {
        this.listeners.length === 1 &&
          ...
          Hv(this.currentQuery, this.options) && this.executeFetch(),
          this.updateTimers());
      }),
      (n.onUnsubscribe = function () {
      ...
      (n.setOptions = function (o, i) {
        ...
        l && qv(this.currentQuery, s, this.options, a) && this.executeFetch(),
          this.updateResult(i),
          l &&
            (this.currentQuery !== s ||
      ...
      (n.trackResult = function (o, i) {
        var a = this,
          s = {},
          l = function (c) {
            a.trackedProps.includes(c) || a.trackedProps.push(c);
          };
        return (
      ...
      (n.executeFetch = function (o) {
        ...
        return (o != null && o.throwOnError) || (i = i.catch(Qe)), i;
      }),
      (n.updateStaleTimeout = function () {
        var o = this;
        if (
          (this.clearStaleTimeout(),
          !(ll || this.currentResult.isStale || !cf(this.options.staleTime)))
        ) {
          var i = z0(this.currentResult.dataUpdatedAt, this.options.staleTime),
            a = i + 1;
      ...
      (n.updateRefetchInterval = function (o) {
        ...
        this.clearRefetchInterval(),
          ...
          !(
            ...
            !cf(this.currentRefetchInterval) ||
            this.currentRefetchInterval === 0
          ) &&
            (this.refetchIntervalId = setInterval(function () {
              (i.options.refetchIntervalInBackground || Ri.isFocused()) &&
                i.executeFetch();
      ...
      (n.createResult = function (o, i) {
        var a = this.currentQuery,
          ...
          f = o !== a,
          d = f ? o.state : this.currentQueryInitialState,
        ...
        if (
          ...
          (T = p.data), (y = p.dataUpdatedAt), (g = p.status), (S = !0);
            ...
            try {
              (this.selectFn = i.select),
                ...
                i.structuralSharing !== !1 &&
                  (T = fl(l == null ? void 0 : l.data, T)),
                (this.selectResult = T),
                (this.selectError = null);
            } catch (ce) {
              hl().error(ce), (this.selectError = ce);
            }
        else T = v.data;
        if (
          ...
          if (
            ...
            try {
              ($ = i.select($)),
                i.structuralSharing !== !1 &&
                  ($ = fl(l == null ? void 0 : l.data, $)),
                (this.selectError = null);
            } catch (ce) {
              hl().error(ce), (this.selectError = ce);
            }
          typeof $ < "u" && ((g = "success"), (T = $), (k = !0));
        }
        this.selectError &&
          ((_ = this.selectError),
          (T = this.selectResult),
      ...
      (n.onQueryUpdate = function (o) {
        ...
        o.type === "success"
          ? (i.onSuccess = !0)
          : o.type === "error" && !Es(o.error) && (i.onError = !0),
          this.updateResult(i),
...
function Hv(e, t) {
  return yR(e, t) || (e.state.dataUpdatedAt > 0 && df(e, t, t.refetchOnMount));
}
function df(e, t, n) {
  if (t.enabled !== !1) {
    var r = typeof n == "function" ? n(e) : n;
    return r === "always" || (r !== !1 && qd(e, t));
  }
  return !1;
}
function qv(e, t, n, r) {
...
var wR = L0.unstable_batchedUpdates;
Ne.setBatchNotifyFunction(wR);
var SR = console;
lR(SR);
var Kv = V.createContext(void 0),
  G0 = V.createContext(!1);
function X0(e) {
  return e && typeof window < "u"
    ? (window.ReactQueryClientContext || (window.ReactQueryClientContext = Kv),
      window.ReactQueryClientContext)
    : Kv;
}
var _R = function () {
    var t = V.useContext(X0(V.useContext(G0)));
    if (!t)
  ...
  bR = function (t) {
    ...
    return V.createElement(
      G0.Provider,
      { value: o },
      V.createElement(a.Provider, { value: n }, i)
    );
  };
function ER() {
  var e = !1;
...
var CR = V.createContext(ER()),
  RR = function () {
    return V.useContext(CR);
  };
function OR(e, t, n) {
...
function xR(e, t) {
  ...
  if (
    ...
    throw u
      ...
      .then(function (f) {
        var d = f.data;
        s.onSuccess == null || s.onSuccess(d),
          s.onSettled == null || s.onSettled(d, null);
      })
      .catch(function (f) {
        a.clearReset(),
          s.onError == null || s.onError(f),
          s.onSettled == null || s.onSettled(void 0, f);
      });
  if (
    c.isError &&
    !a.isReset() &&
    !c.isFetching &&
    OR(s.suspense, s.useErrorBoundary, [c.error, u.getCurrentQuery()])
  )
    throw c.error;
...
function kR(e) {
  ...
  function n(o, i) {
    ...
    return s + "#" + (typeof i == "string" ? i : na(i));
  }
  function r(o, i) {
    PR(
      o.pathname.charAt(0) === "/",
...
function LR(e, t, n, r) {
  ...
  let { window: o = document.defaultView, v5Compat: i = !1 } = r,
    ...
    l = null,
    u = c();
  u == null && ((u = 0), a.replaceState(ta({}, a.state, { idx: u }), ""));
  function c() {
  ...
  function f() {
    ...
    let _ = c(),
      m = _ == null ? null : _ - u;
    (u = _), l && l({ action: s, location: y.location, delta: m });
  }
  function d(_, m) {
    s = jn.Push;
    let h = hf(y.location, _, m);
    n && n(h, _), (u = c() + 1);
    let g = Gv(h, u),
      S = y.createHref(h);
    try {
  ...
  let y = {
    ...
    listen(_) {
      ...
      return (
        o.addEventListener(Qv, f),
        (l = _),
        () => {
          o.removeEventListener(Qv, f), (l = null);
        }
      );
    },
    createHref(_) {
...
function NR(e, t, n) {
  ...
  AR(i);
  let a = null;
  for (let s = 0; a == null && s < i.length; ++s) a = zR(i[s], HR(o));
  return a;
}
function J0(e, t, n, r) {
  ...
  let o = (i, a, s) => {
    ...
    i.children &&
      ...
      J0(i.children, t, c, u)),
      !(i.path == null && !i.index) &&
        t.push({ path: u, score: jR(u, i.index), routesMeta: c });
  };
  return (
    e.forEach((i, a) => {
      var s;
      if (i.path === "" || !((s = i.path) != null && s.includes("?"))) o(i, a);
      else for (let l of Z0(i.path)) o(i, a, l);
    }),
    t
  );
}
...
function jR(e, t) {
  ...
  return (
    ...
    n
      .filter((o) => !Yv(o))
      .reduce((o, i) => o + (IR.test(i) ? MR : i === "" ? $R : UR), r)
  );
}
function BR(e, t) {
...
function zR(e, t) {
  ...
  for (let a = 0; a < n.length; ++a) {
    ...
    i.push({
      ...
      pathnameBase: GR(Yn([o, c.pathnameBase])),
      route: f,
    }),
...
function KR(e, t) {
  ...
  return {
    pathname: n ? (n.startsWith("/") ? n : QR(n, t)) : t,
    search: XR(r),
    hash: YR(o),
  };
}
...
const tO = typeof Object.is == "function" ? Object.is : eO,
  { useState: nO, useEffect: rO, useLayoutEffect: oO, useDebugValue: iO } = Tt;
function aO(e, t, n) {
  const r = t(),
    [{ inst: o }, i] = nO({ inst: { value: r, getSnapshot: t } });
  return (
    oO(() => {
      (o.value = r), (o.getSnapshot = t), Vu(o) && i({ inst: o });
    }, [e, r, t]),
    rO(
      () => (
        Vu(o) && i({ inst: o }),
...
const lO =
  ...
  uO = !lO,
  cO = uO ? sO : aO;
"useSyncExternalStore" in Tt && ((e) => e.useSyncExternalStore)(Tt);
const r1 = L.createContext(null),
  o1 = L.createContext(null),
  zl = L.createContext(null),
  Vl = L.createContext(null),
  $o = L.createContext({ outlet: null, matches: [] }),
  i1 = L.createContext(null);
function fO(e, t) {
  let { relative: n } = t === void 0 ? {} : t;
  ya() || Ue(!1);
  let { basename: r, navigator: o } = L.useContext(zl),
    { hash: i, pathname: a, search: s } = a1(e, { relative: n }),
    l = a;
  return (
    r !== "/" && (l = a === "/" ? r : Yn([r, a])),
...
function wa() {
  return ya() || Ue(!1), L.useContext(Vl).location;
}
function dO() {
  ya() || Ue(!1);
  let { basename: e, navigator: t } = L.useContext(zl),
    { matches: n } = L.useContext($o),
    { pathname: r } = wa(),
    o = JSON.stringify(t1(n).map((s) => s.pathnameBase)),
    i = L.useRef(!1);
  return (
    L.useEffect(() => {
      i.current = !0;
    ...
    L.useCallback(
      function (s, l) {
        ...
        let u = n1(s, JSON.parse(o), r, l.relative === "path");
        e !== "/" &&
          (u.pathname = u.pathname === "/" ? e : Yn([e, u.pathname])),
...
function a1(e, t) {
  let { relative: n } = t === void 0 ? {} : t,
    { matches: r } = L.useContext($o),
    { pathname: o } = wa(),
    i = JSON.stringify(t1(r).map((a) => a.pathnameBase));
  return L.useMemo(() => n1(e, JSON.parse(i), o, n === "path"), [e, i, o, n]);
}
function s1(e, t) {
  ya() || Ue(!1);
  let { navigator: n } = L.useContext(zl),
    r = L.useContext(o1),
    { matches: o } = L.useContext($o),
    i = o[o.length - 1],
    a = i ? i.params : {};
  i && i.pathname;
  ...
  if (t) {
    var c;
    let y = typeof t == "string" ? $r(t) : t;
    s === "/" || ((c = y.pathname) != null && c.startsWith(s)) || Ue(!1),
      (u = y);
  } else u = l;
  let f = u.pathname || "/",
...
function vO(e) {
  ...
  return (
    ...
    L.createElement($o.Provider, { value: t }, r)
  );
}
function mO(e, t, n) {
  ...
  return r.reduceRight((i, a, s) => {
    let l = a.route.id ? (o == null ? void 0 : o[a.route.id]) : null,
      u = n ? a.route.errorElement || L.createElement(hO, null) : null,
...
function SO() {
  var e;
  let t = L.useContext(i1),
    n = gO(pl.UseRouteError),
    r = wO(pl.UseRouteError);
...
function _O(e) {
  ...
  ya() && Ue(!1);
  let s = t.replace(/^\/*/, "/"),
    l = L.useMemo(() => ({ basename: s, navigator: i, static: a }), [s, i, a]);
  ...
  let {
    ...
    v = L.useMemo(() => {
      ...
      return y == null
        ? null
        : { pathname: y, search: c, hash: f, state: d, key: p };
    }, [s, u, c, f, d, p]);
  return v == null
    ? null
    : L.createElement(
  ...
  return (
    L.Children.forEach(e, (r, o) => {
      ...
      if (r.type === L.Fragment) {
        n.push.apply(n, mf(r.props.children, t));
        return;
      }
      r.type !== vf && Ue(!1), !r.props.index || !r.props.children || Ue(!1);
      let i = [...t, o],
        a = {
      ...
      r.props.children && (a.children = mf(r.props.children, i)), n.push(a);
    }),
    n
  );
}
...
function RO(e, t) {
  return e.button === 0 && (!t || t === "_self") && !CO(e);
}
const OO = [
  "onClick",
  "relative",
...
function xO(e) {
  ...
  let i = o.current,
    [a, s] = L.useState({ action: i.action, location: i.location });
  return (
    L.useLayoutEffect(() => i.listen(s), [i]),
    L.createElement(_O, {
      basename: t,
      children: n,
      location: a.location,
...
const kO =
  ...
  l1 = L.forwardRef(function (t, n) {
    let {
      ...
      f = EO(t, OO),
      d = typeof u == "string" ? u : na(u),
      p = /^[a-z+]+:\/\//i.test(d) || d.startsWith("//"),
      v = d,
      y = !1;
    if (kO && p) {
      let g = new URL(window.location.href),
        S = d.startsWith("//") ? new URL(g.protocol + d) : new URL(d);
      S.origin === g.origin ? (v = S.pathname + S.search + S.hash) : (y = !0);
    }
    let _ = fO(v, { relative: o }),
      m = PO(v, {
        replace: a,
        state: s,
        target: l,
    ...
    return L.createElement(
      "a",
      gf({}, f, { href: p ? d : _, onClick: y || i ? r : h, ref: n, target: l })
    );
  });
var em;
(function (e) {
...
class IO extends Wl {
  ...
  map(t) {
    try {
      ...
      return Re(n) ? Lr(n) : Ro(n) ? n : Sa(n);
    } catch (n) {
      return Re(n) ? Lr(n.next(() => this.map(t))) : Hl(n);
    }
  }
}
class MO extends Wl {
  ...
  map(t) {
    return Lr(
      this.contents
        ...
        .catch((n) => {
          if (Re(n)) return n.then(() => this.map(t).contents);
          throw n;
        })
    );
  }
...
function Sa(e) {
  return Object.freeze(new IO(e));
}
function Hl(e) {
  return Object.freeze(new MO(e));
}
function Lr(e) {
  return Object.freeze(new u1(e));
}
function c1() {
  return Object.freeze(new u1(new Promise(() => {})));
}
function DO(e) {
  return e.every((t) => t.state === "hasValue")
    ? Sa(e.map((t) => t.contents))
    ...
    : Lr(Promise.all(e.map((t) => t.contents)));
}
function f1(e) {
  const n = (
      Array.isArray(e) ? e : Object.getOwnPropertyNames(e).map((o) => e[o])
    ).map((o) => (Ro(o) ? o : Re(o) ? Lr(o) : Sa(o))),
    r = DO(n);
...
var Ur = {
    loadableWithValue: Sa,
    loadableWithError: Hl,
    loadableWithPromise: Lr,
    loadableLoading: c1,
    loadableAll: f1,
    isLoadable: Ro,
    RecoilLoadable: $O,
  },
  UO = Ur.loadableWithValue,
  FO = Ur.loadableWithError,
  jO = Ur.loadableWithPromise,
  BO = Ur.loadableLoading,
  zO = Ur.loadableAll,
  VO = Ur.isLoadable,
  WO = Ur.RecoilLoadable,
  _a = Object.freeze({
    __proto__: null,
    loadableWithValue: UO,
    loadableWithError: FO,
...
function Kl(e) {
  var t;
  return (t = ql.get(e)) !== null && t !== void 0 ? t : !1;
}
Kl.setPass = (e) => {
  ql.set(e, !0);
};
...
var qO = HO,
  ...
  qu;
const KO =
    (Wu = V.createMutableSource) !== null && Wu !== void 0
      ? Wu
      : V.unstable_createMutableSource,
  d1 =
    (Hu = V.useMutableSource) !== null && Hu !== void 0
      ? Hu
      : V.unstable_useMutableSource,
  h1 =
    (qu = V.useSyncExternalStore) !== null && qu !== void 0
      ? qu
      : V.unstable_useSyncExternalStore;
function QO() {
  var e;
...
var ba = {
  createMutableSource: KO,
  useMutableSource: d1,
  useSyncExternalStore: h1,
  currentRendererSupportsUseSyncExternalStore: QO,
  reactMode: GO,
  isFastRefreshEnabled: XO,
};
const p1 = { RECOIL_DUPLICATE_ATOM_KEY_CHECKING_ENABLED: !0 };
function YO() {
  var e, t, n;
  if (
    typeof process > "u" ||
  ...
  p1.RECOIL_DUPLICATE_ATOM_KEY_CHECKING_ENABLED = r === "true";
}
YO();
var v1 = p1;
class Gd {
...
class g1 extends Gd {}
function JO(e) {
  return e instanceof m1 || e instanceof g1;
}
var Ql = {
    AbstractRecoilValue: Gd,
    RecoilState: m1,
    RecoilValueReadOnly: g1,
    isRecoilValue: JO,
  },
  ZO = Ql.AbstractRecoilValue,
  ex = Ql.RecoilState,
  tx = Ql.RecoilValueReadOnly,
  nx = Ql.isRecoilValue,
  Oo = Object.freeze({
    __proto__: null,
    AbstractRecoilValue: ZO,
    RecoilState: ex,
    RecoilValueReadOnly: tx,
    isRecoilValue: nx,
  });
function rx(e, t) {
  return (function* () {
...
function sx(e) {
  v1.RECOIL_DUPLICATE_ATOM_KEY_CHECKING_ENABLED && ax(e.key), Nr.set(e.key, e);
  const t =
    e.set == null
      ? new Oo.RecoilValueReadOnly(e.key)
      : new Oo.RecoilState(e.key);
  return Xd.set(e.key, t), t;
}
...
function cx(e) {
  var t;
  if (!ge("recoil_memory_managament_2020")) return;
  const n = Nr.get(e);
  if (
    n != null &&
    ...
    var r;
    Nr.delete(e), (r = S1(e)) === null || r === void 0 || r(), vl.delete(e);
  }
}
function fx(e, t) {
  ge("recoil_memory_managament_2020") &&
...
var ft = {
  ...
  getNode: lx,
  getNodeMaybe: ux,
  deleteNodeConfigIfPossible: cx,
  setConfigDeletionHandler: fx,
  getConfigDeletionHandler: S1,
  recoilValuesForKeys: ix,
  NodeMissingError: w1,
  DefaultValue: y1,
  DEFAULT_VALUE: ox,
};
...
var hx = { enqueueExecution: dx };
function px(e, t) {
  return (t = { exports: {} }), e(t, t.exports), t.exports;
}
var vx = px(function (e) {
  var t =
      typeof Symbol == "function" && typeof Symbol.iterator == "symbol"
        ? function (x) {
            return typeof x;
    ...
    c = (n.hash = function (x) {
      var E = typeof x > "u" ? "undefined" : t(x);
      if (E === "number") return x;
      E !== "string" && (x += "");
      for (var F = 0, H = 0, q = x.length; H < q; ++H) {
        var Q = x.charCodeAt(H);
        F = ((F << 5) - F + Q) | 0;
      }
      return F;
    }),
    ...
    y = function (E, F, H, q) {
      ...
      if (!E) {
        var ne = q.length;
        Q = new Array(ne);
        for (var ee = 0; ee < ne; ++ee) Q[ee] = q[ee];
      }
      return (Q[F] = H), Q;
    },
    _ = function (E, F, H) {
      var q = H.length - 1,
        ...
        ee = H;
      if (E) Q = ne = F;
      else for (ee = new Array(q); Q < F; ) ee[ne++] = H[Q++];
      for (++Q; Q <= q; ) ee[ne++] = H[Q++];
      return E && (ee.length = q), ee;
    },
    m = function (E, F, H, q) {
      var Q = q.length;
      if (E) {
        for (var ne = Q; ne >= F; ) q[ne--] = q[ne];
        return (q[F] = H), q;
      }
      for (var ee = 0, te = 0, ue = new Array(Q + 1); ee < F; )
        ue[te++] = q[ee++];
      for (ue[F] = H; ee < Q; ) ue[++te] = q[ee++];
      return ue;
    },
    h = 1,
    g = 2,
    ...
    T = { __hamt_isEmpty: !0 },
    N = function (E) {
      return E === T || (E && E.__hamt_isEmpty);
    },
    I = function (E, F, H, q) {
      return { type: h, edit: E, hash: F, key: H, value: q, _modify: O };
    },
    G = function (E, F, H) {
      return { type: g, edit: E, hash: F, children: H, _modify: A };
    },
    $ = function (E, F, H) {
      return { type: S, edit: E, mask: F, children: H, _modify: D };
    },
    X = function (E, F, H) {
      return { type: k, edit: E, size: F, children: H, _modify: z };
    },
    ce = function (E) {
      return E === T || E.type === h || E.type === g;
    },
    re = function (E, F, H, q, Q) {
      for (var ne = [], ee = q, te = 0, ue = 0; ee; ++ue)
        ee & 1 && (ne[ue] = Q[te++]), (ee >>>= 1);
      return (ne[F] = H), X(E, te + 1, ne);
    },
    w = function (E, F, H, q) {
      for (
        var Q = new Array(F - 1), ne = 0, ee = 0, te = 0, ue = q.length;
        te < ue;
        ++te
      )
        if (te !== H) {
          var Ee = q[te];
          Ee && !N(Ee) && ((Q[ne++] = Ee), (ee |= 1 << te));
        }
      return $(E, ee, Q);
    },
    P = function x(E, F, H, q, Q, ne) {
      if (H === Q) return G(E, H, [ne, q]);
      var ee = d(F, H),
        te = d(F, Q);
      return $(
        E,
        p(ee) | p(te),
        ee === te ? [x(E, F + r, H, q, Q, ne)] : ee < te ? [q, ne] : [ne, q]
      );
    },
    M = function (E, F, H, q, Q, ne, ee, te) {
      for (var ue = Q.length, Ee = 0; Ee < ue; ++Ee) {
        var ot = Q[Ee];
        if (H(ee, ot.key)) {
          var Fe = ot.value,
            bt = ne(Fe);
          return bt === Fe
            ...
            : bt === l
            ? (--te.value, _(E, Ee, Q))
            : y(E, Ee, I(F, q, ee, bt), Q);
        }
      }
      var Mt = ne();
      return Mt === l ? Q : (++te.value, y(E, ue, I(F, q, ee, Mt), Q));
    },
    C = function (E, F) {
      return E === F.edit;
    },
    O = function (E, F, H, q, Q, ne, ee) {
      if (F(ne, this.key)) {
        var te = q(this.value);
      ...
      return ue === l
        ? this
        : (++ee.value, P(E, H, this.hash, this, Q, I(E, Q, ne, ue)));
    },
    A = function (E, F, H, q, Q, ne, ee) {
      if (Q === this.hash) {
        var te = C(E, this),
          ue = M(te, E, F, this.hash, this.children, q, ne, ee);
        return ue === this.children
          ? this
          : ue.length > 1
          ? G(E, this.hash, ue)
          : ue[0];
      ...
      return Ee === l
        ? this
        : (++ee.value, P(E, H, this.hash, this, Q, I(E, Q, ne, Ee)));
    },
    D = function (E, F, H, q, Q, ne, ee) {
      var te = this.mask,
        ue = this.children,
        Ee = d(H, Q),
        ot = p(Ee),
        ...
        bt = te & ot,
        Mt = bt ? ue[Fe] : T,
        zr = Mt._modify(E, F, H + r, q, Q, ne, ee);
      if (Mt === zr) return this;
      var ka = C(E, this),
        zo = te,
        Vo = void 0;
      if (bt && N(zr)) {
        if (((zo &= ~ot), !zo)) return T;
        if (ue.length <= 2 && ce(ue[Fe ^ 1])) return ue[Fe ^ 1];
        Vo = _(ka, Fe, ue);
      } else if (!bt && !N(zr)) {
        if (ue.length >= a) return re(E, Ee, zr, te, ue);
        (zo |= ot), (Vo = m(ka, Fe, zr, ue));
      } else Vo = y(ka, Fe, zr, ue);
      return ka ? ((this.mask = zo), (this.children = Vo), this) : $(E, zo, Vo);
    },
    z = function (E, F, H, q, Q, ne, ee) {
      var te = this.size,
        ue = this.children,
        Ee = d(H, Q),
        ot = ue[Ee],
        Fe = (ot || T)._modify(E, F, H + r, q, Q, ne, ee);
      if (ot === Fe) return this;
      var bt = C(E, this),
        Mt = void 0;
      if (N(ot) && !N(Fe)) ++te, (Mt = y(bt, Ee, Fe, ue));
      else if (!N(ot) && N(Fe)) {
        if ((--te, te <= s)) return w(E, te, Ee, ue);
        Mt = y(bt, Ee, T, ue);
      } else Mt = y(bt, Ee, Fe, ue);
      return bt ? ((this.size = te), (this.children = Mt), this) : X(E, te, Mt);
    };
  T._modify = function (x, E, F, H, q, Q, ne) {
    var ee = H();
    return ee === l ? T : (++ne.value, I(x, q, Q, ee));
  };
  function b(x, E, F, H, q) {
    (this._editable = x),
      (this._edit = E),
      (this._config = F),
      (this._root = H),
  ...
  b.prototype.setTree = function (x, E) {
    return this._editable
      ? ((this._root = x), (this._size = E), this)
      : x === this._root
      ? this
      : new b(this._editable, this._edit, this._config, x, E);
  };
  var U = (n.tryGetHash = function (x, E, F, H) {
    for (var q = H._root, Q = 0, ne = H._config.keyEq; ; )
      switch (q.type) {
        case h:
          return ne(F, q.key) ? q.value : x;
        case g: {
          if (E === q.hash)
            for (var ee = q.children, te = 0, ue = ee.length; te < ue; ++te) {
              var Ee = ee[te];
              if (ne(F, Ee.key)) return Ee.value;
            }
          return x;
        }
        case S: {
          var ot = d(Q, E),
            Fe = p(ot);
          if (q.mask & Fe) {
            (q = q.children[v(q.mask, Fe)]), (Q += r);
            break;
          }
          return x;
        }
        case k: {
          if (((q = q.children[d(Q, E)]), q)) {
            Q += r;
            break;
          }
          return x;
  ...
  b.prototype.tryGetHash = function (x, E, F) {
    return U(x, E, F, this);
  };
  var B = (n.tryGet = function (x, E, F) {
    return U(x, F._config.hash(E), E, F);
  });
  b.prototype.tryGet = function (x, E) {
    return B(x, E, this);
  };
  var J = (n.getHash = function (x, E, F) {
    return U(void 0, x, E, F);
  });
  (b.prototype.getHash = function (x, E) {
    return J(x, E, this);
  }),
    (n.get = function (x, E) {
      return U(void 0, E._config.hash(x), x, E);
    }),
    (b.prototype.get = function (x, E) {
      return B(E, x, this);
    });
  var W = (n.has = function (x, E, F) {
    return U(l, x, E, F) !== l;
  });
  b.prototype.hasHash = function (x, E) {
    return W(x, E, this);
  };
  var Z = (n.has = function (x, E) {
    return W(E._config.hash(x), x, E);
  });
  b.prototype.has = function (x) {
    return Z(x, this);
  };
  var ae = function (E, F) {
    return E === F;
  ...
  (n.make = function (x) {
    return new b(
      0,
      0,
      { keyEq: (x && x.keyEq) || ae, hash: (x && x.hash) || c },
      T,
      0
    );
  }),
    (n.empty = n.make());
  var Y = (n.isEmpty = function (x) {
    return x && !!N(x._root);
  });
  b.prototype.isEmpty = function () {
    return Y(this);
  };
  var me = (n.modifyHash = function (x, E, F, H) {
    var q = { value: H._size },
      Q = H._root._modify(
        H._editable ? H._edit : NaN,
        H._config.keyEq,
        0,
        x,
        E,
    ...
    return H.setTree(Q, q.value);
  });
  b.prototype.modifyHash = function (x, E, F) {
    return me(F, x, E, this);
  };
  var ye = (n.modify = function (x, E, F) {
    return me(x, F._config.hash(E), E, F);
  });
  b.prototype.modify = function (x, E) {
    return ye(E, x, this);
  };
  var pe = (n.setHash = function (x, E, F, H) {
    return me(u(F), x, E, H);
  });
  b.prototype.setHash = function (x, E, F) {
    return pe(x, E, F, this);
  };
  var we = (n.set = function (x, E, F) {
    return pe(F._config.hash(x), x, E, F);
  });
  b.prototype.set = function (x, E) {
    return we(x, E, this);
  };
  var rt = u(l),
    lr = (n.removeHash = function (x, E, F) {
      return me(rt, x, E, F);
    });
  b.prototype.removeHash = b.prototype.deleteHash = function (x, E) {
    return lr(x, E, this);
  };
  var _t = (n.remove = function (x, E) {
    return lr(E._config.hash(x), x, E);
  });
  b.prototype.remove = b.prototype.delete = function (x) {
    return _t(x, this);
  };
  var dt = (n.beginMutation = function (x) {
    return new b(x._editable + 1, x._edit + 1, x._config, x._root, x._size);
  });
  b.prototype.beginMutation = function () {
    return dt(this);
  };
  var $h = (n.endMutation = function (x) {
    return (x._editable = x._editable && x._editable - 1), x;
  });
  b.prototype.endMutation = function () {
    return $h(this);
  };
  var TS = (n.mutate = function (x, E) {
    var F = dt(E);
    return x(F), $h(F);
  });
  b.prototype.mutate = function (x) {
    return TS(x, this);
  };
  var fu = function (E) {
      return E && Uh(E[0], E[1], E[2], E[3], E[4]);
    },
    Uh = function (E, F, H, q, Q) {
      for (; H < E; ) {
        var ne = F[H++];
        if (ne && !N(ne)) return Fh(ne, q, [E, F, H, q, Q]);
      }
      return fu(Q);
    },
    Fh = function (E, F, H) {
      switch (E.type) {
        case h:
          return { value: F(E), rest: H };
        case g:
        case k:
        case S:
          var q = E.children;
          return Uh(q.length, q, 0, F, H);
        default:
          return fu(H);
      }
    },
  ...
  (du.prototype.next = function () {
    if (!this.v) return LS;
    var x = this.v;
    return (this.v = fu(x.rest)), x;
  }),
    (du.prototype[Symbol.iterator] = function () {
      return this;
    });
  var hu = function (E, F) {
      return new du(Fh(E._root, F));
    },
    NS = function (E) {
      return [E.key, E.value];
    },
    AS = (n.entries = function (x) {
      return hu(x, NS);
    });
  ...
  var jh = (n.fold = function (x, E, F) {
    var H = F._root;
    if (H.type === h) return x(E, H.value, H.key);
    for (var q = [H.children], Q = void 0; (Q = q.pop()); )
      for (var ne = 0, ee = Q.length; ne < ee; ) {
        var te = Q[ne++];
        te &&
          te.type &&
          (te.type === h ? (E = x(E, te.value, te.key)) : q.push(te.children));
      }
    return E;
  });
  b.prototype.fold = function (x, E) {
    return jh(x, E, this);
  };
  var US = (n.forEach = function (x, E) {
    return jh(
      function (F, H, q) {
        return x(H, q, E);
      },
  ...
  b.prototype.forEach = function (x) {
    return US(x, this);
  };
  var FS = (n.count = function (x) {
    return x._size;
  });
  (b.prototype.count = function () {
    return FS(this);
  }),
    Object.defineProperty(b.prototype, "size", { get: b.prototype.count }),
...
class Yd {
  constructor(t) {
    if ((ie(this, "_hamt", vx.empty.beginMutation()), t instanceof Yd)) {
...
function Jd(e) {
  return ge("recoil_hamt_2020") ? new Yd(e) : new mx(e);
}
var gx = { persistentMap: Jd },
  yx = gx.persistentMap,
  wx = Object.freeze({ __proto__: null, persistentMap: yx });
function Sx(e, ...t) {
  const n = new Set();
  e: for (const r of e) {
...
function Ex(e) {
  return {
    nodeDeps: ml(e.nodeDeps, (t) => new Set(t)),
    nodeToNodeSubscriptions: ml(e.nodeToNodeSubscriptions, (t) => new Set(t)),
  };
}
function Ku(e, t, n, r) {
...
var Ea = { cloneGraph: Ex, graph: bx, saveDepsToStore: Cx };
let Rx = 0;
const Ox = () => Rx++;
let xx = 0;
const kx = () => xx++;
...
const Tx = () => Px++;
var Xl = {
  getNextTreeStateVersion: Ox,
  getNextStoreID: kx,
  getNextComponentID: Tx,
};
const { persistentMap: nm } = wx,
  { graph: Lx } = Ea,
  { getNextTreeStateVersion: _1 } = Xl;
function b1() {
  const e = _1();
  return {
    version: e,
...
function Nx() {
  ...
  return {
    ...
    graphsByVersion: new Map().set(e.version, Lx()),
    retention: {
...
var E1 = {
  makeEmptyTreeState: b1,
  makeEmptyStoreState: Nx,
  getNextTreeStateVersion: _1,
};
class C1 {}
function Ax() {
  return new C1();
}
var Yl = { RetentionZone: C1, retentionZone: Ax };
function Ix(e, t) {
  const n = new Set(e);
  return n.add(t), n;
}
...
var R1 = {
  setByAddingToSet: Ix,
  setByDeletingFromSet: Mx,
  mapBySettingInMap: Dx,
  mapByUpdatingInMap: $x,
  mapByDeletingFromMap: Ux,
  mapByDeletingMultipleFromMap: Fx,
};
function* jx(e, t) {
  let n = 0;
...
var O1 = Bx;
const { getNode: Ca, getNodeMaybe: zx, recoilValuesForKeys: rm } = ft,
  { RetentionZone: om } = Yl,
  { setByAddingToSet: Vx } = R1,
  Wx = Object.freeze(new Set());
...
function Kx(e, t, n) {
  eh(e, e.getState().currentTree, t, n);
}
function Qx(e, t) {
  var n;
  const r = e.getState();
...
function Gx(e, t, n) {
  return eh(e, t, n, "get"), Ca(n).get(e, t);
}
function x1(e, t, n) {
  return Ca(n).peek(e, t);
}
function Xx(e, t, n) {
  var r;
  const o = zx(t);
  return (
    o == null || (r = o.invalidate) === null || r === void 0 || r.call(o, e),
    {
      ...
      dirtyAtoms: Vx(e.dirtyAtoms, t),
    }
  );
}
function Yx(e, t, n, r) {
  const o = Ca(n);
  if (o.set == null) throw new Hx(`Attempt to set read-only RecoilValue: ${n}`);
  const i = o.set;
  return eh(e, t, n, "set"), i(e, t, r);
}
function Jx(e, t, n) {
  const r = e.getState(),
  ...
  return O1(
    { type: i },
    {
      ...
      subscribers: () => {
        var a, s;
        return {
          nodes: rm(Zd(k1(e, t, new Set([n])), (l) => l !== n)),
          components: Gl(
            (a =
...
function k1(e, t, n) {
  ...
  for (let s = o.pop(); s; s = o.pop()) {
    ...
    r.add(s);
    const l =
      (a = i.nodeToNodeSubscriptions.get(s)) !== null && a !== void 0 ? a : Wx;
...
var ir = {
  ...
  initializeNode: Kx,
  cleanUpNode: Qx,
  setUnvalidatedAtomValue_DEPRECATED: Xx,
  peekNodeInfo: Jx,
  getDownstreamNodes: k1,
};
let P1 = null;
function Zx(e) {
  P1 = e;
...
function ek() {
  var e;
  (e = P1) === null || e === void 0 || e();
}
var T1 = { setInvalidateMemoizedSnapshot: Zx, invalidateMemoizedSnapshot: ek };
const { getDownstreamNodes: tk, getNodeLoadable: L1, setNodeValue: nk } = ir,
  { getNextComponentID: rk } = Xl,
  { getNode: ok, getNodeMaybe: N1 } = ft,
  { DefaultValue: th } = ft,
  { reactMode: ik } = ba,
  {
    AbstractRecoilValue: ak,
    RecoilState: sk,
    RecoilValueReadOnly: lk,
    isRecoilValue: uk,
  } = Oo,
  { invalidateMemoizedSnapshot: ck } = T1;
function fk(e, { key: t }, n = e.getState().currentTree) {
  var r, o;
  const i = e.getState();
...
function dk(e, t) {
  ...
  return (
    t.forEach((r, o) => {
      r.state === "hasValue" && r.contents instanceof th
        ? n.delete(o)
        : n.set(o, r);
    }),
    n
...
function pk(e, t, n) {
  if (n.type === "set") {
    const { recoilValue: o, valueOrUpdater: i } = n,
      a = hk(e, t, o, i),
      s = nk(e, t, o.key, a);
    for (const [l, u] of s.entries()) yf(t, l, u);
    ...
    a == null || (r = a.invalidate) === null || r === void 0 || r.call(a, t),
      ...
      t.dirtyAtoms.add(o);
  } else Qd(`Unknown action ${n.type}`);
}
function yf(e, t, n) {
  n.state === "hasValue" && n.contents instanceof th
...
function A1(e, t) {
  e.replaceState((n) => {
    const r = I1(n);
    for (const o of t) pk(e, r, o);
    return M1(e, r), ck(), r;
  });
}
function Jl(e, t) {
  if (xi.length) {
    const n = xi[xi.length - 1];
    let r = n.get(e);
...
function mk(e, t, n) {
  if (n instanceof th) return D1(e, t, n);
...
var fn = {
  ...
  setRecoilValue: D1,
  setRecoilValueLoadable: mk,
  markRecoilValueModified: gk,
  setUnvalidatedRecoilValue: yk,
  subscribeToRecoilValue: wk,
  isRecoilValue: uk,
  applyAtomValueWrites: dk,
  batchStart: vk,
  writeLoadableToTreeState: yf,
  invalidateDownstreams: M1,
  copyTreeState: I1,
  refreshRecoilValue: Sk,
};
function _k(e, t, n) {
  const r = e.entries();
  let o = r.next();
...
var bk = _k;
const { cleanUpNode: Ek } = ir,
  { deleteNodeConfigIfPossible: Ck, getNode: $1 } = ft,
  { RetentionZone: U1 } = Yl,
  Rk = 12e4,
  F1 = new Set();
function j1(e, t) {
  ...
  const o = new Set();
  for (const a of t)
    if (a instanceof U1) for (const s of Pk(n, a)) o.add(s);
    else o.add(a);
  const i = Ok(e, o);
  for (const a of i) kk(e, r, a);
}
function Ok(e, t) {
  const n = e.getState(),
    r = n.currentTree,
  ...
  function s(l) {
    ...
    for (const v of c) {
      ...
      if (B1(v).some((_) => n.retention.referenceCounts.get(_))) {
        a.add(v);
        continue;
      }
      const y = o.nodeToNodeSubscriptions.get(v);
      if (y && bk(y, (_) => a.has(_))) {
        a.add(v);
        continue;
      }
    ...
    const d = new Set();
    for (const v of u)
      for (const y of (p = o.nodeDeps.get(v)) !== null && p !== void 0
        ? p
        : F1) {
        var p;
        i.has(y) || d.add(y);
...
function Lk(e, t, n) {
  ...
  i === 0 ? z1(e, t) : o.set(t, i);
}
function z1(e, t) {
  if (!ge("recoil_memory_managament_2020")) return;
  e.getState().retention.referenceCounts.delete(t), Tk(e, t);
}
function Nk(e) {
  if (!ge("recoil_memory_managament_2020")) return;
  const t = e.getState();
  j1(e, t.retention.retainablesToCheckForRelease),
...
var Fr = {
  SUSPENSE_TIMEOUT_MS: Rk,
  updateRetainCount: Lk,
  updateRetainCountToZero: z1,
  releaseScheduledRetainablesNow: Nk,
  retainedByOptionWithDefault: Ak,
};
const { unstable_batchedUpdates: Ik } = L0;
var Mk = { unstable_batchedUpdates: Ik };
const { unstable_batchedUpdates: Dk } = Mk;
var $k = { unstable_batchedUpdates: Dk };
const { batchStart: Uk } = fn,
  { unstable_batchedUpdates: Fk } = $k;
let nh = Fk;
const jk = (e) => {
    nh = e;
  },
...
var Zl = { getBatcher: Bk, setBatcher: jk, batchUpdates: zk };
function* Vk(e) {
  for (const t of e) for (const n of t) yield n;
}
var V1 = Vk;
const W1 = typeof Window > "u" || typeof window > "u",
  Wk = (e) => !W1 && (e === window || e instanceof Window),
  Hk = typeof navigator < "u" && navigator.product === "ReactNative";
var rh = { isSSR: W1, isReactNative: Hk, isWindow: Wk };
function qk(e, t) {
  let n;
  return (...o) => {
    n || (n = {});
...
var Gk = {
  memoizeWithArgsHash: qk,
  memoizeOneWithArgsHash: Kk,
  memoizeOneWithArgsHashAndInvalidation: Qk,
};
const { batchUpdates: wf } = Zl,
  { initializeNode: Xk, peekNodeInfo: Yk } = ir,
  { graph: Jk } = Ea,
  { getNextStoreID: Zk } = Xl,
  { DEFAULT_VALUE: eP, recoilValues: im, recoilValuesForKeys: am } = ft,
  {
    AbstractRecoilValue: tP,
    getRecoilValueAsLoadable: nP,
    setRecoilValue: sm,
    setUnvalidatedRecoilValue: rP,
  } = fn,
  { updateRetainCount: Cs } = Fr,
  { setInvalidateMemoizedSnapshot: oP } = T1,
  { getNextTreeStateVersion: iP, makeEmptyStoreState: aP } = E1,
  { isSSR: sP } = rh,
  { memoizeOneWithArgsHashAndInvalidation: lP } = Gk;
class eu {
  constructor(t, n) {
    ie(this, "_store", void 0),
      ...
      ie(
        this,
        "getLoadable",
        (r) => (this.checkRefCount_INTERNAL(), nP(this._store, r))
      ),
      ie(
        this,
        "getPromise",
      ...
      ie(this, "getNodes_UNSTABLE", (r) => {
        ...
        return (r == null ? void 0 : r.isInitialized) == null
          ...
          : r.isInitialized === !0
          ? am(V1([o, i]))
          : Zd(im.values(), ({ key: a }) => !o.has(a) && !i.has(a));
      }),
      ie(
        this,
        "getInfo_UNSTABLE",
        ({ key: r }) => (
          this.checkRefCount_INTERNAL(),
          Yk(this._store, this._store.getState().currentTree, r)
        )
      ),
      ie(this, "map", (r) => {
        this.checkRefCount_INTERNAL();
        const o = new Sf(this, wf);
        return r(o), o;
      }),
    ...
    for (const r of this._store.getState().knownAtoms)
      Xk(this._store, r, "get"), Cs(this._store, r, 1);
  ...
  autoRelease_INTERNAL() {
    sP || window.setTimeout(() => this._release(), 10);
  }
  _release() {
  ...
  checkRefCount_INTERNAL() {
    ge("recoil_memory_managament_2020") && this._refCount <= 0;
  }
  getStore_INTERNAL() {
...
function H1(e, t, n = !1) {
  ...
  return {
    ...
    nodeCleanupFunctions: new Map(
      Gl(r.nodeCleanupFunctions.entries(), ([i]) => [i, () => {}])
    ),
  };
}
function uP(e) {
      ...
      o =
        t === "latest"
          ? (n = r.nextTree) !== null && n !== void 0
            ...
            : r.currentTree
          : Oe(r.previousTree);
    return new eu(H1(e, o), e.storeID);
  },
  (e, t) => {
    var n, r;
    return (
...
oP(q1);
function cP(e, t = "latest") {
  const n = lm(e, t);
  return n.isRetained() ? n : (q1(), lm(e, t));
}
class Sf extends eu {
  constructor(t, n) {
    super(
      ...
      ie(this, "set", (r, o) => {
        ...
        this._batch(() => {
          Cs(i, r.key, 1), sm(this.getStore_INTERNAL(), r, o);
        });
      }),
      ie(this, "reset", (r) => {
        this.checkRefCount_INTERNAL();
        ...
        this._batch(() => {
          Cs(o, r.key, 1), sm(this.getStore_INTERNAL(), r, eP);
        });
      }),
      ie(this, "setUnvalidatedAtomValues_DEPRECATED", (r) => {
        ...
        const o = this.getStore_INTERNAL();
        wf(() => {
          for (const [i, a] of r.entries()) Cs(o, i, 1), rP(o, new tP(i), a);
        });
      }),
      (this._batch = n);
  }
...
var um = yP;
const { getNextTreeStateVersion: wP, makeEmptyStoreState: K1 } = E1,
  {
    cleanUpNode: SP,
    getDownstreamNodes: _P,
    initializeNode: bP,
    setNodeValue: EP,
    setUnvalidatedAtomValue_DEPRECATED: CP,
  } = ir,
  { graph: RP } = Ea,
  { cloneGraph: OP } = Ea,
  { getNextStoreID: Q1 } = Xl,
  { createMutableSource: Qu, reactMode: G1 } = ba,
  { applyAtomValueWrites: xP } = fn,
  { releaseScheduledRetainablesNow: X1 } = Fr,
  { freshSnapshot: kP } = nu,
  {
    useCallback: PP,
    useContext: Y1,
...
function cm(e) {
  ...
  if (t.nextTree === null) {
    ge("recoil_memory_managament_2020") &&
      ge("recoil_release_on_cascading_update_killswitch_2021") &&
      t.commitDepth > 0 &&
      X1(e);
    ...
    (t.nextTree = {
      ...
      t.graphsByVersion.set(r, OP(Oe(t.graphsByVersion.get(n))));
  }
}
const Z1 = V.createContext({ current: J1 }),
  ru = () => Y1(Z1),
  ew = V.createContext(null);
function AP() {
  return Y1(ew);
}
function oh(e, t, n) {
  const r = _P(e, n, n.dirtyAtoms);
  for (const o of r) {
...
function tw(e) {
  ...
  if (r.size) {
    ...
    (!G1().early || t.suspendedComponentResolvers.size > 0) &&
      (oh(e, t, n),
...
function IP(e) {
  ...
  try {
    ...
    (t.previousTree = t.currentTree),
      ...
      (t.previousTree = null),
      ge("recoil_memory_managament_2020") && n == null && X1(e);
  } finally {
    t.commitDepth--;
  }
}
function MP({ setNotifyBatcherOfChange: e }) {
  const t = ru(),
    [, n] = NP([]);
  return (
    e(() => n({})),
  ...
  return (
    t({
      set: (r, o) => {
        ...
        n.currentTree = {
          ...i,
          dirtyAtoms: mP(i.dirtyAtoms, s),
          atomValues: xP(i.atomValues, a),
          nonvalidatedAtoms: l,
        };
      },
      setUnvalidatedAtomValues: (r) => {
        r.forEach((o, i) => {
          n.currentTree = CP(n.currentTree, i, o);
        });
      },
    }),
    n
...
function UP({
  ...
  const i = (p) => {
      ...
      if (v == null) {
        ...
        return (
          Oe(y.get(v)).set(_, p),
          {
            release: () => {
              const m = y.get(v);
              m && (m.delete(_), m.size === 0 && y.delete(v));
            },
          }
        );
      }
    ...
    s = (p) => {
      ...
      for (const v of Object.keys(p))
        Oe(f.current.getState().nextTree).transactionMetadata[v] = p[v];
    },
    l = (p) => {
      cm(f.current);
      const v = Oe(o.current.nextTree);
      let y;
      try {
        (bf = !0), (y = p(v));
      } finally {
      ...
      y !== v &&
        ...
        G1().early && oh(f.current, o.current, y),
        Oe(u.current)());
    },
    u = LP(null),
    c = PP(
  ...
  n != null && (f.current = n),
    (o = um(() => (e != null ? DP(f.current, e) : t != null ? $P(t) : K1())));
  const d = TP(
    () => (Qu == null ? void 0 : Qu(o, () => o.current.currentTree.version)),
    [o]
  );
  return (
    _f(() => {
      const p = f.current;
      for (const v of new Set(p.getState().knownAtoms)) bP(p, v, "get");
      return () => {
        for (const v of p.getState().knownAtoms) SP(p, v);
      };
    }, [f]),
    V.createElement(
      Z1.Provider,
      ...
      V.createElement(
        ew.Provider,
        { value: d },
        V.createElement(MP, { setNotifyBatcherOfChange: c }),
        r
      )
    )
  );
...
function FP(e) {
  const { override: t, ...n } = e,
    r = ru();
  return t === !1 && r.current !== J1 ? e.children : V.createElement(UP, n);
}
function jP() {
  return ru().current.storeID;
}
var Rn = {
  RecoilRoot: FP,
  useStoreRef: ru,
  useRecoilMutableSource: AP,
  useRecoilStoreID: jP,
  notifyComponents_FOR_TESTING: oh,
  sendEndOfBatchNotifications_FOR_TESTING: tw,
};
function BP(e, t) {
  if (e === t) return !0;
...
var zP = BP;
const { useEffect: VP, useRef: WP } = V;
function HP(e) {
  const t = WP();
  return (
    VP(() => {
...
var nw = HP;
const { useStoreRef: qP } = Rn,
  { SUSPENSE_TIMEOUT_MS: KP } = Fr,
  { updateRetainCount: ri } = Fr,
  { RetentionZone: QP } = Yl,
  { useEffect: GP, useRef: XP } = V,
  { isSSR: dm } = rh;
function YP(e) {
  if (ge("recoil_memory_managament_2020")) return JP(e);
}
function JP(e) {
  const n = (Array.isArray(e) ? e : [e]).map((a) =>
      a instanceof QP ? a : a.key
    ),
    r = qP();
  GP(() => {
    if (!ge("recoil_memory_managament_2020")) return;
    const a = r.current;
    if (o.current && !dm) window.clearTimeout(o.current), (o.current = null);
...
var Ra = ZP;
const { batchUpdates: eT } = Zl,
  { DEFAULT_VALUE: rw } = ft,
  {
    currentRendererSupportsUseSyncExternalStore: tT,
    reactMode: Uo,
    useMutableSource: nT,
    useSyncExternalStore: rT,
  } = ba,
  { useRecoilMutableSource: oT, useStoreRef: dn } = Rn,
  {
    AbstractRecoilValue: Ef,
    getRecoilValueAsLoadable: Oa,
    setRecoilValue: gl,
    setUnvalidatedRecoilValue: iT,
    subscribeToRecoilValue: xo,
  } = fn,
  { useCallback: ct, useEffect: ko, useMemo: ow, useRef: ki, useState: ah } = V,
  { setByAddingToSet: aT } = R1;
function sh(e, t, n) {
...
function sT() {
  ...
  return (
    ko(() => {
      const l = t.current;
      Oi(r.current, o.current).forEach((u) => {
        if (i.current.has(u)) return;
        const c = xo(l, new Ef(u), (d) => s(d, u), e);
        i.current.set(u, c),
          l.getState().nextTree
        ...
        Oi(o.current, r.current).forEach((u) => {
          a(u);
        }),
        (o.current = r.current);
    }),
    ko(() => {
      const l = i.current;
      return (
        Oi(r.current, new Set(l.keys())).forEach((u) => {
          const c = xo(t.current, new Ef(u), (f) => s(f, u), e);
          l.set(u, c);
        }),
        () => l.forEach((u, c) => a(c))
      );
    ...
    ow(() => {
      ...
      function u(v) {
        return () => gl(t.current, v, rw);
      }
      function c(v) {
        var y;
        r.current.has(v.key) || (r.current = aT(r.current, v.key));
        const _ = t.current.getState();
        return Oa(
          t.current,
          v,
          Uo().early && (y = _.nextTree) !== null && y !== void 0
            ? y
            : _.currentTree
        );
      }
...
function uT(e) {
  const t = dn(),
      ...
      const l = t.current,
        ...
        c =
          Uo().early && (s = u.nextTree) !== null && s !== void 0
            ? s
            : u.currentTree;
      return { loadable: Oa(l, e, c), key: e.key };
    }, [t, e]),
    o = ct((s) => {
      let l;
      return () => {
    ...
    a = ct(
      (s) => {
        const l = t.current;
        return xo(l, e, s, n).release;
      },
      [t, e, n]
    );
  return rT(a, i, i).loadable;
}
function cT(e) {
  const t = dn(),
    n = ct(() => {
    ...
    i = ct(
      (u, c) => {
        ...
        return xo(
          ...
          e,
          () => {
            if (!ge("recoil_suppress_rerender_in_callback")) return c();
            const p = n();
            l.current.is(p) || c(), (l.current = p);
          },
          o
        ).release;
      },
    ...
    ko(() => {
      const s = t.current,
        ...
        u = xo(
          ...
          (f) => {
            var d;
            if (!ge("recoil_suppress_rerender_in_callback")) return n([]);
            const p = o();
            ((d = a.current) !== null && d !== void 0 && d.is(p)) || n(p),
              (a.current = p);
          },
          r
        );
...
function lh(e) {
  return (
    ge("recoil_memory_managament_2020") && ih(e),
    {
      TRANSITION_SUPPORT: Cf,
      SYNC_EXTERNAL_STORE: tT() ? uT : Cf,
      MUTABLE_SOURCE: cT,
      LEGACY: fT,
    }[Uo().mode](e)
  );
  ...
  return (t, n = {}) => {
    eT(() => {
      e.current.addTransactionMetadata(n),
        t.forEach((r, o) => iT(e.current, new Ef(o), r));
    });
  };
}
function aw(e) {
  return ge("recoil_memory_managament_2020") && ih(e), Cf(e);
}
function sw(e) {
  const t = dn(),
    n = aw(e);
...
var gT = {
  ...
  useRecoilState: hT,
  useRecoilStateLoadable: pT,
  useRecoilValue: iw,
  useRecoilValueLoadable: lh,
  useResetRecoilState: dT,
  useSetRecoilState: ou,
  useSetUnvalidatedAtomValues: vT,
  useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE: aw,
  useRecoilValue_TRANSITION_SUPPORT_UNSTABLE: sw,
  useRecoilState_TRANSITION_SUPPORT_UNSTABLE: mT,
};
function yT(e, t) {
  const n = new Map();
...
var ET = bT;
const { batchUpdates: CT } = Zl,
  { DEFAULT_VALUE: RT, getNode: lw, nodes: OT } = ft,
  { useStoreRef: uh } = Rn,
  { AbstractRecoilValue: xT, setRecoilValueLoadable: kT } = fn,
  { SUSPENSE_TIMEOUT_MS: PT } = Fr,
  { cloneSnapshot: yl } = nu,
  { useCallback: iu, useEffect: uw, useRef: hm, useState: TT } = V,
  { isSSR: pm } = rh;
function au(e) {
  const t = uh();
  uw(() => t.current.subscribeToTransactions(e).release, [e, t]);
}
function vm(e) {
  const t = e.atomValues.toMap(),
    n = ml(
      wT(t, (r, o) => {
        const a = lw(o).persistence_UNSTABLE;
        return a != null && a.type !== "none" && r.state === "hasValue";
      }),
      (r) => r.contents
    );
  return ET(e.nonvalidatedAtoms.toMap(), n);
}
function LT(e) {
  au(
    iu(
      (t) => {
        ...
        const o = vm(r),
          ...
          s = _T(r.dirtyAtoms, (l) => o.has(l) || i.has(l));
        e({
          atomValues: o,
      ...
      for (const c of u) {
        ...
        ((s = o.atomValues.get(c)) === null || s === void 0
          ...
          ((l = i.atomValues.get(c)) === null || l === void 0
            ? void 0
            : l.contents) &&
          lw(c).shouldRestoreFromSnapshots &&
          a.add(c);
      }
    a.forEach((u) => {
      kT(e, new xT(u), i.atomValues.has(u) ? Oe(i.atomValues.get(u)) : RT);
    }),
...
function IT() {
  const e = uh();
  return iu((t) => cw(e.current, t), [e]);
}
var fw = {
  useRecoilSnapshot: AT,
  gotoSnapshot: cw,
  useGotoRecoilSnapshot: IT,
  useRecoilTransactionObserver: NT,
  useTransactionObservation_DEPRECATED: LT,
  useTransactionSubscription_DEPRECATED: au,
};
const { peekNodeInfo: MT } = ir,
  { useStoreRef: DT } = Rn;
function $T() {
  const e = DT();
  return ({ key: t }) => MT(e.current, e.current.getState().currentTree, t);
}
var UT = $T;
const { reactMode: FT } = ba,
  { RecoilRoot: jT, useStoreRef: BT } = Rn,
  { useMemo: zT } = V;
function VT() {
  FT().mode === "MUTABLE_SOURCE" &&
    console.warn(
  ...
  return zT(() => {
    function t({ children: n }) {
      return V.createElement(jT, { store_INTERNAL: e }, n);
    }
    return t;
  }, [e]);
}
var WT = VT;
const { loadableWithValue: HT } = _a,
  { initializeNode: qT } = ir,
  { DEFAULT_VALUE: KT, getNode: QT } = ft,
  {
    copyTreeState: GT,
    getRecoilValueAsLoadable: XT,
    invalidateDownstreams: YT,
    writeLoadableToTreeState: JT,
  } = fn;
function mm(e) {
  return QT(e.key).nodeType === "atom";
}
class ZT {
  constructor(t, n) {
    ie(this, "_store", void 0),
      ...
      ie(this, "get", (r) => {
        ...
        const o = XT(this._store, r, this._treeState);
      ...
      ie(this, "set", (r, o) => {
        ...
        } else qT(this._store, r.key, "set"), this._changes.set(r.key, o);
      }),
      ie(this, "reset", (r) => {
        this.set(r, KT);
      }),
  ...
  newTreeState_INTERNAL() {
    ...
    const t = GT(this._treeState);
    for (const [n, r] of this._changes) JT(t, n, HT(r));
    return YT(this._store, t), t;
  }
}
function eL(e) {
  return (t) => {
...
var tL = { atomicUpdater: eL },
  nL = tL.atomicUpdater,
  dw = Object.freeze({ __proto__: null, atomicUpdater: nL });
function rL(e, t) {
  if (!e) throw new Error(t);
}
var oL = rL,
  fi = oL;
const { atomicUpdater: iL } = dw,
  { batchUpdates: aL } = Zl,
  { DEFAULT_VALUE: sL } = ft,
  { useStoreRef: lL } = Rn,
  { refreshRecoilValue: uL, setRecoilValue: gm } = fn,
  { cloneSnapshot: cL } = nu,
  { gotoSnapshot: fL } = fw,
  { useCallback: dL } = V;
class hw {}
      ...
      const l = O1(
          {
            ...
            reset: (c) => gm(e, c, sL),
            refresh: (c) => uL(e, c),
            gotoSnapshot: (c) => fL(e, c),
            transact_UNSTABLE: (c) => iL(e)(c),
          },
          {
            snapshot: () => {
              const c = cL(e);
...
function pL(e, t) {
  const n = lL();
  return dL((...r) => pw(n.current, e, r), t != null ? [...t, n] : void 0);
}
var vw = { recoilCallback: pw, useRecoilCallback: pL };
const { useStoreRef: vL } = Rn,
  { refreshRecoilValue: mL } = fn,
  { useCallback: gL } = V;
function yL(e) {
  const t = vL();
  return gL(() => {
...
var OL = { WrappedValue: RL },
  xL = OL.WrappedValue,
  mw = Object.freeze({ __proto__: null, WrappedValue: xL });
const { isFastRefreshEnabled: kL } = ba;
...
class PL {
  ...
  set(t, n, r) {
    ...
    try {
      ...
      if (i instanceof ym) this.clear(), o();
      else throw i;
    }
  }
  delete(t) {
  ...
  invalidCacheError() {
    ...
    throw (Qd(t + (this._name != null ? ` - ${this._name}` : "")), new ym());
  }
}
var TL = { TreeCache: PL },
  LL = TL.TreeCache,
  gw = Object.freeze({ __proto__: null, TreeCache: LL });
class NL {
  constructor(t) {
    var n;
...
var AL = { LRUCache: NL },
  IL = AL.LRUCache,
  yw = Object.freeze({ __proto__: null, LRUCache: IL });
const { LRUCache: ML } = yw,
  { TreeCache: DL } = gw;
function $L({ name: e, maxSize: t, mapNodeValue: n = (r) => r }) {
  const r = new ML({ maxSize: t }),
    o = new DL({
      name: e,
      mapNodeValue: n,
      onHit: (i) => {
...
function Ut(e, t, n) {
  ...
  if (Re(e)) return "__PROMISE__";
  if (Array.isArray(e)) return `[${e.map((o, i) => Ut(o, t, i.toString()))}]`;
  if (typeof e.toJSON == "function") return Ut(e.toJSON(n), t, n);
  if (e instanceof Map) {
    const o = {};
    for (const [i, a] of e) o[typeof i == "string" ? i : Ut(i, t)] = a;
    return Ut(o, t, n);
  }
  return e instanceof Set
    ? Ut(
        Array.from(e).sort((o, i) => Ut(o, t).localeCompare(Ut(i, t))),
        t,
        n
      )
    : Symbol !== void 0 &&
    ...
    : `{${Object.keys(e)
        .filter((o) => e[o] !== void 0)
        .sort()
        .map((o) => `${Ut(o, t)}:${Ut(e[o], t, o)}`)
        .join(",")}}`;
}
function UL(e, t = { allowFunctions: !1 }) {
  return Ut(e, t);
}
var su = UL;
const { TreeCache: FL } = gw,
...
function zL(e, t, n, r) {
  switch (e) {
    case "keep-all":
      return new FL({ name: r, mapNodeValue: n });
    case "lru":
      return wm({ name: r, maxSize: Oe(t), mapNodeValue: n });
    case "most-recent":
      return wm({ name: r, maxSize: 1, mapNodeValue: n });
  }
...
var HL = { startPerfBlock: WL };
const {
    isLoadable: qL,
    loadableWithError: Xa,
    loadableWithPromise: KL,
    loadableWithValue: Gu,
  } = _a,
  { WrappedValue: ww } = mw,
  { getNodeLoadable: Ya, peekNodeLoadable: QL, setNodeValue: GL } = ir,
  { saveDepsToStore: XL } = Ea,
  {
    DEFAULT_VALUE: YL,
    getConfigDeletionHandler: JL,
    getNode: ZL,
    registerNode: Sm,
  } = ft,
  { isRecoilValue: eN } = Oo,
  { markRecoilValueModified: _m } = fn,
  { retainedByOptionWithDefault: tN } = Fr,
  { recoilCallback: nN } = vw,
  { startPerfBlock: rN } = HL;
class Sw {}
const oi = new Sw(),
  ii = [],
  Ja = new Map(),
...
function _w(e) {
  ...
  const { key: n, get: r, cachePolicy_UNSTABLE: o } = e,
    ...
    a = new Set(),
    s = VL(o ?? { equality: "reference", eviction: "keep-all" }, n),
    l = tN(e.retainedBy_UNSTABLE),
    u = new Map();
  let c = 0;
  function f() {
    return !ge("recoil_memory_managament_2020") || c > 0;
  }
  function d(b) {
    return (
      b.getState().knownSelectors.add(n),
      c++,
      () => {
        c--;
      }
  ...
  function p() {
    return JL(n) !== void 0 && !f();
  }
  function v(b, U, B, J, W) {
    M(U, J, W), y(b, B);
  }
  function y(b, U) {
    w(b, U) && re(b), m(U, !0);
  ...
  function _(b, U) {
    w(b, U) && (Oe($(b)).stateVersions.clear(), m(U, !1));
  }
  function m(b, U) {
    const B = Ja.get(b);
    if (B != null) {
      for (const J of B) _m(J, Oe(t));
      U && Ja.delete(b);
    }
  }
  function h(b, U) {
    let B = Ja.get(U);
    B == null && Ja.set(U, (B = new Set())), B.add(b);
  }
  function g(b, U, B, J, W, Z) {
    return U.then((ae) => {
      if (!f()) throw (re(b), oi);
      const Y = Gu(ae);
      return v(b, B, W, Y, J), ae;
    }).catch((ae) => {
      if (!f()) throw (re(b), oi);
      if (Re(ae)) return S(b, ae, B, J, W, Z);
      const Y = Xa(ae);
      throw (v(b, B, W, Y, J), ae);
    });
  }
  function S(b, U, B, J, W, Z) {
    return U.then((ae) => {
      if (!f()) throw (re(b), oi);
      Z.loadingDepKey != null && Z.loadingDepPromise === U
        ? B.atomValues.set(Z.loadingDepKey, Gu(ae))
        : b.getState().knownSelectors.forEach((pe) => {
            B.atomValues.delete(pe);
          });
      const Y = N(b, B);
      if (Y && Y.state !== "loading") {
        if (((w(b, W) || $(b) == null) && y(b, W), Y.state === "hasValue"))
          return Y.contents;
        throw Y.contents;
      }
      if (!w(b, W)) {
        const pe = G(b, B);
        if (pe != null) return pe.loadingLoadable.contents;
      }
      const [me, ye] = T(b, B, W);
      if (
        (me.state !== "loading" && v(b, B, W, me, ye), me.state === "hasError")
      )
        throw me.contents;
      return me.contents;
    }).catch((ae) => {
      if (ae instanceof Sw) throw oi;
      if (!f()) throw (re(b), oi);
      const Y = Xa(ae);
      throw (v(b, B, W, Y, J), ae);
    });
    ...
    if (
      ...
      XL(
        ...
        (me =
          ...
          pe === void 0
            ? void 0
            : pe.version) !== null && me !== void 0
          ? me
          : b.getState().currentTree.version
      );
    }
    for (const we of B) a.add(we);
  }
  function T(b, U, B) {
    const J = rN(n);
    let W = !0,
    ...
    let Y,
      me = !1,
      ye;
    const pe = { loadingDepKey: null, loadingDepPromise: null },
      we = new Map();
    function rt({ key: _t }) {
      const dt = Ya(b, U, _t);
      switch (
        (we.set(_t, dt),
        W || (k(b, U, new Set(we.keys()), B), _(b, B)),
        dt.state)
      ) {
        case "hasValue":
          return dt.contents;
        ...
        case "loading":
          throw (
            ((pe.loadingDepKey = _t),
            (pe.loadingDepPromise = dt.contents),
            dt.contents)
          );
      }
    ...
    const lr =
      ...
      (...dt) => {
        ...
        return t == null && fi(!1), nN(b, _t, dt, { node: t });
      };
    try {
      (Y = r({ get: rt, getCallback: lr })),
        (Y = eN(Y) ? rt(Y) : Y),
        qL(Y) && (Y.state === "hasError" && (me = !0), (Y = Y.contents)),
        Re(Y) ? (Y = g(b, Y, U, we, B, pe).finally(ae)) : ae(),
        (Y = Y instanceof ww ? Y.value : Y);
    } catch (_t) {
      (Y = _t),
        Re(Y) ? (Y = S(b, Y, U, we, B, pe).finally(ae)) : ((me = !0), ae());
    }
    return (
      me ? (ye = Xa(Y)) : Re(Y) ? (ye = KL(Y)) : (ye = Gu(Y)),
      (W = !1),
      ce(b, B, we),
      k(b, U, new Set(we.keys()), B),
      [ye, we]
    );
  }
  function N(b, U) {
    let B = U.atomValues.get(n);
    if (B != null) return B;
    const J = new Set();
    try {
      B = s.get((Z) => (typeof Z != "string" && fi(!1), Ya(b, U, Z).contents), {
        onNodeVisit: (Z) => {
          Z.type === "branch" && Z.nodeKey !== n && J.add(Z.nodeKey);
        },
      });
    } catch (Z) {
      throw se(`Problem with cache lookup for selector "${n}": ${Z.message}`);
    }
    if (B) {
      var W;
      U.atomValues.set(n, B),
        k(
          b,
          U,
          J,
          (W = $(b)) === null || W === void 0 ? void 0 : W.executionID
        );
    }
    return B;
  }
  function I(b, U) {
    const B = N(b, U);
    if (B != null) return re(b), B;
    const J = G(b, U);
    if (J != null) {
      var W;
      return (
        ((W = J.loadingLoadable) === null || W === void 0
          ? void 0
          : W.state) === "loading" && h(b, J.executionID),
        J.loadingLoadable
      );
    }
    const Z = oN(),
  ...
  function G(b, U) {
    ...
    function J(W) {
      for (const [Z, ae] of W) if (!Ya(b, U, Z).is(ae)) return !0;
      return !1;
    }
    for (const W of B) {
      if (
        W.stateVersions.get(U.version) ||
        !J(W.depValuesDiscoveredSoFarDuringAsyncWork)
      )
        return W.stateVersions.set(U.version, !0), W;
      W.stateVersions.set(U.version, !1);
    }
  }
  function $(b) {
    return u.get(b);
  }
  function X(b, U, B, J, W) {
    u.set(b, {
  ...
  function ce(b, U, B) {
    if (w(b, U)) {
      const J = $(b);
      J != null && (J.depValuesDiscoveredSoFarDuringAsyncWork = B);
    }
  }
  function re(b) {
    u.delete(b);
  ...
  function w(b, U) {
    var B;
    return U === ((B = $(b)) === null || B === void 0 ? void 0 : B.executionID);
  }
  function P(b) {
    return Array.from(b.entries()).map(([U, B]) => [U, B.contents]);
  }
  function M(b, U, B) {
    b.atomValues.set(n, U);
    try {
      s.set(P(B), U);
    } catch (J) {
  ...
  function C(b) {
    if (ii.includes(n)) {
      const U = `Recoil selector has circular dependencies: ${ii
        .slice(ii.indexOf(n))
        .join(" → ")}`;
      return Xa(se(U));
    }
    ...
    return (
      ...
      s.get((J) => {
        ...
        return (
          ...
          (W = QL(b, U, J)) === null || W === void 0 ? void 0 : W.contents
        );
      })
    );
  }
  ...
  function z(b, U) {
    ...
    for (const J of a) {
      var B;
      const W = ZL(J);
      (B = W.clearCache) === null || B === void 0 || B.call(W, b, U);
    }
    a.clear(), D(U), s.clear(), _m(b, t);
  }
  return i != null
    ? (t = Sm({
        key: n,
        ...
        set: (U, B, J) => {
          ...
          function ae({ key: pe }) {
            ...
            if (we.state === "loading") {
              const rt = `Getting value of asynchronous atom or selector "${pe}" in a pending state while setting selector "${n}" is not yet supported.`;
              throw se(rt);
          ...
          function Y(pe, we) {
            ...
            const rt = typeof we == "function" ? we(ae(pe)) : we;
            GL(U, B, pe.key, rt).forEach((_t, dt) => Z.set(dt, _t));
          }
          function me(pe) {
            Y(pe, YL);
          }
          const ye = i({ set: Y, get: ae, reset: me }, J);
          if (ye !== void 0)
            throw Re(ye)
...
const {
    isLoadable: iN,
    loadableWithError: Xu,
    loadableWithPromise: Yu,
    loadableWithValue: qr,
  } = _a,
  { WrappedValue: bw } = mw,
  { peekNodeInfo: aN } = ir,
  {
    DEFAULT_VALUE: vr,
    DefaultValue: An,
    getConfigDeletionHandler: Ew,
    registerNode: sN,
    setConfigDeletionHandler: lN,
  } = ft,
  { isRecoilValue: uN } = Oo,
  {
    getRecoilValueAsLoadable: cN,
    markRecoilValueModified: fN,
    setRecoilValue: bm,
    setRecoilValueLoadable: dN,
  } = fn,
  { retainedByOptionWithDefault: hN } = Fr,
  ai = (e) => (e instanceof bw ? e.value : e);
function pN(e) {
  const { key: t, persistence_UNSTABLE: n } = e,
    r = hN(e.retainedBy_UNSTABLE);
  let o = 0;
  function i(h) {
    return Yu(
      h
  ...
  function c(h, g) {
    const S = g
      .then((k) => {
        ...
        return (
          ((N = (
            (T = h.getState().nextTree) !== null && T !== void 0
              ? T
              : h.getState().currentTree
          ).atomValues.get(t)) === null || N === void 0
            ? void 0
            : N.contents) === S && bm(h, m, k),
          k
        );
      })
      .catch((k) => {
  ...
  function f(h, g, S) {
    ...
    const T = () => {
      var $;
      o--,
        ($ = l.get(h)) === null || $ === void 0 || $.forEach((X) => X()),
        l.delete(h);
    };
    if ((h.getState().knownAtoms.add(t), a.state === "loading")) {
      const $ = () => {
        var X;
        ((X = h.getState().nextTree) !== null && X !== void 0
          ? X
          : h.getState().currentTree
        ).atomValues.has(t) || fN(h, m);
      };
      a.contents.finally($);
    }
    ...
    if (N != null) {
      let w = function (D) {
          if (X && D.key === t) {
            const z = $;
            return z instanceof An
              ? d(h, g)
              : Re(z)
              ? Yu(z.then((b) => (b instanceof An ? a.toPromise() : b)))
              : qr(z);
          }
          return cN(h, D);
        },
        P = function (D) {
          return w(D).toPromise();
        },
        M = function (D) {
          var z;
          const b = aN(
            h,
            (z = h.getState().nextTree) !== null && z !== void 0
              ? z
              : h.getState().currentTree,
            D.key
          );
          return X && D.key === t && !($ instanceof An)
            ? { ...b, isSet: !0, loadable: w(D) }
            : b;
        },
        $ = vr,
        X = !0,
      ...
      const C = (D) => (z) => {
          if (X) {
            const b = w(m),
              U = b.state === "hasValue" ? b.contents : vr;
            ($ = typeof z == "function" ? z(U) : z),
              Re($) && ($ = $.then((B) => ((re = { effect: D, value: B }), B)));
          } else {
            if (Re(z))
              throw se("Setting atoms to async values is not implemented.");
            typeof z != "function" && (re = { effect: D, value: ai(z) }),
              bm(
                h,
                m,
                typeof z == "function"
        ...
        A = (D) => (z) => {
          var b;
          const { release: U } = h.subscribeToTransactions((B) => {
            var J;
            let { currentTree: W, previousTree: Z } = B.getState();
            Z || (Z = W);
            const ae =
              (J = W.atomValues.get(t)) !== null && J !== void 0 ? J : a;
            if (ae.state === "hasValue") {
              var Y, me, ye, pe;
              const we = ae.contents,
                rt = (Y = Z.atomValues.get(t)) !== null && Y !== void 0 ? Y : a,
                lr = rt.state === "hasValue" ? rt.contents : vr;
              ((me = re) === null || me === void 0 ? void 0 : me.effect) !==
                D ||
              ((ye = re) === null || ye === void 0 ? void 0 : ye.value) !== we
                ? z(we, lr, !W.atomValues.has(t))
                : ((pe = re) === null || pe === void 0 ? void 0 : pe.effect) ===
                    D && (re = null);
            }
          }, t);
          l.set(h, [...((b = l.get(h)) !== null && b !== void 0 ? b : []), U]);
        };
      for (const D of N)
        try {
          const z = D({
      ...
      if (((X = !1), !($ instanceof An))) {
        var G;
        const D = ce ? Xu($) : Re($) ? Yu(c(h, $)) : qr(ai($));
        D.contents,
          g.atomValues.set(t, D),
          (G = h.getState().nextTree) === null ||
            G === void 0 ||
            G.atomValues.set(t, D);
      }
    }
  ...
  function d(h, g) {
    var S, k;
    return (S = (k = g.atomValues.get(t)) !== null && k !== void 0 ? k : s) !==
      null && S !== void 0
      ? S
      : a;
  }
  function p(h, g) {
    if (g.atomValues.has(t)) return Oe(g.atomValues.get(t));
    if (g.nonvalidatedAtoms.has(t)) {
      if (s != null) return s;
      if (n == null) return a;
      const S = g.nonvalidatedAtoms.get(t),
        k = n.validator(S, vr);
      return (s = k instanceof An ? a : qr(k)), s;
    } else return a;
  }
  function v() {
    s = void 0;
  ...
  function y(h, g, S) {
    if (g.atomValues.has(t)) {
      const k = Oe(g.atomValues.get(t));
      if (k.state === "hasValue" && S === k.contents) return new Map();
    } else if (!g.nonvalidatedAtoms.has(t) && S instanceof An) return new Map();
    return (s = void 0), new Map().set(t, qr(S));
  }
  function _() {
    return Ew(t) !== void 0 && o <= 0;
  }
  const m = sN({
    key: t,
    nodeType: "atom",
...
function ch(e) {
  ...
  return uN(n) ? vN({ ...t, default: n }) : pN({ ...t, default: n });
}
function vN(e) {
  const t = ch({
      ...e,
        ...
        e.persistence_UNSTABLE === void 0
          ...
          : {
              ...
              validator: (r) =>
                r instanceof An
                  ? r
                  : Oe(e.persistence_UNSTABLE).validator(r, vr),
            },
      effects: e.effects,
...
var gN = { MapCache: mN },
  yN = gN.MapCache,
  wN = Object.freeze({ __proto__: null, MapCache: yN });
const { LRUCache: Em } = yw,
  { MapCache: SN } = wN,
...
function EN(e, t, n) {
  switch (e) {
    case "keep-all":
      return new SN({ mapKey: n });
    case "lru":
      return new Em({ mapKey: n, maxSize: Oe(t) });
    case "most-recent":
      return new Em({ mapKey: n, maxSize: 1 });
  }
  throw se(`Unrecognized eviction policy ${e}`);
}
var Rw = _N;
const { setConfigDeletionHandler: CN } = ft;
function RN(e) {
  var t, n;
  const r = Rw({
    equality:
  ...
  return (o) => {
    ...
    const { cachePolicyForParams_UNSTABLE: l, ...u } = e,
      ...
      f = Cw({
        ...u,
        key: `${e.key}__${(i = su(o)) !== null && i !== void 0 ? i : "void"}`,
...
var ON = RN;
const { setConfigDeletionHandler: xN } = ft;
let kN = 0;
function PN(e) {
  var t, n;
  const r = Rw({
  ...
  return (o) => {
    ...
    const s = `${e.key}__selectorFamily/${
        (i = su(o, { allowFunctions: !0 })) !== null && i !== void 0
          ? i
          : "void"
      }/${kN++}`,
      l = (d) => e.get(o)(d),
...
var $N = DN;
const {
  loadableWithError: Ow,
  loadableWithPromise: xw,
  loadableWithValue: kw,
} = _a;
function lu(e, t) {
...
function vo(e, t, n) {
  const r = n.map((o, i) => (o == null ? kw(t[i]) : Re(o) ? xw(o) : Ow(o)));
  return Rf(e, r);
}
function FN(e, t) {
...
const jN = ar({
  ...
  zN = ar({
    ...
    get:
      ...
      ({ get: t }) => {
        const n = uu(e),
          [r, o] = lu(t, n);
        if (o.every((a) => a == null)) return Rf(e, r);
        const i = o.find(UN);
        if (i != null) throw i;
        return Promise.all(o).then((a) => Rf(e, FN(r, a)));
      },
    dangerouslyAllowMutability: !0,
  }),
  VN = ar({
  ...
  WN = ar({
    ...
    get:
      ...
      ({ get: t }) => {
        try {
          return Po.value(kw(t(e)));
        } catch (n) {
          return Po.value(Re(n) ? xw(n) : Ow(n));
        }
      },
    dangerouslyAllowMutability: !0,
  });
...
const { RecoilLoadable: qN } = _a,
  { DefaultValue: KN } = ft,
  { RecoilRoot: QN, useRecoilStoreID: GN } = Rn,
  { isRecoilValue: XN } = Oo,
  { retentionZone: YN } = Yl,
  { freshSnapshot: JN } = nu,
  {
    useRecoilState: ZN,
    useRecoilState_TRANSITION_SUPPORT_UNSTABLE: eA,
    useRecoilStateLoadable: tA,
    useRecoilValue: nA,
    useRecoilValue_TRANSITION_SUPPORT_UNSTABLE: rA,
    useRecoilValueLoadable: oA,
    useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE: iA,
    useResetRecoilState: aA,
    useSetRecoilState: sA,
  } = gT,
  {
    useGotoRecoilSnapshot: lA,
    useRecoilSnapshot: uA,
    useRecoilTransactionObserver: cA,
  } = fw,
  { useRecoilCallback: fA } = vw,
  {
    noWait: dA,
    waitForAll: hA,
...
var fh = {
    ...
    RecoilRoot: QN,
    useRecoilStoreID: GN,
    useRecoilBridgeAcrossReactRoots_UNSTABLE: WT,
    atom: Cw,
    selector: Po,
    atomFamily: ON,
    selectorFamily: ar,
    ...
    useSetRecoilState: sA,
    useResetRecoilState: aA,
    useGetRecoilValueInfo_UNSTABLE: UT,
    useRecoilRefresher_UNSTABLE: wL,
    useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE: iA,
    useRecoilValue_TRANSITION_SUPPORT_UNSTABLE: rA,
    useRecoilState_TRANSITION_SUPPORT_UNSTABLE: eA,
    useRecoilCallback: fA,
    useRecoilTransaction_UNSTABLE: CL,
    useGotoRecoilSnapshot: lA,
    useRecoilSnapshot: uA,
    useRecoilTransactionObserver_UNSTABLE: cA,
    snapshot_UNSTABLE: JN,
    useRetain: ih,
    retentionZone: YN,
  },
  gA = fh.RecoilRoot,
...
const SA = { "Content-Type": "application/json" };
function _A({ secret: e }) {
  const t = { ...SA };
...
function Me({ baseURL: e, secret: t }) {
  const n = _A({ secret: t });
...
const hh = "/configs",
  bA = "/configs/geo",
  EA = "/cache/fakeip/flush",
  CA = "/restart",
  RA = "/upgrade";
async function Lw(e) {
  const { url: t, init: n } = Me(e);
  return await fetch(t + hh, n);
}
function OA(e) {
  return "socks-port" in e && (e["socket-port"] = e["socks-port"]), e;
}
async function xA(e, t) {
  const { url: n, init: r } = Me(e),
    o = JSON.stringify(OA(t));
  return await fetch(n + hh, { ...r, body: o, method: "PATCH" });
}
async function kA(e) {
  const { url: t, init: n } = Me(e),
    r = '{"path": "", "payload": ""}';
  return await fetch(t + hh + "?force=true", { ...n, body: r, method: "PUT" });
}
async function PA(e) {
  const { url: t, init: n } = Me(e),
    r = '{"path": "", "payload": ""}';
  return await fetch(t + bA, { ...n, body: r, method: "POST" });
}
async function TA(e) {
  const { url: t, init: n } = Me(e),
    r = '{"path": "", "payload": ""}';
  return await fetch(t + CA, { ...n, body: r, method: "POST" });
}
async function LA(e) {
  const { url: t, init: n } = Me(e),
    r = '{"path": "", "payload": ""}';
  return await fetch(t + RA, { ...n, body: r, method: "POST" });
}
async function NA(e) {
  const { url: t, init: n } = Me(e);
  return await fetch(t + EA, { ...n, method: "POST" });
}
function Nw(e) {
  var t,
    n,
  ...
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    if (Array.isArray(e))
      for (t = 0; t < e.length; t++)
        e[t] && (n = Nw(e[t])) && (r && (r += " "), (r += n));
    else for (t in e) e[t] && (r && (r += " "), (r += t));
  return r;
}
function Ar() {
  for (var e, t, n = 0, r = ""; n < arguments.length; )
    (e = arguments[n++]) && (t = Nw(e)) && (r && (r += " "), (r += t));
  return r;
}
function Of() {
  return (
...
var ph = L.forwardRef(function (e, t) {
  var n = e.color,
  ...
  return V.createElement(
    ...
    V.createElement("line", { x1: "1", y1: "1", x2: "23", y2: "23" })
  );
});
ph.propTypes = { color: xe.string, size: xe.oneOfType([xe.string, xe.number]) };
ph.displayName = "EyeOff";
const MA = ph;
function xf() {
  return (
    (xf =
...
var vh = L.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    i = o === void 0 ? 24 : o,
  ...
  return V.createElement(
    ...
    V.createElement("circle", { cx: "12", cy: "12", r: "3" })
  );
});
vh.propTypes = { color: xe.string, size: xe.oneOfType([xe.string, xe.number]) };
vh.displayName = "Eye";
const UA = vh;
function kf() {
  return (
...
var mh = L.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    i = o === void 0 ? 24 : o,
...
mh.propTypes = { color: xe.string, size: xe.oneOfType([xe.string, xe.number]) };
mh.displayName = "GitHub";
const BA = mh;
function Pf() {
  return (
    (Pf =
...
var gh = L.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    i = o === void 0 ? 24 : o,
  ...
  return V.createElement(
    ...
    V.createElement("circle", { cx: "12", cy: "12", r: "10" }),
    V.createElement("line", { x1: "12", y1: "16", x2: "12", y2: "12" }),
    V.createElement("line", { x1: "12", y1: "8", x2: "12.01", y2: "8" })
  );
});
gh.propTypes = { color: xe.string, size: xe.oneOfType([xe.string, xe.number]) };
gh.displayName = "Info";
const WA = gh;
function Tf() {
  return (
...
var yh = L.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    i = o === void 0 ? 24 : o,
...
yh.propTypes = { color: xe.string, size: xe.oneOfType([xe.string, xe.number]) };
yh.displayName = "X";
const KA = yh,
  { useState: QA, useCallback: GA } = V;
function XA(e = !1) {
  const [t, n] = QA(e),
    r = GA(() => n((o) => !o), []);
  return [t, r];
}
const Aw = "yacd.metacubex.one";
function YA() {
  try {
...
function jr(e) {
  try {
    ...
    localStorage.setItem(Aw, t);
  } catch {}
}
const Iw = "/traffic",
  JA = new TextDecoder("utf-8"),
  es = 150,
  ra = {
...
let ao = !1,
  ts = "";
function Lf(e) {
  ra.appendData(JSON.parse(e));
}
function Mw(e) {
  return e.read().then(({ done: t, value: n }) => {
    const r = JA.decode(n, { stream: !t });
    ts += r;
    const o = ts.split(`
`),
      i = o[o.length - 1];
    for (let a = 0; a < o.length - 1; a++) Lf(o[a]);
    if (t) {
      Lf(i), (ts = ""), console.log("GET /traffic streaming done"), (ao = !1);
      return;
    } else ts = i;
    return Mw(e);
  });
...
function ZA(e) {
  ...
  return (
    fetch(t + Iw, n).then(
      ...
      (r) => {
        console.log("fetch /traffic error", r), (ao = !1);
      }
    ),
    ra
  );
...
const t3 = { apiConfig: !1 },
  d$ = (e) => e.configs.configs,
  n3 = (e) => e.configs.haveFetchedConfig,
  h$ = (e) => e.configs.configs["log-level"];
function Br(e) {
  return async (t, n) => {
    let r;
    try {
    ...
    if (!r.ok) {
      console.log("Error fetch configs", r.statusText), t(Cm("apiConfig"));
      return;
    }
...
function v$(e) {
  return async (t) => {
    kA(e)
      .then(
        (n) => {
          n.ok === !1 && console.log("Error reload config file", n.statusText);
        },
        (n) => {
          throw (console.log("Error reload config file", n), n);
        }
      )
      .then(() => {
        t(Br(e));
...
function m$(e) {
  return async (t) => {
    TA(e)
      .then(
        (n) => {
          n.ok === !1 && console.log("Error restart core", n.statusText);
        },
        (n) => {
          throw (console.log("Error restart core", n), n);
        }
      )
      .then(() => {
        t(Br(e));
...
function g$(e) {
  return async (t) => {
    LA(e)
      .then(
        (n) => {
          n.ok === !1 && console.log("Error upgrade core", n.statusText);
        },
        (n) => {
          throw (console.log("Error upgrade core", n), n);
        }
      )
      .then(() => {
        t(Br(e));
  ...
  return async (t) => {
    PA(e)
      .then(
        (n) => {
          n.ok === !1 &&
            console.log("Error update geo databases file", n.statusText);
        },
        (n) => {
          throw (console.log("Error update geo databases file", n), n);
        }
      )
      .then(() => {
        t(Br(e));
...
function w$(e) {
  return async (t) => {
    NA(e)
      .then(
        (n) => {
          n.ok === !1 && console.log("Error flush FakeIP pool", n.statusText);
        },
        (n) => {
          throw (console.log("Error flush FakeIP pool", n), n);
        }
      )
      .then(() => {
        t(Br(e));
...
const o3 = {
  ...
  Dw = (e) => e.app.selectedClashAPIConfigIndex,
  Sh = (e) => e.app.clashAPIConfigs,
  _h = (e) => e.app.theme,
  $w = (e) => e.app.selectedChartStyleIndex,
  i3 = (e) => e.app.latencyTestUrl,
  S$ = (e) => e.app.collapsibleIsOpen,
  _$ = (e) => e.app.proxySortBy,
  b$ = (e) => e.app.hideUnavailableProxies,
  a3 = (e) => e.app.autoCloseOldConns,
  E$ = (e) => e.app.logStreamingPaused,
  s3 = wA(jr, 600);
function bh(e, { baseURL: t, secret: n }) {
  const r = Sh(e());
  for (let o = 0; o < r.length; o++) {
    const i = r[o];
    if (i.baseURL === t && i.secret === n) return o;
  }
}
function l3({ baseURL: e, secret: t }) {
  return async (n, r) => {
    if (bh(r, { baseURL: e, secret: t })) return;
    const i = { baseURL: e, secret: t, addedAt: Date.now() };
    n("addClashAPIConfig", (a) => {
      a.app.clashAPIConfigs.push(i);
    }),
      jr(r().app);
  };
}
function u3({ baseURL: e, secret: t }) {
  return async (n, r) => {
    const o = bh(r, { baseURL: e, secret: t });
    n("removeClashAPIConfig", (i) => {
      i.app.clashAPIConfigs.splice(o, 1);
    }),
      jr(r().app);
  };
}
function c3({ baseURL: e, secret: t }) {
  return async (n, r) => {
    const o = bh(r, { baseURL: e, secret: t });
    Dw(r()) !== o &&
      n("selectClashAPIConfig", (a) => {
        a.app.selectedClashAPIConfigIndex = o;
      }),
      jr(r().app);
    try {
...
const Ju = document.querySelector("html");
function Uw(e = "light") {
  e === "auto"
    ? Ju.setAttribute("data-theme", "auto")
    : e === "dark"
    ? Ju.setAttribute("data-theme", "dark")
    : Ju.setAttribute("data-theme", "light");
}
function f3(e = "auto") {
  return (t, n) => {
    _h(n()) !== e &&
...
const p3 = {
    baseURL:
      ((ag = document.getElementById("app")) == null
        ? void 0
        : ag.getAttribute("data-base-url")) ?? "http://127.0.0.1:6756",
    secret: "",
    addedAt: 0,
  },
  v3 = {
...
const y3 = "_ul_1d6f2_1",
  w3 = "_li_1d6f2_10",
  S3 = "_close_1d6f2_28",
  _3 = "_eye_1d6f2_36",
  b3 = "_hasSecret_1d6f2_45",
  E3 = "_url_1d6f2_50",
  C3 = "_secret_1d6f2_54",
  R3 = "_btn_1d6f2_72",
  gn = {
...
function Ir(e) {
  ...
  return (
    ...
    ((function (n) {
      ...
      return (
        o === Object ||
        (typeof o == "function" && Function.toString.call(o) === A3)
      );
    })(e) ||
      Array.isArray(e) ||
      !!e[Am] ||
      !!(!((t = e.constructor) === null || t === void 0) && t[Am]) ||
      Eh(e) ||
      Ch(e))
  );
}
function oa(e, t, n) {
  n === void 0 && (n = !1),
    Fo(e) === 0
      ? (n ? Object.keys : Ph)(e).forEach(function (r) {
...
function Eh(e) {
  return L3 && e instanceof Map;
}
function Ch(e) {
  return N3 && e instanceof Set;
}
function pr(e) {
  return e.o || e.t;
}
function Rh(e) {
  ...
  var t = I3(e);
  delete t[gt];
  for (var n = Ph(t), r = 0; r < n.length; r++) {
    var o = n[r],
      i = t[o];
...
function Oh(e, t) {
  return (
    ...
    xh(e) ||
      To(e) ||
      !Ir(e) ||
      (Fo(e) > 1 && (e.set = e.add = e.clear = e.delete = k3),
      Object.freeze(e),
      t &&
        oa(
          e,
...
function ec(e, t) {
  ...
  var n = t.p[0],
    r = e !== void 0 && e !== n;
  return (
    t.h.g || ln("ES5").S(t, e, r),
    r
      ? (n[gt].P && (wl(t), Wt(4)),
        Ir(e) && ((e = Sl(t, e)), t.l || _l(t, e)),
        t.u && ln("Patches").M(n[gt].t, e, t.u, t.s))
      : (e = Sl(t, n, [])),
    wl(t),
    t.u && t.v(t.u, t.s),
    e !== jw ? e : void 0
...
function Sl(e, t, n) {
  ...
  if (r.A !== e) return t;
  if (!r.P) return _l(e, r.t, !0), r.t;
  if (!r.I) {
    (r.I = !0), r.A._--;
    var o = r.i === 4 || r.i === 5 ? (r.o = Rh(r.k)) : r.o,
      i = o,
      a = !1;
    r.i === 3 && ((i = new Set(o)), o.clear(), (a = !0)),
      oa(i, function (s, l) {
        return km(e, r, o, s, l, n, a);
      }),
      _l(e, o, !1),
      n && e.u && ln("Patches").N(r, n, e.u, e.s);
  }
  return r.o;
}
function km(e, t, n, r, o, i, a) {
  if (To(o)) {
    var s = Sl(e, o, i && t && t.i !== 3 && !Nf(t.R, r) ? i.concat(r) : void 0);
    if ((Fw(n, r, s), !To(s))) return;
    e.m = !1;
  } else a && n.add(o);
  if (Ir(o) && !xh(o)) {
    if (!e.h.D && e._ < 1) return;
    Sl(e, o), (t && t.A.l) || _l(e, o);
  }
}
function _l(e, t, n) {
  n === void 0 && (n = !1), e.h.D && e.m && Oh(t, n);
}
function tc(e, t) {
  var n = e[gt];
  return (n ? pr(n) : e)[t];
  ...
  return (
    ...
    (function t(n) {
      ...
      var r,
        ...
        i = Fo(n);
      if (o) {
        if (!o.P && (o.i < 4 || !ln("ES5").K(o))) return o.t;
        (o.I = !0), (r = Tm(n, i)), (o.I = !1);
      } else r = Tm(n, i);
      return (
        oa(r, function (a, s) {
          (o && O3(o.t, a) === s) || Fw(r, a, t(s));
        }),
        i === 3 ? new Set(r) : r
      );
    })(e)
...
var Lm,
  ia,
  kh = typeof Symbol < "u" && typeof Symbol("x") == "symbol",
  L3 = typeof Map < "u",
  N3 = typeof Set < "u",
  Nm = typeof Proxy < "u" && Proxy.revocable !== void 0 && typeof Reflect < "u",
  jw = kh
    ? Symbol.for("immer-nothing")
    : (((Lm = {})["immer-nothing"] = !0), Lm),
  Am = kh ? Symbol.for("immer-draftable") : "__$immer_draftable",
  gt = kh ? Symbol.for("immer-state") : "__$immer_state",
  A3 = "" + Object.prototype.constructor,
  Ph =
  ...
  Df = {
    ...
    set: function (e, t, n) {
      ...
      if (!e.P) {
        ...
        if (x3(n, o) && (n !== void 0 || Nf(e.t, t))) return !0;
        nc(e), If(e);
      }
      return (
...
oa(Df, function (e, t) {
  ...
  (di.set = function (e, t, n) {
    return Df.set.call(this, e[0], t, n, e[0]);
  });
var D3 = (function () {
    function e(n) {
      var r = this;
          ...
          if (typeof o == "function" && typeof i != "function") {
            ...
            return function (y) {
              ...
              return l.produce(y, function (S) {
                var k;
                return (k = i).call.apply(k, [_, S].concat(h));
              });
            };
          }
          var u;
    ...
    return (
      (t.createDraft = function (n) {
        Ir(n) || Wt(8), To(n) && (n = T3(n));
        var r = xm(this),
          o = Mf(this, n, void 0);
        return (o[gt].C = !0), Af(r), o;
      }),
      (t.finishDraft = function (n, r) {
        var o = n && n[gt],
          i = o.A;
        return Zu(i, r), ec(void 0, i);
      }),
...
var U3 = yt.setAutoFreeze.bind(yt);
...
function H3({ initialState: e, actions: t = {}, children: n }) {
  const r = B3(e),
    [o, i] = V3(e),
    a = Im(() => r.current, []);
  z3(() => {}, [a]);
  const s = Im(
    ...
    l = j3(() => Ww(t, s), [t, s]);
  return R(Bw.Provider, {
    value: o,
    children: R(zw.Provider, {
      value: s,
      children: R(Vw.Provider, { value: l, children: n }),
    }),
  });
}
function Jt(e) {
...
function Ww(e, t) {
  ...
  for (const r in e) {
    ...
    typeof o == "function"
      ? (n[r] = q3(o, t))
      : typeof o == "object" && (n[r] = Ww(o, t));
  }
  return n;
}
const K3 = (e) => ({ apiConfigs: Sh(e), selectedClashAPIConfigIndex: Dw(e) }),
  Q3 = Jt(K3)(G3);
function G3({ apiConfigs: e, selectedClashAPIConfigIndex: t }) {
  const {
  ...
  return le(Cr, {
    children: [
      ...
      t
        ? le(Cr, {
            children: [
              R("span", { className: gn.secret, children: i ? t : "***" }),
              R(Mm, {
                onClick: a,
                className: gn.eye,
                children: R(s, { size: 20 }),
              }),
            ],
          })
        : null,
...
function Mm({ children: e, onClick: t, className: n, disabled: r }) {
  return R("button", {
    disabled: r,
    className: Ar(n, gn.btn),
    onClick: t,
    children: e,
  });
}
const Y3 = "_root_zwtea_1",
  J3 = "_header_zwtea_5",
  Z3 = "_icon_zwtea_10",
  e4 = "_body_zwtea_20",
  ...
  o4 = "_btn_vsco8_4",
  i4 = "_minimal_vsco8_37",
  a4 = "_btnInternal_vsco8_54",
  s4 = "_btnStart_vsco8_61",
  l4 = "_loadingContainer_vsco8_67",
  Pi = {
    btn: o4,
    minimal: i4,
    btnInternal: a4,
  ...
  u4 = "_sectionNameType_k6imc_4",
  c4 = "_loadingDot_k6imc_75",
  f4 = "_dot2_k6imc_1",
  d4 = "_dot1_k6imc_1",
  h4 = "_dot3_k6imc_1",
  Hw = { sectionNameType: u4, loadingDot: c4, dot2: f4, dot1: d4, dot3: h4 };
function C$({ name: e, type: t }) {
  return le("h2", {
    className: Hw.sectionNameType,
    children: [
      R("span", { style: { marginRight: 5 }, children: e }),
      R("span", { children: t }),
    ],
  });
}
function p4() {
  return R("span", { className: Hw.loadingDot });
}
const { forwardRef: v4, useCallback: m4 } = Tt;
function g4(e, t) {
  const {
      onClick: n,
      disabled: r = !1,
    ...
    v = Ar(Pi.btn, { [Pi.minimal]: i === "minimal" }, a);
  return R("button", {
    className: v,
    ref: t,
    onClick: p,
    ...
    children: o
      ? le(Cr, {
          children: [
            ...
            R("span", { className: Pi.loadingContainer, children: R(p4, {}) }),
          ],
        })
      : R(Dm, { ...d }),
  });
}
function Dm({ children: e, label: t, text: n, start: r }) {
  return le("div", {
    className: Pi.btnInternal,
    children: [
      r &&
        R("span", {
...
const y4 = v4(g4),
  w4 = "_root_1or8t_1",
  S4 = "_floatAbove_1or8t_32",
  $m = { root: w4, floatAbove: S4 },
  { useCallback: _4 } = Tt;
function Um({ id: e, label: t, value: n, onChange: r, ...o }) {
  const i = _4((a) => r(a), [r]);
  return le("div", {
    className: $m.root,
    children: [
      R("input", { id: e, value: n, onChange: i, ...o }),
      R("label", { htmlFor: e, className: $m.floatAbove, children: t }),
    ],
  });
}
const b4 = "_path_r8pm3_1",
  E4 = "_dash_r8pm3_1",
  C4 = { path: b4, dash: E4 };
function Lh({
  width: e = 320,
...
const { useState: rc, useRef: Fm, useCallback: oc, useEffect: R4 } = Tt,
  qw = 0,
  O4 = (e) => ({ apiConfig: sr(e) });
function x4({ dispatch: e }) {
  const [t, n] = rc(""),
    [r, o] = rc(""),
    [i, a] = rc(""),
    s = Fm(!1),
    ...
    u = oc((p) => {
      ...
      switch (y) {
        ...
        case "secret":
          ...
          break;
        default:
          throw new Error(`unknown input name ${y}`);
      }
    }, []),
    c = oc(() => {
      let p = t;
      if (p) {
        const v = t.substring(0, 7);
        if (v.includes(":/")) {
          if (v !== "http://" && v !== "https:/")
            return [1, "Must starts with http:// or https://"];
        } else
          window.location.protocol && (p = `${window.location.protocol}//${p}`);
      }
      k4({ baseURL: p, secret: r }).then((v) => {
        v[0] !== qw ? a(v[1]) : e(l3({ baseURL: p, secret: r }));
      });
    }, [t, r, e]),
    f = oc(
      (p) => {
        (p.target instanceof Element &&
          (!p.target.tagName || p.target.tagName.toUpperCase() !== "INPUT")) ||
          (p.key === "Enter" && c());
      },
      [c]
    ),
    d = async () => {
      (await fetch("/")).json().then((v) => {
        v.hello === "clash" && n(window.location.origin);
      });
    };
  return (
    R4(() => {
    ...
    le("div", {
      ...
      children: [
        ...
        R("div", { className: ur.error, children: i || null }),
        R("div", {
          className: ur.footer,
          children: R(y4, { label: "Add", onClick: c }),
        }),
        R("div", { style: { height: 20 } }),
        R(Q3, {}),
      ],
    })
  );
...
async function k4(e) {
  ...
  try {
    const t = await Lw(e);
    return t.status > 399 ? [1, t.statusText] : [qw];
  } catch {
...
const P4 = "_root_ul0od_4",
  T4 = "_h1_ul0od_10",
  jm = { root: P4, h1: T4 };
function L4({ title: e }) {
  return R("div", {
    className: jm.root,
    children: R("h1", { className: jm.h1, children: e }),
  });
}
const Gw = V.memo(L4),
  N4 = "_root_10mcy_4",
  A4 = "_mono_10mcy_13",
  I4 = "_link_10mcy_17",
  ic = { root: N4, mono: A4, link: I4 };
function Bm({ name: e, link: t, version: n }) {
  return le("div", {
    className: ic.root,
    children: [
      R("h2", { children: e }),
      le("p", {
        children: [
          R("span", { children: "Version " }),
          R("span", { className: ic.mono, children: n }),
        ],
      }),
      R("p", {
        children: le("a", {
          ...
          children: [R(BA, { size: 20 }), R("span", { children: "Source" })],
        }),
      }),
    ],
  });
...
function M4(e) {
  const { data: t } = Y0(["/version", e.apiConfig], () =>
    Qw("/version", e.apiConfig)
  );
  return le(Cr, {
    children: [
      R(Gw, { title: "About" }),
...
function Yw(...e) {
  return L.useCallback((t) => {
    for (let n of e) U4(n, t);
  }, e);
}
function Nh(e) {
  return Xw() ? (e ? e.ownerDocument : document) : null;
}
function F4(e) {
  let t = Nh(e),
  ...
  return t
    ? {
        width: t.documentElement.clientWidth ?? n.innerWidth,
        height: t.documentElement.clientHeight ?? n.innerHeight,
      }
    : { width: 0, height: 0 };
}
function Jw(...e) {
...
function j4() {
  let [, e] = L.useState(Object.create(null));
  return L.useCallback(() => {
    e(Object.create(null));
  }, []);
}
var Ti = Xw() ? L.useLayoutEffect : L.useEffect,
  ac = !1,
  B4 = 0;
function Vm() {
  return ++B4;
}
var Wm = Tt["useId".toString()];
function z4(e) {
  if (Wm !== void 0) {
    let o = Wm();
    return e ?? o;
...
var V4 = ({ children: e, type: t = "reach-portal", containerRef: n }) => {
    let r = L.useRef(null),
      o = L.useRef(null),
      i = j4();
    return (
      ...
      o.current
        ? mo.createPortal(e, o.current)
        : L.createElement("span", { ref: r })
    );
  },
  Zw = ({ unstable_skipInitialRender: e, ...t }) => {
    let [n, r] = L.useState(!1);
    return (
      L.useEffect(() => {
        e && r(!0);
      }, [e]),
      e && !n ? null : L.createElement(V4, { ...t })
    );
  };
Zw.displayName = "Portal";
var eS = L.forwardRef(function ({ as: t = "span", style: n = {}, ...r }, o) {
...
eS.displayName = "VisuallyHidden";
var W4 = ["bottom", "height", "left", "right", "top", "width"],
  H4 = function (t, n) {
    return (
      t === void 0 && (t = {}),
      n === void 0 && (n = {}),
  ...
  q4 = function e() {
    var t = [];
    Pn.forEach(function (n, r) {
      var o = r.getBoundingClientRect();
      H4(o, n.rect) && ((n.rect = o), t.push(n));
    }),
      t.forEach(function (n) {
      ...
      (tS = window.requestAnimationFrame(e));
  };
function K4(e, t) {
  return {
    observe: function () {
      var r = Pn.size === 0;
      Pn.has(e)
        ? Pn.get(e).callbacks.push(t)
        : Pn.set(e, { rect: void 0, hasRectChanged: !1, callbacks: [t] }),
        r && q4();
    },
    unobserve: function () {
      var r = Pn.get(e);
      if (r) {
        ...
        o >= 0 && r.callbacks.splice(o, 1),
          r.callbacks.length || Pn.delete(e),
          Pn.size || cancelAnimationFrame(tS);
      }
    },
  };
}
function nS(e, t, n) {
  ...
  return (
    ...
    Ti(() => {
      if (!r) return;
      let d = i;
      if ((l.current || ((l.current = !0), (d = e.current)), !d)) {
        console.warn("You need to place the ref");
        return;
      }
      let p = K4(d, (v) => {
        var y;
        (y = f.current) == null || y.call(f, v), c(v);
      });
      return (
        p.observe(),
        () => {
...
var Q4 = 100,
  ...
  Ff = {
    initial: "IDLE",
    states: {
      IDLE: { enter: sc, on: { MOUSE_ENTER: "FOCUSED", FOCUS: "VISIBLE" } },
      FOCUSED: {
        enter: J4,
        leave: Z4,
        on: {
  ...
  kt = { value: Ff.initial, context: { id: null } },
  Rs = [];
function X4(e) {
  return (
    Rs.push(e),
...
var jf;
function J4() {
  window.clearTimeout(jf),
    (jf = window.setTimeout(() => {
      Bt({ type: "REST" });
    }, Q4));
}
function Z4() {
...
function eI() {
  window.clearTimeout(Bf),
    (Bf = window.setTimeout(() => Bt({ type: "TIME_COMPLETE" }), G4));
}
function tI() {
  window.clearTimeout(Bf);
}
...
function nI({
  ...
  L.useEffect(
    ...
    aI({ disabled: d, isVisible: _, ref: h });
  function k(M, C) {
    return typeof window < "u" && "PointerEvent" in window ? M : kn(M, C);
  }
  function T(M) {
    return function (O) {
      O.pointerType === "mouse" && M(O);
    };
  }
  function N() {
    Bt({ type: "MOUSE_ENTER", id: y });
  }
  function I() {
    Bt({ type: "MOUSE_MOVE", id: y });
  }
  function G() {
    Bt({ type: "MOUSE_LEAVE" });
  }
  function $() {
    kt.context.id === y && Bt({ type: "MOUSE_DOWN" });
  }
  function X() {
    window.__REACH_DISABLE_TOOLTIPS || Bt({ type: "FOCUS", id: y });
  }
  function ce() {
    kt.context.id === y && Bt({ type: "BLUR" });
  }
  function re(M) {
    (M.key === "Enter" || M.key === " ") &&
      Bt({ type: "SELECT_WITH_KEYBOARD" });
  ...
  return [
    {
      "aria-describedby": _ ? Jw("tooltip", y) : void 0,
      "data-state": _ ? "tooltip-visible" : "tooltip-hidden",
      "data-reach-tooltip-trigger": "",
      ref: g,
      onPointerEnter: kn(t, T(N)),
      onPointerMove: kn(n, T(I)),
      onPointerLeave: kn(r, T(G)),
      onPointerDown: kn(o, T($)),
      onMouseEnter: k(i, N),
      onMouseMove: k(a, I),
      onMouseLeave: k(s, G),
      onMouseDown: k(l, $),
    ...
    { id: y, triggerRect: S, isVisible: _ },
    _,
  ];
}
var Ah = L.forwardRef(function (
  ...
  return L.createElement(
    ...
    null,
    L.cloneElement(s, l),
    L.createElement(rS, { ref: a, label: t, "aria-label": n, ...u, ...i })
  );
});
Ah.displayName = "Tooltip";
var rS = L.forwardRef(function (
  ...
  return r
    ? L.createElement(
        ...
        L.createElement(oS, {
          ...
          isVisible: r,
          ...i,
          id: Jw("tooltip", String(o)),
        })
      )
    : null;
});
rS.displayName = "TooltipPopup";
var oS = L.forwardRef(function (
  {
    ariaLabel: t,
    "aria-label": n,
    as: r = "div",
  ...
  return L.createElement(
    ...
    d && L.createElement(eS, { role: "tooltip", id: o }, n || t)
  );
});
oS.displayName = "TooltipContent";
function rI(e, t, n) {
  return n ? e(t, n) : { visibility: "hidden" };
}
var oI = 8,
  iI = (e, t, n = oI) => {
    let { width: r, height: o } = F4();
    if (!e || !t) return {};
    let i = {
...
function aI({ disabled: e, isVisible: t, ref: n }) {
  L.useEffect(() => {
...
function Bt(e) {
  let { value: t, context: n, changed: r } = sI(kt, e);
  r && ((kt = { value: t, context: n }), Y4());
}
function sI(e, t) {
  let n = Ff.states[e.value],
...
function Hm(e, t) {
  return (
    ...
    (t
      ? kt.value === "VISIBLE"
      : kt.value === "VISIBLE" || kt.value === "LEAVING_VISIBLE")
  );
}
function lI(e) {
  let t = {};
...
const Ih = lI(() =>
    Ot(() => import("./index-777fdc28.js"), [], import.meta.url)
  ),
  uI = "_iconWrapper_1rpjb_1",
  cI = "_themeSwitchContainer_1rpjb_21",
  qm = { iconWrapper: uI, themeSwitchContainer: cI };
function fI({ theme: e, dispatch: t }) {
  const { t: n } = No(),
    r = L.useMemo(() => {
      switch (e) {
        case "dark":
        ...
        case "light":
          return R(dI, {});
        default:
          return console.assert(!1, "Unknown theme"), R(Km, {});
      }
    }, [e]),
    o = L.useCallback((i) => t(f3(i.target.value)), [t]);
  return R(Ah, {
    label: n("switch_theme"),
    "aria-label": "switch theme",
    children: le("div", {
      className: qm.themeSwitchContainer,
      children: [
        R("span", { className: qm.iconWrapper, children: r }),
        le("select", {
          onChange: o,
          children: [
            R("option", { value: "auto", children: "Auto" }),
            R("option", { value: "dark", children: "Dark" }),
            R("option", { value: "light", children: "Light" }),
          ],
        }),
      ],
    }),
...
function dI() {
  ...
  return le("svg", {
    ...
    strokeLinejoin: "round",
    children: [
      R("circle", { cx: "12", cy: "12", r: "5" }),
      le(t.g, {
        initial: { scale: 0.7 },
        animate: { scale: 1 },
        transition: { duration: 0.5 },
        children: [
          R("line", { x1: "12", y1: "1", x2: "12", y2: "3" }),
          R("line", { x1: "12", y1: "21", x2: "12", y2: "23" }),
          R("line", { x1: "4.22", y1: "4.22", x2: "5.64", y2: "5.64" }),
          R("line", { x1: "18.36", y1: "18.36", x2: "19.78", y2: "19.78" }),
          R("line", { x1: "1", y1: "12", x2: "3", y2: "12" }),
          R("line", { x1: "21", y1: "12", x2: "23", y2: "12" }),
          R("line", { x1: "4.22", y1: "19.78", x2: "5.64", y2: "18.36" }),
          R("line", { x1: "18.36", y1: "5.64", x2: "19.78", y2: "4.22" }),
        ],
      }),
    ],
  });
...
function vI(e) {
  const { code: t } = e;
  return typeof t == "number" ? Vf[t] : Vf.default;
}
const mI = "_content_b98hm_1",
  gI = "_container_b98hm_16",
  yI = "_overlay_b98hm_22",
  wI = "_fixed_b98hm_26",
  rs = { content: mI, container: gI, overlay: yI, fixed: wI },
  SI = "_overlay_fy74n_1",
  _I = "_content_fy74n_14",
  Qm = { overlay: SI, content: _I };
function bI({
  isOpen: e,
  onRequestClose: t,
  className: n,
...
const EI = L.memo(bI),
  { useCallback: CI, useEffect: RI } = Tt;
function OI({ dispatch: e, apiConfig: t, modals: n }) {
  if (!window.fetch) {
    const { detail: o } = Vf[zf],
      i = new Error(o);
    throw ((i.code = zf), i);
  }
  const r = CI(() => {
  ...
  return (
    ...
    le(EI, {
      ...
      overlayClassName: rs.overlay,
      shouldCloseOnOverlayClick: !1,
      shouldCloseOnEsc: !1,
      onRequestClose: r,
      children: [
        R("div", { className: rs.container, children: R(Kw, {}) }),
        R("div", { className: rs.fixed, children: R(iS, {}) }),
      ],
    })
  );
}
const xI = (e) => ({ modals: e.modals, apiConfig: sr(e) }),
  kI = Jt(xI)(OI),
  PI = "_root_16avz_1",
  TI = "_yacd_16avz_14",
  LI = "_link_16avz_23",
  lc = { root: PI, yacd: TI, link: LI };
function NI({ width: e = 24, height: t = 24 } = {}) {
  return R("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: e,
    height: t,
...
const AI = "https://github.com/metacubex/yacd";
function II({ message: e, detail: t }) {
  return le("div", {
    className: lc.root,
    children: [
      R("div", {
        className: lc.yacd,
        children: R(Lh, { width: 150, height: 150 }),
      }),
      e ? R("h1", { children: e }) : null,
      t ? R("p", { children: t }) : null,
      R("p", {
        children: le("a", {
          className: lc.link,
          href: AI,
          children: [R(NI, { width: 16, height: 16 }), "metacubex/yacd"],
        }),
      }),
    ],
  });
...
class MI extends L.Component {
  ...
  render() {
    if (this.state.error) {
      const { message: n, detail: r } = vI(this.state.error);
      return R(II, { message: n, detail: r });
    } else return this.props.children;
  }
}
const DI = "_root_1ddes_4",
  $I = "_chart_1ddes_13",
  Gm = { root: DI, chart: $I },
  UI = "_loading_wpm96_1",
  FI = "_spinner_wpm96_9",
  jI = "_rotate_wpm96_1",
  Xm = { loading: UI, spinner: FI, rotate: jI },
  aS = ({ height: e }) => {
    const t = e ? { height: e } : {};
    return R("div", {
      className: Xm.loading,
      style: t,
      children: R("div", { className: Xm.spinner }),
    });
  },
  sS = "/memory",
  ...
  os = 150,
  aa = {
    labels: Array(os).fill(0),
    inuse: Array(os),
    oslimit: Array(os),
    size: os,
    subscribers: [],
    appendData(e) {
      this.inuse.shift(), this.oslimit.shift(), this.labels.shift();
      const t = Date.now();
      this.inuse.push(e.inuse),
        this.oslimit.push(e.oslimit),
        this.labels.push(t),
        this.subscribers.forEach((n) => n(e));
    },
    subscribe(e) {
...
let so = !1,
  is = "";
function Wf(e) {
  aa.appendData(JSON.parse(e));
}
function lS(e) {
  return e.read().then(({ done: t, value: n }) => {
    const r = BI.decode(n, { stream: !t });
    is += r;
    const o = is.split(`
`),
      i = o[o.length - 1];
    for (let a = 0; a < o.length - 1; a++) Wf(o[a]);
    if (t) {
      Wf(i), (is = ""), console.log("GET /memory streaming done"), (so = !1);
      return;
    } else is = i;
    return lS(e);
  });
...
function VI(e) {
  ...
  return (
    fetch(t + sS, n).then(
      ...
      (r) => {
        console.log("fetch /memory error", r), (so = !1);
      }
    ),
    aa
  );
...
function Ym(e, t, n, r = 0, o = !1) {
  ...
  const i = {
    args: n,
    promise: e(...n)
      .then((a) => (i.response = a ?? !0))
      .catch((a) => (i.error = a ?? "unknown error"))
      .then(() => {
        r > 0 &&
          setTimeout(() => {
            const a = t.indexOf(i);
...
function uS(e, t = 0) {
  ...
  return {
    read: (...r) => Ym(e, n, r, t),
    preload: (...r) => void Ym(e, n, r, t, !0),
    clear: (...r) => WI(n, ...r),
    peek: (...r) => {
      var o;
      return (o = n.find((i) => Mh(r, i.args))) == null ? void 0 : o.response;
    },
  };
}
const Jm = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"];
function Er(e) {
  if (e < 1e3) return e + " B";
  const t = Math.min(Math.floor(Math.log10(e) / 3), Jm.length - 1);
  e = Number((e / Math.pow(1e3, t)).toPrecision(3));
  const n = Jm[t];
  return e + " " + n;
}
const HI = uS(() =>
    Ot(() => import("./chart-lib-6081a478.js"), [], import.meta.url)
  ),
  Zm = { borderWidth: 1, pointRadius: 0, tension: 0.2, fill: !0 },
  qI = {
    responsive: !0,
    ...
    scales: {
      ...
      y: {
        type: "linear",
        display: !0,
        grid: { display: !0, color: "#555", drawTicks: !1 },
        border: { dash: [3, 6] },
        ticks: {
          maxTicksLimit: 5,
          callback(e) {
  ...
  QI = { borderWidth: 1, pointRadius: 0, tension: 0.2, fill: !0 },
  cS = {
    responsive: !0,
    maintainAspectRatio: !0,
    plugins: { legend: { labels: { boxWidth: 20 } } },
...
const JI = "_TrafficChart_13afo_1",
  ZI = { TrafficChart: JI },
  { useMemo: eM } = Tt,
  tM = {
    justifySelf: "center",
  ...
  nM = { width: "100%", height: "100%", padding: "10px", borderRadius: "10px" },
  rM = (e) => ({ apiConfig: sr(e), selectedChartStyleIndex: $w(e) }),
  oM = Jt(rM)(iM);
function iM({ apiConfig: e, selectedChartStyleIndex: t }) {
  const n = KI.read(),
    r = zI(e),
    { t: o } = No(),
    i = eM(
      () => ({
        labels: r.labels,
        datasets: [
          { ...QI, ...cS, ...GI[t].inuse, label: o("Memory"), data: r.inuse },
        ],
      }),
      [r, t, o]
    );
  return (
    YI(n.Chart, "MemoryChart", i, r),
    R("div", {
      style: tM,
      children: R("canvas", {
        id: "MemoryChart",
        style: nM,
        className: ZI.TrafficChart,
      }),
    })
  );
}
const aM = "_TrafficChart_13afo_1",
  sM = { TrafficChart: aM },
  { useMemo: lM } = Tt,
  uM = {
    justifySelf: "center",
  ...
  cM = { width: "100%", height: "100%", padding: "10px", borderRadius: "10px" },
  fM = (e) => ({ apiConfig: sr(e), selectedChartStyleIndex: $w(e) }),
  dM = Jt(fM)(hM);
function hM({ apiConfig: e, selectedChartStyleIndex: t }) {
  const n = HI.read(),
    r = wh(e),
    { t: o } = No(),
    i = lM(
      () => ({
        labels: r.labels,
        datasets: [
          { ...Zm, ...eg[t].up, label: o("Up"), data: r.up },
          { ...Zm, ...eg[t].down, label: o("Down"), data: r.down },
        ],
      }),
      [r, t, o]
    );
  return (
    XI(n.Chart, "trafficChart", i, r),
    R("div", {
      style: uM,
      children: R("canvas", {
        id: "trafficChart",
        style: cM,
        className: sM.TrafficChart,
      }),
    })
  );
}
const cu = "/connections",
  Bn = [];
function pM(e) {
  let t;
  try {
    (t = JSON.parse(e)),
      t.connections.forEach((n) => {
        ...
        r.process == null &&
          r.processPath != null &&
          (r.process = r.processPath.replace(/^.*[/\\](.*)$/, "$1"));
      });
  } catch {
    console.log("JSON.parse error", JSON.parse(e));
  }
  Bn.forEach((n) => n.listner(t));
}
let ss;
function vM(e, t, n) {
  if (ss === 1 && t) return tg({ listner: t, onClose: n });
  ss = 1;
  const r = dh(e, cu),
    o = new WebSocket(r);
  if (
    (o.addEventListener("error", () => {
      (ss = 3), Bn.forEach((i) => i.onClose()), (Bn.length = 0);
    }),
    o.addEventListener("close", () => {
      (ss = 3), Bn.forEach((i) => i.onClose()), (Bn.length = 0);
    }),
    o.addEventListener("message", (i) => pM(i.data)),
    t)
  )
    return tg({ listner: t, onClose: n });
}
function tg(e) {
  return (
    Bn.push(e),
    function () {
      const n = Bn.indexOf(e);
      Bn.splice(n, 1);
    }
  );
}
async function R$(e) {
  const { url: t, init: n } = Me(e);
  return await fetch(t + cu, { ...n, method: "DELETE" });
}
async function mM(e) {
  const { url: t, init: n } = Me(e);
  return await fetch(t + cu, { ...n });
}
...
const yM = "_TrafficNow_w4nk9_2",
  wM = "_sec_w4nk9_35",
  cr = { TrafficNow: yM, sec: wM },
  { useState: dS, useEffect: hS, useCallback: SM } = Tt,
  _M = (e) => ({ apiConfig: sr(e) }),
  bM = Jt(_M)(EM);
function EM({ apiConfig: e }) {
  const { t } = No(),
    { upStr: n, downStr: r } = CM(e),
    { upTotal: o, dlTotal: i, connNumber: a, mUsage: s } = RM(e);
  return le("div", {
    className: cr.TrafficNow,
    children: [
      le("div", {
        className: cr.sec,
        children: [
          R("div", { children: t("Upload") }),
          R("div", { children: n }),
        ],
      }),
      le("div", {
      ...
      le("div", {
        className: cr.sec,
        children: [
          R("div", { children: t("Download Total") }),
          R("div", { children: i }),
        ],
      }),
      le("div", {
        className: cr.sec,
        children: [
          R("div", { children: t("Active Connections") }),
          R("div", { children: a }),
        ],
      }),
      le("div", {
...
function CM(e) {
  const [t, n] = dS({ upStr: "0 B/s", downStr: "0 B/s" });
  return (
    hS(
      () =>
        wh(e).subscribe((r) =>
          n({ upStr: Er(r.up) + "/s", downStr: Er(r.down) + "/s" })
        ),
      [e]
    ),
    t
...
function RM(e) {
  const [t, n] = dS({
    ...
    r = SM(
      ({ downloadTotal: o, uploadTotal: i, connections: a, memory: s }) => {
        n({
          upTotal: Er(i),
          dlTotal: Er(o),
          connNumber: a.length,
  ...
  return hS(() => vM(e, r), [e, r]), t;
}
function OM() {
  const { t: e } = No();
  return le("div", {
    children: [
      R(Gw, { title: e("Overview") }),
      le("div", {
        className: Gm.root,
        children: [
          R("div", { children: R(bM, {}) }),
          R("div", {
            className: Gm.chart,
            children: le(L.Suspense, {
              fallback: R(aS, { height: "200px" }),
              children: [R(dM, {}), R(oM, {})],
            }),
          }),
        ],
...
const TM = (e) => ({ apiConfig: sr(e), apiConfigs: Sh(e) });
function LM({ apiConfig: e, apiConfigs: t }) {
  return (
    L.useEffect(() => {
      let n = "yacd";
      if (t.length > 1)
        try {
          n = `${new URL(e.baseURL).host} - yacd`;
        } catch {}
      document.title = n;
    }),
    R(Cr, {})
...
var pS = {
  ...
  ng = V.createContext && V.createContext(pS),
  Jn =
...
function vS(e) {
  return (
    e &&
    e.map(function (t, n) {
      return V.createElement(t.tag, Jn({ key: n }, t.attr), vS(t.child));
    })
  );
}
function jo(e) {
  return function (t) {
    return V.createElement(IM, Jn({ attr: Jn({}, e.attr) }, t), vS(e.child));
  };
}
function IM(e) {
  var t = function (n) {
  ...
  return ng !== void 0
    ? V.createElement(ng.Consumer, null, function (n) {
        return t(n);
      })
    : t(pS);
}
...
const BM = "_root_9y1rm_4",
  zM = "_logo_meta_9y1rm_10",
  VM = "_logo_whitelabelairport_9y1rm_24",
  WM = "_logo_singbox_9y1rm_31",
  HM = "_rows_9y1rm_46",
  qM = "_row_9y1rm_46",
  KM = "_rowActive_9y1rm_83",
  QM = "_label_9y1rm_94",
  GM = "_footer_9y1rm_110",
  XM = "_iconWrapper_9y1rm_122",
  Dn = {
    root: BM,
    logo_meta: zM,
    logo_whitelabelairport: VM,
    logo_singbox: WM,
    rows: HM,
    row: qM,
    rowActive: KM,
  ...
  JM = L.memo(function ({ isActive: t, to: n, iconId: r, labelText: o }) {
    const i = YM[r],
      a = Ar(Dn.row, t ? Dn.rowActive : null);
    return le(l1, {
      to: n,
      className: a,
      children: [R(i, {}), R("div", { className: Dn.label, children: o })],
    });
  }),
  ZM = [
    { to: "/", iconId: "globe", labelText: "Proxies" },
    { to: "/overview", iconId: "activity", labelText: "Overview" },
...
function nD(e) {
  const { t } = No(),
    n = wa();
  return (
    Y0(["/version", e.apiConfig], () => Qw("/version", e.apiConfig)),
    le("div", {
      className: Dn.root,
      children: [
        R("div", { className: Dn.logo_whitelabelairport }),
        R("center", { children: "WebUI V0 Alpha" }),
        R("div", {
          className: Dn.rows,
          children: ZM.map(({ to: r, iconId: o, labelText: i }) =>
            R(
              JM,
              { to: r, isActive: n.pathname === r, iconId: o, labelText: t(i) },
              r
            )
          ),
        }),
...
function og(e, t, n, r, o) {
  return (function (i, a, s, l, u) {
    ...
    for (var f = "#", d = 1; d < 6; d += 2) {
      var p = parseInt(l.substr(d, 2), 16),
        v = parseInt(u.substr(d, 2), 16),
        y = Math.round((1 - c) * p + c * v).toString(16);
    ...
    (t.prototype.render = function () {
      var n = this.props,
        ...
        G = {
          height: _,
          width: m,
          margin: Math.max(0, (this.t - _) / 2),
          position: "relative",
          background: og(k, this.i, this.o, a, s),
          borderRadius: typeof h == "number" ? h : _ / 2,
        ...
        $ = {
          height: _,
          width: Math.min(1.5 * _, m - (this.t + _) / 2 + 1),
          position: "relative",
        ...
        ce = {
          height: this.t,
          width: this.t,
          background: og(k, this.i, this.o, l, u),
          display: "inline-block",
          cursor: o ? "default" : "pointer",
          borderRadius: typeof h == "number" ? h - 1 : "50%",
          position: "absolute",
          transform: "translateX(" + k + "px)",
          top: Math.max(0, (_ - this.t) / 2),
          outline: 0,
          boxShadow: N ? y : v,
          border: 0,
          WebkitTransition: T
      ...
      return V.createElement(
        ...
        V.createElement(
          ...
          c && V.createElement("div", { style: $ }, c),
          f && V.createElement("div", { style: X }, f)
        ),
        V.createElement(
          "div",
          {
          ...
          p && V.createElement("div", { style: re }, p),
          d && V.createElement("div", { style: w }, d)
        ),
        V.createElement(
          "input",
          Hf(
...
const aD = Os.default ? Os.default : Os;
function sD({ checked: e = !1, onChange: t, theme: n, name: r }) {
  return R(aD, {
    onChange: t,
    checked: e,
    uncheckedIcon: !1,
...
const x$ = Jt((e) => ({ theme: _h(e) }))(sD),
  lD = "_ToggleSwitch_10mtp_1",
  uD = "_slider_10mtp_28",
  ig = { ToggleSwitch: lD, slider: uD };
function cD({ options: e, value: t, name: n, onChange: r }) {
  const o = L.useMemo(() => e.map((s) => s.value).indexOf(t), [e, t]),
    i = L.useCallback(
      (s) => {
    ...
    a = L.useMemo(() => ({ width: i(o) + "%", left: o * i(0) + "%" }), [o, i]);
  return le("div", {
    className: ig.ToggleSwitch,
    children: [
      R("div", { className: ig.slider, style: a }),
      e.map((s, l) => {
        const u = `${n}-${s.label}`;
        return le(
          "label",
...
function wD(e) {
  ...
  var o = function () {
    ...
    var p = f,
      ...
      g = e(function () {
        for (var k = [], T = m.length, N = 0; N < T; N++)
          k.push(m[N].apply(null, arguments));
        return (c = h.apply(null, k)), c;
      });
    return (
      Object.assign(g, {
        resultFunc: d,
...
const bD = { searchText: "", logs: [], tail: -1 },
  Dh = "/proxies";
async function ED(e) {
  const { url: t, init: n } = Me(e);
  return await (await fetch(t + Dh, n)).json();
}
async function CD(e, t, n) {
  const r = { name: n },
    { url: o, init: i } = Me(e),
    a = `${o}${Dh}/${t}`;
  return await fetch(a, { ...i, method: "PUT", body: JSON.stringify(r) });
}
async function RD(e, t, n = "https://www.gstatic.com/generate_204") {
  const { url: r, init: o } = Me(e),
    i = `timeout=5000&url=${encodeURIComponent(n)}`,
    a = `${r}${Dh}/${encodeURIComponent(t)}/delay?${i}`;
  return await fetch(a, o);
}
async function L$(e, t, n = "http://www.gstatic.com/generate_202") {
  const { url: r, init: o } = Me(e),
    i = `url=${encodeURIComponent(n)}&timeout=2000`,
    a = `${r}/group/${encodeURIComponent(t)}/delay?${i}`;
  return await fetch(a, o);
}
async function OD(e) {
  const { url: t, init: n } = Me(e),
...
const kD = {
  ...
  TD = (e) => e.proxies.proxies,
  SS = (e) => e.proxies.delay,
  N$ = (e) => e.proxies.groupNames,
  LD = (e) => e.proxies.proxyProviders || [],
  _S = (e) => e.proxies.dangleProxyNames,
  A$ = (e) => e.proxies.showModalClosePrevConns;
function Bo(e) {
  return async (t, n) => {
    const [r, o] = await Promise.all([ED(e), OD(e)]),
      { providers: i, proxies: a } = FD(o.providers),
      s = { ...a, ...r.proxies },
      [l, u] = UD(s),
      f = { ...SS(n()) };
    for (let p = 0; p < u.length; p++) {
      const v = u[p],
        { history: y } = s[v] || { history: [] },
        _ = y[y.length - 1];
      _ && typeof _.delay == "number" && (f[v] = { number: _.delay });
    }
    const d = [];
    for (const p of u) a[p] || d.push(p);
    t("store/proxies#fetchProxies", (p) => {
      (p.proxies.proxies = s),
        (p.proxies.groupNames = l),
        (p.proxies.delay = f),
        (p.proxies.proxyProviders = i),
        (p.proxies.dangleProxyNames = d);
    });
  };
}
function I$(e, t) {
...
async function ND(e, t, n) {
  ...
  await Promise.all(a.map((s) => gM(e, s).catch(wS)));
}
function AD(e, t, n) {
  const r = [n, t];
  let o,
...
async function ID(e, t, n, r, o) {
  try {
    if ((await CD(n, r, o)).ok === !1)
...
function CS(e, t, n) {
  const r = AD(t, n.groupName, n.itemName);
  ND(e, n.groupName, r[0]);
}
function MD(e) {
  return async (t, n) => {
    var a;
...
function DD(e, t) {
  return async (n, r) => {
    const o = i3(r()),
      i = await RD(e, t, o);
    let a = "";
    i.ok === !1 && (a = i.statusText);
    const { delay: s } = await i.json(),
      u = { ...SS(r()), [t]: { error: a, number: s } };
    n("requestDelayForProxyOnce", (c) => {
      c.proxies.delay = u;
    });
  };
}
...
function $D(e, t) {
  return async (n, r) => {
    const o = _S(r()),
      i = t.filter((a) => o.indexOf(a) > -1).map((a) => n(RS(e, a)));
    await Promise.all(i), await n(Bo(e));
  };
}
function U$(e) {
  return async (t, n) => {
    const r = _S(n());
    await Promise.all(r.map((i) => t(RS(e, i))));
    const o = LD(n());
    for (const i of o) await bS(e, i.name);
    await t(Bo(e));
  };
}
function UD(e) {
...
function FD(e) {
  ...
  return { providers: n, proxies: r };
}
const jD = {
    requestDelayForProxies: $D,
    closeModalClosePrevConns: ES,
    closePrevConnsAndTheModal: MD,
  },
  F$ = yA({ key: "proxyFilterText", default: "" }),
  BD = { app: g3(), modals: t3, configs: o3, proxies: kD, logs: bD },
  zD = {
    selectChartStyleIndex: d3,
    updateAppConfig: Rm,
    app: {
      updateCollapsibleIsOpen: h3,
      updateAppConfig: Rm,
      removeClashAPIConfig: u3,
      selectClashAPIConfig: c3,
    },
    proxies: jD,
  },
  VD = "_app_tjhhp_1",
  WD = "_content_tjhhp_17",
  OS = { app: VD, content: WD },
  { lazy: xa, Suspense: xS } = Tt,
  HD = xa(() =>
    Ot(
      () => import("./Connections-ac8a4ae7.js"),
      [
        "./Connections-ac8a4ae7.js",
        "./Select-0e7ed95b.js",
        "./Select-07e025ab.css",
        "./useRemainingViewPortHeight-1c35aab5.js",
        "./BaseModal-ab8cd8e0.js",
        "./BaseModal-e9f180d4.css",
        "./index-84fa0cb3.js",
        "./Input-4a412620.js",
        "./objectWithoutPropertiesLoose-4f48578a.js",
        "./Fab-12e96042.js",
        "./Fab-48def6bf.css",
        "./play-c7b83a10.js",
        "./Connections-2b49f1fb.css",
      ],
      import.meta.url
    )
  ),
  ...
  KD = xa(() =>
    Ot(
      () => import("./Logs-9ddf6a86.js"),
      [
        "./Logs-9ddf6a86.js",
        "./logs-3f8dcdee.js",
        "./debounce-c1ba2006.js",
        "./useRemainingViewPortHeight-1c35aab5.js",
        "./Fab-12e96042.js",
        "./Fab-48def6bf.css",
        "./play-c7b83a10.js",
  ...
  QD = xa(() =>
    Ot(
      ...
      [
        ...
        "./Fab-12e96042.js",
        "./Fab-48def6bf.css",
        "./TextFitler-ae90d90b.js",
        "./rotate-cw-6c7b4819.js",
        "./debounce-c1ba2006.js",
        "./TextFitler-a112af1a.css",
        "./index-84fa0cb3.js",
        "./Select-0e7ed95b.js",
        "./Select-07e025ab.css",
        "./Proxies-06b60f95.css",
      ],
      import.meta.url
    )
  ),
  ...
  XD = [
    { path: "/overview", element: R(OM, {}) },
    { path: "/connections", element: R(HD, {}) },
    { path: "/configs", element: R(qD, {}) },
    { path: "/logs", element: R(KD, {}) },
    { path: "/", element: R(QD, {}) },
    { path: "/rules", element: R(GD, {}) },
    { path: "/about", element: R($4, {}) },
    !1,
  ].filter(Boolean);
function YD() {
  return le(Cr, {
    children: [
      ...
      R("div", {
        ...
        children: R(xS, { fallback: R(PM, {}), children: s1(XD) }),
      }),
    ],
  });
}
              ...
              children: [
                ...
                R(xS, {
                  ...
                  children: R(xO, {
                    children: le(bO, {
                      children: [
                        R(vf, { path: "/backend", element: R(Kw, {}) }),
                        R(vf, { path: "*", element: R(YD, {}) }),
                      ],
                    }),
                  }),
                }),
...
const PS = document.getElementById("app"),
  n$ = N0(PS);
B0.setAppElement(PS);
n$.render(R(JD, {}));
e$();
...
const on = { touching: !1, trace: [] };
function r$(e) {
  if (e.touches.length !== 1) {
    (on.touching = !1), (on.trace = []);
    return;
  }
  (on.touching = !0),
    (on.trace = [{ x: e.touches[0].screenX, y: e.touches[0].screenY }]);
}
function o$(e) {
  on.touching &&
    on.trace.push({ x: e.touches[0].screenX, y: e.touches[0].screenY });
}
function i$() {
  if (!on.touching) return;
  const e = on.trace;
  (on.touching = !1), (on.trace = []), a$(e);
}
function a$(e) {
  const t = ["/", "/proxies", "/rules", "/connections", "/configs", "/logs"],
    n = e[0],
    r = e[e.length - 1],
    o = window.location.hash.slice(1),
    i = t.indexOf(o);
  console.log(i, o, t.length),
    i !== 3 &&
      (r.x - n.x > 200 && i > 0
        ? (window.location.hash = t[i - 1])
        : r.x - n.x < -200 &&
          i < t.length - 1 &&
          ((window.location.hash = t[i + 1]),
          i === -1 && (window.location.hash = t[i + 2])));
}
export {
  k$ as $,
  Br as A,
