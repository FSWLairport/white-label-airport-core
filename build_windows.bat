...
del bin\libcore.dll bin\WhiteLabelAirportCli.exe
set CGO_LDFLAGS=
...
rsrc  -ico .\assets\whitelabelairport-cli.ico -o cli\bydll\cli.syso

copy bin\libcore.dll .
set CGO_LDFLAGS="libcore.dll"
go build  -o bin/WhiteLabelAirportCli.exe ./cli/bydll/
del libcore.dll
